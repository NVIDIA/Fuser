...
__global__ void nvfuser_reduction_f0_c1_r0_g17(Tensor<float, 3, 3> T163, Tensor<float, 3, 3> T156, Tensor<float, 3, 3> T155, Tensor<float, 3, 3> T117, Tensor<float, 3, 3> T165, Tensor<float, 3, 3> T206, Tensor<float, 3, 3> T212) {
  ...
  warp::warpReduceTIDX<false, true>(T159[0], T284[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, static_cast<float>(0.000000000e+00f), DefaultBlockDim());
  ...
  warp::warpReduceTIDX<false, true>(T171[0], T285[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, static_cast<float>(0.000000000e+00f), DefaultBlockDim());
