...
__global__ void nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 3, 3> T0, Tensor<__bfloat, 3, 3> T1, Tensor<__bfloat, 2, 2> T2, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, const __grid_constant__ TensorMap var3, Tensor<__bfloat, 2, 2> T4, Tensor<__bfloat, 2, 2> T12) {
  alignas(16) extern __shared__ char array[];
  const unsigned smem_offset = 0;
  nvfuser_index_t i4;
  i4 = ceilDiv((ceilDiv(T0.logical_size[0LL], 128)), 8);
  nvfuser_index_t i5;
  i5 = ceilDiv(((8 * (ceilDiv(T1.logical_size[1LL], 128))) * i4), 132);
  nvfuser_index_t i6;
  ...
  nvfuser_index_t i13;
  i13 = 16384 * ((nvfuser_index_t)threadIdx.y);
  __bfloat* T19 = reinterpret_cast<__bfloat*>(array + smem_offset + 32768);
  unsigned i14;
  i14 = toSmem(T19) + i13;
  ...
  nvfuser_index_t i17;
  i17 = ((nvfuser_index_t)threadIdx.x) / 4;
  nvfuser_index_t i18;
  i18 = i17 / 8;
  nvfuser_index_t i19;
  i19 = i17 % 8;
  ...
  nvfuser_index_t i21;
  i21 = ((i20 + ((16 * T1.logical_size[1LL]) * i18)) + (T1.logical_size[1LL] * i19)) + ((64 * T1.logical_size[1LL]) * ((nvfuser_index_t)threadIdx.y));
  nvfuser_index_t i22;
  i22 = 1024 * T1.logical_size[1LL];
  nvfuser_index_t i23;
  i23 = 128 * T1.logical_size[1LL];
  nvfuser_index_t i24;
  i24 = 8 * T1.logical_size[1LL];
  __bfloat* T20 = reinterpret_cast<__bfloat*>(array + smem_offset + 0);
  unsigned i25;
  i25 = toSmem(T20) + i13;
  const TensorMap* ptr26;
  ptr26 = &var3;
  bool b27;
  ...
  i32 = ((8 + i31) + i19) + i16;
  nvfuser_index_t i33;
  i33 = (9 - T1.logical_size[1LL]) + i20;
  nvfuser_index_t i34;
  i34 = (((-T0.logical_size[0LL]) + i31) + i19) + i16;
  nvfuser_index_t i35;
  i35 = (-T1.logical_size[1LL]) + i20;
  #pragma unroll 1
  for(nvfuser_index_t i36 = 0; i36 < i5; ++i36) {
    nvfuser_index_t i37;
    i37 = ((nvfuser_index_t)blockIdx.x) + (132 * i36);
    nvfuser_index_t i38;
    i38 = i37 / i4;
    nvfuser_index_t i39;
    i39 = 128 * (i38 / 8);
    ...
    i45 = (i16 + i41) + i43;
    nvfuser_index_t i46;
    i46 = ((i21 + i39) + (i22 * i40)) + (i23 * i42);
    bool b47;
    b47 = b30 && (((i32 + i41) + i43) < T0.logical_size[0LL]);
    nvfuser_index_t i48;
    i48 = i33 + i39;
    nvfuser_index_t i49;
    i49 = (i34 + i41) + i43;
    ...
    uint64_t* T21 = reinterpret_cast<uint64_t*>(array + smem_offset + 163840);
    #pragma unroll
    for(nvfuser_index_t i51 = 0; i51 < 3; ++i51) {
      if (((Hopper::electSync(4294967295U) && b27) && b28)) {
        mbarrier::init(toSmem((&T21[i51])), 2U);
      }
    }
    #pragma unroll
    for(nvfuser_index_t i52 = 0; i52 < 3; ++i52) {
      if (((Hopper::electSync(4294967295U) && b27) && b28)) {
        mbarrier::init(toSmem((&T21[(i52 + 3LL)])), 256U);
      }
    }
    __syncthreads();
    if (b29) {
      #pragma unroll 2
      for(nvfuser_index_t i53 = 0; i53 < i6; ++i53) {
        nvfuser_index_t i54;
        i54 = 16384 * (i53 % 3);
        if ((Hopper::electSync(4294967295U) && b27)) {
          mbarrier::waitParity(toSmem((&T21[((i53 % 3) + 3LL)])), (uint32_t)(((i53 / 3) % 2)));
          mbarrier::arriveExpectTX(toSmem((&T21[(i53 % 3)])), 16384U);
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr7, (Array<nvfuser_index_t, 2, 1>{(64 * i53), i39}), toSmem((&T21[(i53 % 3)])) }), (i8 + i54));
          mbarrier::arriveExpectTX(toSmem((&T21[(i53 % 3)])), 16384U);
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr9, (Array<nvfuser_index_t, 2, 1>{(64 * i53), i44}), toSmem((&T21[(i53 % 3)])) }), (i10 + i54));
        }
      }
    } else {
      #pragma unroll
      for(nvfuser_index_t i55 = 0; i55 < 3; ++i55) {
        mbarrier::arrive(toSmem((&T21[(i55 + 3LL)])));
      }
      #pragma unroll 2
      for(nvfuser_index_t i56 = 0; i56 < i6; ++i56) {
        ...
        unsigned i59;
        i59 = i8 + i57;
        mbarrier::waitParity(toSmem((&T21[(i56 % 3)])), (uint32_t)(((i56 / 3) % 2)));
        asm volatile("wgmma.fence.sync.aligned;\n");
        #pragma unroll
        for(nvfuser_index_t i60 = 0; i60 < 4; ++i60) {
          ...
          asm volatile(
            ...
            :"l"((4611686293305294848ULL | ((262143ULL & (uint64_t)(i62)) >> 4ULL))),
             "l"((4611686293305294848ULL | ((262143ULL & (uint64_t)(i63)) >> 4ULL))),
             "n"((uint32_t)(true)),
             "n"(1),
             "n"(1),
             "n"(0),
        ...
        mbarrier::arrive(toSmem((&T21[((i56 % 3) + 3LL)])));
      }
    }
    #pragma unroll
    for(nvfuser_index_t i64 = 0; i64 < 3; ++i64) {
      if (((Hopper::electSync(4294967295U) && b27) && b28)) {
        mbarrier::inval(toSmem((&T21[(i64 + 3LL)])));
      }
    }
    #pragma unroll
    for(nvfuser_index_t i65 = 0; i65 < 3; ++i65) {
      if (((Hopper::electSync(4294967295U) && b27) && b28)) {
        mbarrier::inval(toSmem((&T21[i65])));
      }
    }
    Array<__bfloat, 64, 8> T16;
    #pragma unroll
    ...
    for(nvfuser_index_t i72 = 0; i72 < 8; ++i72) {
      if ((b47 && (i48 < (-(16 * i72))))) {
        asm volatile(
          ...
          :
          :"r"((uint32_t)((toSmem(T19) + ((((nvfuser_index_t)threadIdx.y) * 16384) + (((i72 / 4) * 8192) + ((i12 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i72 % 4) * 2)) ^ (i12 % 8)) * 16))))))),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T16[(8 * i72)]))[0]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T16[(8 * i72)]))[1]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T16[(8 * i72)]))[2]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T16[(8 * i72)]))[3])
        );
      }
    }
    ...
    for(nvfuser_index_t i85 = 0; i85 < 8; ++i85) {
      if ((b47 && (i48 < (-(16 * i85))))) {
        asm volatile(
          "stmatrix.sync.aligned.x4.m8n8.shared.b16 [%0], {%1, %2, %3, %4};\n"
          :
          :"r"((uint32_t)((toSmem(T20) + ((((nvfuser_index_t)threadIdx.y) * 16384) + (((i85 / 4) * 8192) + ((i12 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i85 % 4) * 2)) ^ (i12 % 8)) * 16))))))),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i85)]))[0]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i85)]))[1]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i85)]))[2]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i85)]))[3])
        );
      }
    }
    __syncthreads();
    ...
    for(nvfuser_index_t i73 = 0; i73 < 2; ++i73) {
      ...
      if (b30) {
        if (Hopper::electSync(4294967295U) && b27) {
        Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr15, (Array<nvfuser_index_t, 2, 1>{(i39 + (64 * i73)), i45}) }), (i14 + (8192 * i73)));
        }
      }
    }
    #pragma unroll
    for(nvfuser_index_t i86 = 0; i86 < 2; ++i86) {
      asm volatile("fence.proxy.async;\n");
      if (b30) {
        if (Hopper::electSync(4294967295U) && b27) {
        Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr26, (Array<nvfuser_index_t, 2, 1>{(i39 + (64 * i86)), i45}) }), (i25 + (8192 * i86)));
        }
      }
    }
