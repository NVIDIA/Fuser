...
__global__ void nvfuser_reduction_f0_c1_r0_g18(Tensor<__bfloat, 3, 3> T0, Tensor<__bfloat, 2, 2> T35, Tensor<__bfloat, 1, 1> T254, Tensor<__bfloat, 2, 2> T240, Tensor<__bfloat, 2, 2> T286, Tensor<__bfloat, 2, 2> T243, Tensor<float, 1, 1> T290, Tensor<int64_t, 1, 1> T291) {
  ...
  nvfuser_index_t i1;
  i1 = ((nvfuser_index_t)blockDim.y) * 49152;
  nvfuser_index_t i2;
  i2 = 8 * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i3;
  i3 = (8 * ((nvfuser_index_t)blockDim.x)) * ((nvfuser_index_t)blockIdx.x);
  nvfuser_index_t i4;
  i4 = (((24576 * ((nvfuser_index_t)threadIdx.y)) + ((i1 * i0) * ((nvfuser_index_t)blockIdx.y))) + i2) + i3;
  nvfuser_index_t i5;
  i5 = 24576 * ((nvfuser_index_t)blockDim.y);
  nvfuser_index_t i6;
  i6 = i2 + i3;
  bool b7;
  b7 = ((7 + i2) + i3) < 24576;
  nvfuser_index_t i8;
  i8 = ((nvfuser_index_t)blockDim.y) * 2;
  nvfuser_index_t i9;
  i9 = (((i8 * ((nvfuser_index_t)blockIdx.y)) * i0) + ((nvfuser_index_t)blockDim.y)) + ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i10;
  i10 = (-2048 + ((nvfuser_index_t)threadIdx.y)) + ((i8 * i0) * ((nvfuser_index_t)blockIdx.y));
  bool b11;
  b11 = (((nvfuser_index_t)blockIdx.y) == (((nvfuser_index_t)gridDim.y) + -1)) && (((nvfuser_index_t)threadIdx.y) == 0);
  // Allocate global tensor T290
  // Allocate global tensor T291
  Array<float, 8, 8> T289;
  #pragma unroll
  for(nvfuser_index_t i12 = 0; i12 < 8; ++i12) {
    T289[i12] = 0.000000000e+00f;
  }
  ...
  for(nvfuser_index_t i13 = 0; i13 < i0; ++i13) {
    ...
    if ((b7 && ((i9 + i15) < 2048))) {
      ...
      #pragma unroll
      for(nvfuser_index_t i17 = 0; i17 < 2; ++i17) {
        loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T283[(8 * i17)],  &T35[(i14 + (i5 * (i17 + nvfuser_zero)))]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 16, 8> T282;
      #pragma unroll
      ...
      #pragma unroll
      for(nvfuser_index_t i18 = 0; i18 < 2; ++i18) {
        loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T282[(8 * i18)],  &T0[(i14 + (i5 * (i18 + nvfuser_zero)))]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 16, 8> T288;
      Array<__bfloat, 16, 8> T285;
      Array<__bfloat, 16, 8> T287;
      #pragma unroll
      for(nvfuser_index_t i12 = 0; i12 < 8; ++i12) {
        #pragma unroll
        for(nvfuser_index_t i19 = 0; i19 < 2; ++i19) {
          ...
          T28[0]
            = T25[0]
            * T23[0];
          Array<__bfloat, 1, 1> T37;
          T37[0]
             = T283[i20];
          Array<float, 1, 1> T39;
          T39[0]
             = __bfloat2float(T37[0]);
          Array<float, 1, 1> T42;
          T42[0]
            = T40[0]
            * T39[0];
          ...
          T45[0]
            = (float) 7.97884999999999955e-01
            * T43[0];
          Array<float, 1, 1> T210;
          T210[0]
            = T40[0]
            * T44[0];
          Array<__bfloat, 1, 1> T219;
          T219[0]
             = __float2bfloat(T210[0]);
          T288[i20]
             = T219[0];
          Array<float, 1, 1> T46;
          T46[0]
          ...
          T55[0]
            = T54[0]
            + T52[0];
          Array<float, 1, 1> T237;
          T237[0]
             = T55[0];
          T289[i12]
            = T289[i12]
            + T237[0];
          Array<__bfloat, 1, 1> T56;
          T56[0]
             = __float2bfloat(T55[0]);
          Array<__bfloat, 1, 1> T57;
          T57[0]
             = T56[0];
          T285[i20]
             = T57[0];
      ...
      for(nvfuser_index_t i21 = 0; i21 < 2; ++i21) {
        loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T240[(i14 + (i5 * (i21 + nvfuser_zero)))], &T285[(8 * i21)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i22 = 0; i22 < 2; ++i22) {
        loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T286[(i14 + (i5 * (i22 + nvfuser_zero)))], &T287[(8 * i22)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i23 = 0; i23 < 2; ++i23) {
        loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T243[(i14 + (i5 * (i23 + nvfuser_zero)))], &T288[(8 * i23)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
    } else {
      Array<__bfloat, 16, 8> T283;
      ...
      for(nvfuser_index_t i17 = 0; i17 < 2; ++i17) {
        nvfuser_index_t i24;
        i24 = i17 + nvfuser_zero;
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i24))))) {
          loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T283[(8 * i17)],  &T35[(i14 + (i5 * i24))]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 16, 8> T282;
      ...
      for(nvfuser_index_t i18 = 0; i18 < 2; ++i18) {
        nvfuser_index_t i25;
        i25 = i18 + nvfuser_zero;
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i25))))) {
          loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T282[(8 * i18)],  &T0[(i14 + (i5 * i25))]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 16, 8> T288;
      ...
      for(nvfuser_index_t i12 = 0; i12 < 8; ++i12) {
        ...
        for(nvfuser_index_t i19 = 0; i19 < 2; ++i19) {
          ...
          T237[0]
             = T55[0];
          if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * (i19 + nvfuser_zero)))))) {
            T289[i12]
              = T289[i12]
              + T237[0];
          }
      ...
      for(nvfuser_index_t i21 = 0; i21 < 2; ++i21) {
        nvfuser_index_t i27;
        i27 = i21 + nvfuser_zero;
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i27))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T240[(i14 + (i5 * i27))], &T285[(8 * i21)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i22 = 0; i22 < 2; ++i22) {
        nvfuser_index_t i28;
        i28 = i22 + nvfuser_zero;
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i28))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T286[(i14 + (i5 * i28))], &T287[(8 * i22)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i23 = 0; i23 < 2; ++i23) {
        nvfuser_index_t i29;
        i29 = i23 + nvfuser_zero;
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i29))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T243[(i14 + (i5 * i29))], &T288[(8 * i23)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
    }
  ...
  if (b7) {
    Array<float, 8, 1> T238;
    #pragma unroll
    for(nvfuser_index_t i30 = 0; i30 < 8; ++i30) {
      T238[i30] = 0.000000000e+00f;
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    reduction::iterGroupedGridReduce<false, true, false, false, true, false, false, false, 8>(
      ...
      DefaultBlockDim());
    NVFUSER_UPDATE_MAGIC_ZERO;
    Array<__bfloat, 8, 8> T284;
    #pragma unroll
    for(nvfuser_index_t i31 = 0; i31 < 8; ++i31) {
      if (b11) {
        T284[i31]
           = __float2bfloat(T238[i31]);
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    if (b11) {
      loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T254[i6], &T284[0]);
    }
  } else {
    Array<float, 8, 1> T238;
    #pragma unroll
