...
__global__ void nvfuser_reduction_f0_c1_r0_g0(Tensor<__bfloat, 4, 5> T0, Tensor<__bfloat, 4, 5> T1, Tensor<__bfloat, 4, 5> T2, Tensor<__bfloat, 1, 2> T11, Tensor<__bfloat, 3, 4> T14, Tensor<float, 1, 1> T18, Tensor<int64_t, 1, 1> T19) {
    ...
    if ((b22 && ((i24 + i37) < 2048))) {
      ...
      for(nvfuser_index_t i30 = 0; i30 < 8; ++i30) {
        ...
        for(nvfuser_index_t i47 = 0; i47 < 4; ++i47) {
          ...
          T3[0]
             = b41 ? T0[(i39 + i49)] : 0.0000e+00f;
          Array<__bfloat, 1, 1> T5;
          T5[0]
             = b43 ? T2[(i42 + i49)] : 0.0000e+00f;
          Array<__bfloat, 1, 1> T4;
          T4[0]
             = b45 ? T1[(i44 + i49)] : 0.0000e+00f;
      ...
      for(nvfuser_index_t i30 = 0; i30 < 8; ++i30) {
        ...
        for(nvfuser_index_t i47 = 0; i47 < 4; ++i47) {
          nvfuser_index_t i58;
          i58 = i47 + nvfuser_zero;
          nvfuser_index_t i59;
          i59 = i8 * i58;
          bool b60;
          b60 = b22 && (i38 < (-(((nvfuser_index_t)blockDim.y) * i58)));
          Array<__bfloat, 1, 1> T3;
          if (b60) {
            T3[0]
               = b52 ? T0[(i50 + i59)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T5;
          if (b60) {
            T5[0]
               = b54 ? T2[(i53 + i59)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T4;
          if (b60) {
            T4[0]
               = b56 ? T1[(i55 + i59)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T6;
          if (b60) {
            T6[0]
  ...
  if (b22) {
    ...
    for(nvfuser_index_t i62 = 0; i62 < 8; ++i62) {
      ...
      if (b26) {
        T15[0]
           = __float2bfloat(T10[i62]);
      }
      if (b26) {
        T11[(i18 + (i62 + nvfuser_zero))]
           = T15[0];
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
