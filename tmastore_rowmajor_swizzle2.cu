...
__global__ void __cluster_dims__(2, 1, 1) nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 3, 3> T0, Tensor<__bfloat, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, Tensor<__bfloat, 2, 2> T3) {
  ...
  for(nvfuser_index_t i22 = 0; i22 < i4; ++i22) {
    ...
    i29 = i14 + i28;
    bool b30;
    b30 = b18 && ((i20 + i28) < T0.logical_size[0LL]);
    nvfuser_index_t i31;
    i31 = (i21 + i25) + i26;
    float T2[128];
    ...
    if (b17) {
      ...
      for(nvfuser_index_t i34 = 0; i34 < i5; ++i34) {
        ...
        if ((Hopper::electSync(4294967295U) && b15)) {
          mbarrier::waitParity(toSmem((&T8[((i34 % 3) + 3LL)])), (uint32_t)(((i34 / 3) % 2)));
          mbarrier::arriveExpectTX(toSmem((&T8[(i34 % 3)])), 32768U);
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr6, (Array<nvfuser_index_t, 2, 1>{(64 * i34), i27}), toSmem((&T8[(i34 % 3)])) }), (i7 + (32768 * i35)));
          mbarrier::arriveExpectTX(toSmem((&T8[(i34 % 3)])), 16384U);
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr8, (Array<nvfuser_index_t, 2, 1>{(64 * i34), i28}), toSmem((&T8[(i34 % 3)])) }), (i9 + (16384 * i35)));
        }
      }
    } else {
      #pragma unroll
      ...
      for(nvfuser_index_t i37 = 0; i37 < i5; ++i37) {
        ...
        unsigned i40;
        i40 = i7 + (32768 * i38);
        mbarrier::waitParity(toSmem((&T8[(i37 % 3)])), (uint32_t)(((i37 / 3) % 2)));
        #pragma unroll
        ...
        mbarrier::arrive(toSmem((&T8[((i37 % 3) + 3LL)])));
      }
    }
    #pragma unroll
    ...
    for(nvfuser_index_t i54 = 0; i54 < 4; ++i54) {
      asm volatile("fence.proxy.async;\n");
      if (b18) {
        Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr13, (Array<nvfuser_index_t, 2, 1>{(i27 + (64 * i54)), i29}) }), (i12 + (8192 * i54)));
      }
    }
    __syncthreads();
