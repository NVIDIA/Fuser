...
TEST_F(ResizeTest, CancellableSplitAndCat) {
  auto fusion = std::make_unique<Fusion>();
  FusionGuard fg(fusion.get());
...
TEST_F(ResizeTest, NoncancellableSplitAndCat_AmountMismatch) {
  auto fusion = std::make_unique<Fusion>();
  FusionGuard fg(fusion.get());
...
TEST_F(ResizeTest, NoncancellableSplitAndCat_CatOnlySubsetOfSplitOutputs) {
  auto fusion = std::make_unique<Fusion>();
  FusionGuard fg(fusion.get());
...
TEST_F(ResizeTest, CancellableSplitAndCat_PermuteInBetween) {
  auto fusion = std::make_unique<Fusion>();
  FusionGuard fg(fusion.get());
...
TEST_F(ResizeTest, NoncancellableSplitAndCat_SomeArePermuted) {
  auto fusion = std::make_unique<Fusion>();
  FusionGuard fg(fusion.get());
...
TEST_F(ResizeTest, NoncancellableSplitAndCat_PermutedDifferently) {
  auto fusion = std::make_unique<Fusion>();
  FusionGuard fg(fusion.get());
