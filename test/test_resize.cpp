...
TEST_F(NVFuserTest, FusionSliceForNanoGPT_CUDA) {
  ...
  Slice dim0{IrBuilder::create<Int>(0), IrBuilder::create<Int>(1),IrBuilder::create<Int>(1)};
  Slice dim1{IrBuilder::create<Int>(0), IrBuilder::create<Int>(1),IrBuilder::create<Int>(1)};
  Slice dim2{IrBuilder::create<Int>(0), IrBuilder::create<Int>(128),IrBuilder::create<Int>(1)};
  Slice dim3{IrBuilder::create<Int>(0), IrBuilder::create<Int>(128),IrBuilder::create<Int>(1)};
