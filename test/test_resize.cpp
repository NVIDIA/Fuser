...
TEST_F(NVFuserTest, FusionResizePad1_CUDA) {
  ...
  auto tv1 = pad(tv0, {IrBuilder::create<Scalar>(1), IrBuilder::create<Scalar>(1)});
...
TEST_F(NVFuserTest, FusionResizePad3_CUDA) {
  ...
  auto tv2 = set(tv0);
  auto tv3 = pad(tv2, {IrBuilder::create<Scalar>(1), IrBuilder::create<Scalar>(1)});
...
TEST_F(NVFuserTest, FusionResizePad5_CUDA) {
  ...
  auto tv1 = set(tv0);
  auto tv2 = pad(tv1, {IrBuilder::create<Scalar>(1), IrBuilder::create<Scalar>(1)});
...
TEST_F(NVFuserTest, FusionResizePad8_CUDA) {
  ...
  auto tv1 = set(tv0);
  // Sort of shift(tv1, {-1});
  auto tv2 = pad(tv1, {IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(1)});
  // Sort of shift(tv1, {1});
  auto tv3 = pad(tv1, {IrBuilder::create<Scalar>(1), IrBuilder::create<Scalar>(0)});
...
TEST_F(NVFuserTest, FusionResizeSlice2_CUDA) {
  ...
  auto tv1 = slice(
      tv0,
      {Slice(),
       {IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(shape[1] / 2)}});
...
TEST_F(NVFuserTest, FusionResizeSlice4_CUDA) {
  ...
  auto tv1 = slice(
      tv0, {{IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(2)}, Slice()});
  auto tv2 = slice(tv0, {{IrBuilder::create<Scalar>(2)}, Slice()});
...
TEST_F(NVFuserTest, FusionResizeSlice5_CUDA) {
  ...
  auto tv1 = slice(
      ...
      {Slice(),
       {IrBuilder::create<Scalar>(1),
        sub(tv0->axis(1)->extent(), IrBuilder::create<Scalar>(1))}});
  auto tv2 = sum(tv1, {1});
  fusion.addOutput(tv2);
  auto tv3 = slice(
      tv0,
...
TEST_F(NVFuserTest, FusionResizeReductionSliceScheduler1_CUDA) {
  ...
  auto tv2 = slice(
      tv1,
      {{IrBuilder::create<Scalar>(1),
        sub(tv1->axis(0)->extent(), IrBuilder::create<Scalar>(2))}});
  fusion.addOutput(tv2);
...
TEST_F(NVFuserTest, FusionResizeSoftmaxSliceScheduler2_CUDA) {
  ...
  auto tv2 = slice(
      ...
      {Slice(),
       {IrBuilder::create<Scalar>(1),
        sub(tv1->axis(1)->extent(), IrBuilder::create<Scalar>(2))}});
  fusion.addOutput(tv2);
...
TEST_F(NVFuserTest, FusionSliceForNanoGPT3_CUDA) {
  ...
  auto tv1 = slice(
      tv0,
      {{IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(16)},
       {IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(128)},
       {IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(1024)}});
  auto tv2 = slice(
      tv0,
      {{IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(16)},
       {IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(128)},
       {IrBuilder::create<Scalar>(1024), IrBuilder::create<Scalar>(2048)}});
  auto tv3 = slice(
      tv0,
      {{IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(16)},
       {IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(128)},
       {IrBuilder::create<Scalar>(2048), IrBuilder::create<Scalar>(3072)}});
...
TEST_F(NVFuserTest, ResizeReshapeAndSlice_CUDA) {
  ...
  auto tv2 = slice(
      tv1,
      {{IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(2)},
       {IrBuilder::create<Scalar>(0), IrBuilder::create<Scalar>(2)}});
  fusion->addOutput(tv2);
...
TEST_F(NVFuserTest, ResizePermuteAndSlice_CUDA) {
  ...
  auto tv2 = slice(
      tv1,
      {{IrBuilder::create<Scalar>(1), IrBuilder::create<Scalar>(shape.at(0) - 1)},
       {IrBuilder::create<Scalar>(2), IrBuilder::create<Scalar>(shape.at(1) - 2)}});
