...
__global__ void CUDAGeneratedKernel(Tensor<__half, 4, 4> T0, Tensor<__half, 4, 4> T2, Tensor<__half, 4, 4> T7) {
  int64_t i1380;
  i1380 = T0.size[2] * T0.size[1];
  int64_t i1383;
  i1383 = ((nvfuser_index_t)threadIdx.x) + (128 * ((nvfuser_index_t)blockIdx.x));
  int64_t i1385;
  i1385 = (T0.size[1] * T0.size[2]) * T0.size[3];
  int64_t i1417;
  i1417 = i1383 % i1385;
  int64_t i1394;
  i1394 = T0.size[2] * T0.size[3];
  int64_t i1418;
  i1418 = i1417 % i1394;
  if ((i1383 < (((T0.size[0] * T0.size[1]) * T0.size[2]) * T0.size[3]))) {
    __half T9[1];
    T9[0] = 0;
    T9[0]
       = T2[(((((i1380 * T0.size[3]) * (i1383 / i1385)) + (i1380 * (i1418 % T0.size[3]))) + (T0.size[2] * (i1417 / i1394))) + (i1418 / T0.size[3]))];
    __half T8[1];
    T8[0] = 0;
    T8[0]
       = T0[i1383];
