...
TEST_F(NVFuserTest, IterGroupedGridReduction) {
  Fusion fusion;
  FusionGuard fg(&fusion);
...
// [  FAILED  ] NVFuserTest.FusionWelfordShmoo_CUDA
// [  FAILED  ] OuterReductionTest.GridPersistentWelfordOuterNormLikeHalf256x28x512Scheduler
// [  FAILED  ] OuterReductionTest.GridPersistentWelfordOuterNormLikeFloat256x28x512Scheduler
// [  FAILED  ] OuterReductionTest.GridPersistentWelfordOuterNormWithWeightsLikeWHalf256x28x512Scheduler
// [  FAILED  ] OuterReductionTest.GridPersistentBatchNormChannelsLastHalf256x28x512Scheduler
// [  FAILED  ] OuterReductionTest.GridPersistentBatchNormChannelsLastFloat256x28x512Scheduler