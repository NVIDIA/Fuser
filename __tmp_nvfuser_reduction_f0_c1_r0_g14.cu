...
__global__ void nvfuser_reduction_f0_c1_r0_g14(Tensor<__bfloat, 4, 4> T138, Tensor<__bfloat, 4, 4> T137, Tensor<__bfloat, 4, 4> T136, Tensor<__bfloat, 1, 1> T248, Tensor<__bfloat, 2, 2> T228, Tensor<__bfloat, 2, 2> T284, Tensor<float, 1, 1> T287, Tensor<int64_t, 1, 1> T288) {
  ...
  b19 = ((7 + i14) + i15) < 18432;
  nvfuser_index_t i20;
  i20 = ((nvfuser_index_t)blockDim.y) * 4;
  nvfuser_index_t i21;
  i21 = (((i20 * ((nvfuser_index_t)blockIdx.y)) * i0) + (((nvfuser_index_t)blockDim.y) * 3)) + ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i22;
  i22 = (-2048 + ((nvfuser_index_t)threadIdx.y)) + ((i20 * i0) * ((nvfuser_index_t)blockIdx.y));
  bool b23;
  b23 = (((nvfuser_index_t)blockIdx.y) == (((nvfuser_index_t)gridDim.y) + -1)) && (((nvfuser_index_t)threadIdx.y) == 0);
  nvfuser_index_t i24;
  i24 = 0 + 128;
  nvfuser_index_t i25;
  i25 = i24 + 128;
  // Allocate global tensor T287
  // Allocate global tensor T288
  Array<float, 8, 8> T286;
  #pragma unroll
  for(nvfuser_index_t i26 = 0; i26 < 8; ++i26) {
    T286[i26] = 0.000000000e+00f;
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll 1
  for(nvfuser_index_t i27 = 0; i27 < i0; ++i27) {
    nvfuser_index_t i28;
    i28 = i2 * i27;
    nvfuser_index_t i29;
    i29 = i7 + i28;
    ...
    if ((b19 && ((i21 + i33) < 2048))) {
      ...
      for(nvfuser_index_t i26 = 0; i26 < 8; ++i26) {
        ...
        for(nvfuser_index_t i42 = 0; i42 < 4; ++i42) {
          nvfuser_index_t i43;
          i43 = i8 * (i42 + nvfuser_zero);
          nvfuser_index_t i44;
          i44 = i26 + (8 * i42);
          Array<__bfloat, 1, 1> T139;
          T139[0] = 0;
          T139[0]
             = b37 ? T138[(i35 + i43)] : 0.0000e+00f;
          Array<__bfloat, 1, 1> T141;
          T141[0] = 0;
          T141[0]
             = b39 ? T136[(i38 + i43)] : 0.0000e+00f;
          Array<__bfloat, 1, 1> T140;
          T140[0] = 0;
          T140[0]
             = b41 ? T137[(i40 + i43)] : 0.0000e+00f;
          Array<__bfloat, 1, 1> T142;
          T142[0]
            = (T139[0] | T140[0])
            | T141[0];
          Array<__bfloat, 1, 1> T143;
          T143[0]
             = T142[0];
          Array<float, 1, 1> T214;
          T214[0]
             = __bfloat2float(T143[0]);
          Array<__bfloat, 1, 1> T144;
          T144[0]
             = T143[0];
          T283[i44]
             = T144[0];
      ...
      for(nvfuser_index_t i45 = 0; i45 < 4; ++i45) {
        loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T228[(i32 + (i17 * (i45 + nvfuser_zero)))], &T283[(8 * i45)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i46 = 0; i46 < 4; ++i46) {
        loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T284[(i32 + (i17 * (i46 + nvfuser_zero)))], &T285[(8 * i46)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
    } else {
      Array<__bfloat, 32, 8> T283;
      ...
      for(nvfuser_index_t i26 = 0; i26 < 8; ++i26) {
        ...
        for(nvfuser_index_t i42 = 0; i42 < 4; ++i42) {
          nvfuser_index_t i54;
          i54 = i42 + nvfuser_zero;
          nvfuser_index_t i55;
          i55 = i8 * i54;
          nvfuser_index_t i56;
          i56 = i26 + (8 * i42);
          bool b57;
          b57 = b19 && (i34 < (-(((nvfuser_index_t)blockDim.y) * i54)));
          Array<__bfloat, 1, 1> T139;
          T139[0] = 0;
          if (b57) {
            T139[0]
               = b49 ? T138[(i47 + i55)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T141;
          T141[0] = 0;
          if (b57) {
            T141[0]
               = b51 ? T136[(i50 + i55)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T140;
          T140[0] = 0;
          if (b57) {
            T140[0]
               = b53 ? T137[(i52 + i55)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T142;
          T142[0]
            = (T139[0] | T140[0])
      ...
      for(nvfuser_index_t i45 = 0; i45 < 4; ++i45) {
        nvfuser_index_t i58;
        i58 = i45 + nvfuser_zero;
        if ((b19 && (i34 < (-(((nvfuser_index_t)blockDim.y) * i58))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T228[(i32 + (i17 * i58))], &T283[(8 * i45)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i46 = 0; i46 < 4; ++i46) {
        ...
        if ((b19 && (i34 < (-(((nvfuser_index_t)blockDim.y) * i59))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T284[(i32 + (i17 * i59))], &T285[(8 * i46)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
    }
  ...
  if (b19) {
    Array<float, 8, 1> T226;
    #pragma unroll
    for(nvfuser_index_t i60 = 0; i60 < 8; ++i60) {
      T226[i60] = 0.000000000e+00f;
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    ...
    for(nvfuser_index_t i61 = 0; i61 < 8; ++i61) {
      if (b23) {
        T282[i61]
           = __float2bfloat(T226[i61]);
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    if (b23) {
      loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T248[i18], &T282[0]);
    }
  } else {
    Array<float, 8, 1> T226;
    #pragma unroll
