...
__global__ void nvfuser_pointwise_f0_c1_r0_g10(Tensor<__bfloat, 4, 5> T135, Tensor<__bfloat, 4, 5> T136) {
  nvfuser_index_t i0;
  ...
  if ((((i1 + 7) + i2) < 25165824)) {
    ...
    T284.set(__bfloat(0));
    loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T284[0],  &T135[i0]);
    ...
    loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T136[i3], &T285[0]);
  } else {
    Array<__bfloat, 8, 8> T284;
    T284.set(__bfloat(0));
    if (b4) {
