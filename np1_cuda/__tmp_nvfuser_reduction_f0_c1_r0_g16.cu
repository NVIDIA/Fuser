...
__global__ void nvfuser_reduction_f0_c1_r0_g16(Tensor<__bfloat, 4, 5> T138, Tensor<__bfloat, 4, 5> T137, Tensor<__bfloat, 4, 5> T136, Tensor<__bfloat, 1, 2> T248, Tensor<__bfloat, 2, 3> T228, Tensor<__bfloat, 2, 3> T286, Tensor<float, 1, 1> T289, Tensor<int64_t, 1, 1> T290) {
  ...
  i12 = (((-128 + i4) + i5) + i6) + i3;
  nvfuser_index_t i13;
  i13 = ((nvfuser_index_t)blockDim.y) * 147456;
  nvfuser_index_t i14;
  i14 = 8 * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i15;
  i15 = (8 * ((nvfuser_index_t)blockDim.x)) * ((nvfuser_index_t)blockIdx.x);
  nvfuser_index_t i16;
  i16 = (((36864 * ((nvfuser_index_t)threadIdx.y)) + ((i13 * i0) * ((nvfuser_index_t)blockIdx.y))) + i14) + i15;
  nvfuser_index_t i17;
  i17 = 36864 * ((nvfuser_index_t)blockDim.y);
  nvfuser_index_t i18;
  i18 = i14 + i15;
  bool b19;
  b19 = ((7 + i14) + i15) < 36864;
  ...
  i22 = (-36864 + i14) + i15;
  nvfuser_index_t i23;
  i23 = (-2048 + ((nvfuser_index_t)threadIdx.y)) + ((i20 * i0) * ((nvfuser_index_t)blockIdx.y));
  bool b24;
  b24 = (((nvfuser_index_t)blockIdx.y) == (((nvfuser_index_t)gridDim.y) + -1)) && (((nvfuser_index_t)threadIdx.y) == 0);
  nvfuser_index_t i25;
  i25 = 0 + 128;
  nvfuser_index_t i26;
  i26 = i25 + 128;
  ...
  for(nvfuser_index_t i27 = 0; i27 < 8; ++i27) {
    T288[i27] = 0.000000000e+00f;
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll 1
  for(nvfuser_index_t i28 = 0; i28 < i0; ++i28) {
    nvfuser_index_t i29;
    i29 = i2 * i28;
    nvfuser_index_t i30;
    i30 = i7 + i29;
    ...
    if ((b19 && ((i21 + i34) < 2048))) {
      ...
      for(nvfuser_index_t i27 = 0; i27 < 8; ++i27) {
        ...
        for(nvfuser_index_t i44 = 0; i44 < 4; ++i44) {
          ...
          T139[0] = 0;
          T139[0]
             = b38 ? T138[(i36 + i46)] : 0.0000e+00f;
          Array<__bfloat, 1, 1> T141;
          T141[0] = 0;
          T141[0]
             = b40 ? T136[(i39 + i46)] : 0.0000e+00f;
          Array<__bfloat, 1, 1> T140;
          T140[0] = 0;
          T140[0]
             = b42 ? T137[(i41 + i46)] : 0.0000e+00f;
      ...
      for(nvfuser_index_t i27 = 0; i27 < 8; ++i27) {
        ...
        i55 = i33 + i27;
        bool b56;
        b56 = i22 < (-(i27 + nvfuser_zero));
        #pragma unroll
        for(nvfuser_index_t i44 = 0; i44 < 4; ++i44) {
          nvfuser_index_t i57;
          i57 = i44 + nvfuser_zero;
          nvfuser_index_t i58;
          i58 = i8 * i57;
          nvfuser_index_t i59;
          i59 = i55 + (i17 * i57);
          bool b60;
          b60 = b56 && (i35 < (-(((nvfuser_index_t)blockDim.y) * i57)));
          Array<__bfloat, 1, 1> T139;
          T139[0] = 0;
          if (b60) {
            T139[0]
               = b50 ? T138[(i48 + i58)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T141;
          T141[0] = 0;
          if (b60) {
            T141[0]
               = b52 ? T136[(i51 + i58)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T140;
          T140[0] = 0;
          if (b60) {
            T140[0]
               = b54 ? T137[(i53 + i58)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T142;
          T142[0]
            = (T139[0] | T140[0])
  ...
  if (b19) {
    ...
    for(nvfuser_index_t i62 = 0; i62 < 8; ++i62) {
      Array<__bfloat, 1, 1> T284;
      if (b24) {
        T284[0]
           = __float2bfloat(T226[i62]);
      }
      if (b24) {
        T248[(i18 + (i62 + nvfuser_zero))]
           = T284[0];
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
