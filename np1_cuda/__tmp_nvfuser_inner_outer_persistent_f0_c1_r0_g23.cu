...
__global__ void nvfuser_inner_outer_persistent_f0_c1_r0_g23(Tensor<__bfloat, 3, 3> T5, Tensor<float, 2, 2> T8, Tensor<__bfloat, 1, 1> T22, Tensor<__bfloat, 1, 1> T7, Tensor<float, 3, 3> T10, Tensor<__bfloat, 3, 3> T9, Tensor<bool, 3, 3> T4, Tensor<__bfloat, 3, 3> T1, Tensor<__bfloat, 2, 2> T60, Tensor<__bfloat, 1, 1> T252, Tensor<__bfloat, 1, 1> T253, Tensor<__bfloat, 1, 1> T250, Tensor<__bfloat, 2, 2> T239, Tensor<__bfloat, 2, 2> T316, Tensor<__bfloat, 2, 2> T232, Tensor<float, 3, 3> T319, Tensor<float, 2, 2> T328, Tensor<float, 2, 2> T332, Tensor<float, 2, 2> T336, Tensor<int64_t, 1, 1> T341) {
  ...
  __bfloat* T311 = reinterpret_cast<__bfloat*>(array + smem_offset + 24576);
  uint32_t i10;
  i10 = ((toSmem(T311) + i4) + i5) + i6;
  nvfuser_index_t i11;
  i11 = (i0 + i1) + i2;
  nvfuser_index_t i12;
  i12 = i11 + i8;
  ...
  __bfloat* T303 = reinterpret_cast<__bfloat*>(array + smem_offset + 0);
  uint32_t i14;
  i14 = ((toSmem(T303) + i4) + i5) + i6;
  nvfuser_index_t i15;
  ...
  // Allocate global tensor T328
  // Allocate global tensor T332
  // Allocate global tensor T336
  Array<float, 48, 4> T333;
  #pragma unroll
  for(nvfuser_index_t i28 = 0; i28 < 12; ++i28) {
    ...
    for(nvfuser_index_t i30 = 0; i30 < 4; ++i30) {
      T333[(i29 + i30)] = 0.000000000e+00f;
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  Array<float, 48, 4> T329;
  #pragma unroll
  for(nvfuser_index_t i28 = 0; i28 < 12; ++i28) {
    nvfuser_index_t i31;
    i31 = 4 * i28;
    #pragma unroll
    for(nvfuser_index_t i30 = 0; i30 < 4; ++i30) {
      T329[(i31 + i30)] = 0.000000000e+00f;
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  Array<float, 48, 4> T337;
  #pragma unroll
  ...
  for(nvfuser_index_t i35 = 0; i35 < 15; ++i35) {
    ...
    T82[0]
       = T81[0];
    Array<float, 1, 1> T293;
    T293[0]
       = T307[0];
    Array<float, 1, 1> T294;
    T294[0]
       = T293[0];
    Array<float, 1, 1> T83;
    T83[0]
    ...
    for(nvfuser_index_t i44 = 0; i44 < 12; ++i44) {
      ...
      if ((b41 && (i18 < (-i45)))) {
        loadGlobalToLocal<bool, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T309[(4 * i44)],  &T4[(i39 + i45)]);
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    #pragma unroll
    ...
    for(nvfuser_index_t i48 = 0; i48 < 12; ++i48) {
      ...
      if ((b41 && (i18 < (-i49)))) {
        loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T308[(4 * i48)],  &T9[(i39 + i49)]);
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    Array<float, 1, 1> T72;
    T72[0]
       = T66[0];
    Array<float, 1, 1> T327;
    T327[0] = 0.000000000e+00f;
    Array<float, 1, 1> T340;
    T340[0] = 0.000000000e+00f;
    ...
    for(nvfuser_index_t i28 = 0; i28 < 12; ++i28) {
      ...
      if ((b41 && (i18 < i55))) {
        ...
        Array<__bfloat, 4, 4> T326;
        T326.set(__bfloat(0));
        loadGeneric<__bfloat, 4>( &T326[0],  &T306[i52]);
        Array<__bfloat, 4, 4> T323;
        T323.set(__bfloat(0));
        loadGeneric<__bfloat, 4>( &T323[0],  &T311[i52]);
        Array<__bfloat, 4, 4> T321;
        T321.set(__bfloat(0));
        loadGeneric<__bfloat, 4>( &T321[0],  &T303[i52]);
        ...
        loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T239[i54], &T315[0]);
      } else {
        Array<__bfloat, 4, 4> T305;
        T305.set(__bfloat(0));
        if (b56) {
    ...
    warp::warpReduceTIDXY<32, 8, true>(T78[0], T340[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, static_cast<float>(0.000000000e+00f), DefaultBlockDim());
    Array<float, 1, 1> T79;
    ...
    warp::warpReduceTIDXY<32, 8, true>(T90[0], T327[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, static_cast<float>(0.000000000e+00f), DefaultBlockDim());
    Array<float, 1, 1> T93;
    ...
    for(nvfuser_index_t i32 = 0; i32 < 12; ++i32) {
      ...
      if ((b41 && (i18 < i64))) {
        ...
        T322.set(__bfloat(0));
        loadGeneric<__bfloat, 4>( &T322[0],  &T303[i60]);
        Array<__bfloat, 4, 4> T324;
        T324.set(__bfloat(0));
        loadGeneric<__bfloat, 4>( &T324[0],  &T311[i60]);
        Array<__bfloat, 4, 4> T325;
        T325.set(__bfloat(0));
        loadGeneric<__bfloat, 4>( &T325[0],  &T306[i60]);
        Array<__bfloat, 4, 4> T310;
        T310.set(__bfloat(0));
        loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T310[0],  &T1[i62]);
        Array<float, 4, 4> T320;
        Array<__bfloat, 4, 4> T317;
        Array<__bfloat, 4, 4> T318;
        #pragma unroll
        for(nvfuser_index_t i34 = 0; i34 < 4; ++i34) {
          nvfuser_index_t i67;
          i67 = i63 + i34;
          ...
          T287[0]
             = __bfloat2float(T322[i34]);
          Array<float, 1, 1> T289;
          T289[0]
            = T287[0]
            * T288[0];
          Array<float, 1, 1> T290;
          T290[0]
            = T289[0]
            * (float) 1.11111000000000004e+00;
          Array<float, 1, 1> T286;
          T286[0]
             = __bfloat2float(T308[i67]);
          ...
          T277[0]
             = __bfloat2float(T310[i34]);
          Array<__bfloat, 1, 1> T295;
          T295[0]
             = T325[i34];
          ...
          Array<__bfloat, 1, 1> T298;
          T298[0]
             = T324[i34];
          Array<float, 1, 1> T299;
          T299[0]
             = __bfloat2float(T298[0]);
          Array<float, 1, 1> T300;
          T300[0]
            = T297[0]
            * T299[0];
          Array<float, 1, 1> T301;
          T301[0]
            = T294[0]
            * T300[0];
        ...
        loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T316[i62], &T317[0]);
        loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T232[i62], &T318[0]);
        loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/false>( &T319[i62], &T320[0]);
      } else {
        Array<__bfloat, 4, 4> T322;
        T322.set(__bfloat(0));
        if (b66) {
  ...
  for(nvfuser_index_t i69 = 0; i69 < 12; ++i69) {
    ...
    if ((i18 < (-i70))) {
      loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/true>( &*(volatile float*)&T328[(i12 + i70)], &T329[(4 * i69)]);
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll
  for(nvfuser_index_t i71 = 0; i71 < 12; ++i71) {
    ...
    if ((i18 < (-i72))) {
      loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/true>( &*(volatile float*)&T332[(i12 + i72)], &T333[(4 * i71)]);
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll
  for(nvfuser_index_t i73 = 0; i73 < 12; ++i73) {
    ...
    if ((i18 < (-i74))) {
      loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/true>( &*(volatile float*)&T336[(i12 + i74)], &T337[(4 * i73)]);
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  // Allocate global tensor T341
  grid_sync::sync<false, true, false, true, true>(T341[index_utils::maskedOffset<true, false, true>(blockIdx, gridDim)], index_utils::maskedSize<false, true, false>(gridDim), DefaultBlockDim());
  Array<float, 72, 4> T338;
  #pragma unroll
  for(nvfuser_index_t i75 = 0; i75 < 18; ++i75) {
    T338.set(float(0.000000000e+00f));
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll
  for(nvfuser_index_t i75 = 0; i75 < 18; ++i75) {
    ...
    if ((b22 && (i23 < (-(8 * i76))))) {
      loadGlobalToLocal<float, /*vec_size=*/4, /*is_volatile=*/true, CacheOp::Streaming>(&T338[(4 * i75)],  &*(volatile float*)&T336[(i16 + (98304 * i76))]);
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  Array<__bfloat, 4, 4> T314;
  #pragma unroll
  for(nvfuser_index_t i77 = 0; i77 < 4; ++i77) {
    Array<float, 1, 1> T339;
    T339[0] = 0.000000000e+00f;
    #pragma unroll
    ...
    blockReduce<false, true, false, true>(T230[0], T339[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, true, float(0.000000000e+00f), DefaultBlockDim());
    T314[i77]
       = __float2bfloat(T230[0]);
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  if (b24) {
    loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T250[i17], &T314[0]);
  }
  Array<float, 72, 4> T334;
  #pragma unroll
  for(nvfuser_index_t i79 = 0; i79 < 18; ++i79) {
    T334.set(float(0.000000000e+00f));
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll
  for(nvfuser_index_t i79 = 0; i79 < 18; ++i79) {
    ...
    if ((b22 && (i23 < (-(8 * i80))))) {
      loadGlobalToLocal<float, /*vec_size=*/4, /*is_volatile=*/true, CacheOp::Streaming>(&T334[(4 * i79)],  &*(volatile float*)&T332[(i16 + (98304 * i80))]);
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  ...
  for(nvfuser_index_t i81 = 0; i81 < 4; ++i81) {
    Array<float, 1, 1> T335;
    T335[0] = 0.000000000e+00f;
    #pragma unroll
    ...
    blockReduce<false, true, false, true>(T236[0], T335[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, true, float(0.000000000e+00f), DefaultBlockDim());
    T313[i81]
       = __float2bfloat(T236[0]);
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  if (b24) {
    loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T253[i17], &T313[0]);
  }
  Array<float, 72, 4> T330;
  #pragma unroll
  for(nvfuser_index_t i83 = 0; i83 < 18; ++i83) {
    T330.set(float(0.000000000e+00f));
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll
  for(nvfuser_index_t i83 = 0; i83 < 18; ++i83) {
    ...
    if ((b22 && (i23 < (-(8 * i84))))) {
      loadGlobalToLocal<float, /*vec_size=*/4, /*is_volatile=*/true, CacheOp::Streaming>(&T330[(4 * i83)],  &*(volatile float*)&T328[(i16 + (98304 * i84))]);
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  ...
  for(nvfuser_index_t i85 = 0; i85 < 4; ++i85) {
    Array<float, 1, 1> T331;
    T331[0] = 0.000000000e+00f;
    #pragma unroll
    ...
    blockReduce<false, true, false, true>(T234[0], T331[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, true, float(0.000000000e+00f), DefaultBlockDim());
    T312[i85]
       = __float2bfloat(T234[0]);
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  if (b24) {
    loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T252[i17], &T312[0]);
  }
}
