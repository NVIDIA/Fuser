...
__global__ void nvfuser_pointwise_f0_c1_r0_g8(Tensor<__bfloat, 4, 5> T133, Tensor<__bfloat, 4, 5> T138) {
  nvfuser_index_t i0;
  i0 = (((12288 * (((nvfuser_index_t)threadIdx.x) / 16)) + (8 * (((nvfuser_index_t)threadIdx.x) % 16))) + (98304 * (((nvfuser_index_t)blockIdx.x) % 256))) + (128 * (((nvfuser_index_t)blockIdx.x) / 256));
  nvfuser_index_t i1;
  i1 = 8 * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i2;
  i2 = 1024 * ((nvfuser_index_t)blockIdx.x);
  nvfuser_index_t i3;
  i3 = i1 + i2;
  bool b4;
  b4 = ((7 + i1) + i2) < 25165824;
  if ((((i1 + 7) + i2) < 25165824)) {
    ...
    T284.set(__bfloat(0));
    loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T284[0],  &T133[i0]);
    ...
    loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T138[i3], &T285[0]);
  } else {
    Array<__bfloat, 8, 8> T284;
    T284.set(__bfloat(0));
    if (b4) {
