...
__global__ void nvfuser_reduction_f0_c1_r0_g19(Tensor<__bfloat, 3, 4> T0, Tensor<__bfloat, 2, 3> T35, Tensor<__bfloat, 1, 2> T254, Tensor<__bfloat, 2, 3> T240, Tensor<__bfloat, 2, 3> T288, Tensor<__bfloat, 2, 3> T243, Tensor<float, 1, 1> T292, Tensor<int64_t, 1, 1> T293) {
  ...
  nvfuser_index_t i1;
  i1 = ((nvfuser_index_t)blockDim.y) * 98304;
  nvfuser_index_t i2;
  i2 = 8 * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i3;
  i3 = (8 * ((nvfuser_index_t)blockDim.x)) * ((nvfuser_index_t)blockIdx.x);
  nvfuser_index_t i4;
  i4 = (((49152 * ((nvfuser_index_t)threadIdx.y)) + ((i1 * i0) * ((nvfuser_index_t)blockIdx.y))) + i2) + i3;
  nvfuser_index_t i5;
  i5 = 49152 * ((nvfuser_index_t)blockDim.y);
  nvfuser_index_t i6;
  i6 = i2 + i3;
  bool b7;
  b7 = ((7 + i2) + i3) < 49152;
  bool b8;
  b8 = (((nvfuser_index_t)threadIdx.x) + (((nvfuser_index_t)blockDim.x) * ((nvfuser_index_t)blockIdx.x))) < 6144;
  bool b9;
  b9 = b7 && b8;
  nvfuser_index_t i10;
