...
if __name__ == '__main__':
    ...
    parser.add_argument('out_histogram', type=str, help='The image file that will contain the histogram of time changes')
    ...
    for row in data:
        for measurement in row['measurements']:
            comparisons.append(Comparison(row['name'], measurement['real_time'],
                               measurement['real_time_other'], measurement['time'] + 1))
