...
sudo apt-get update
sudo apt-get -y install ninja-build cuda-compiler-12-8 cuda-command-line-tools-12-8 cuda-libraries-dev-12-8 libnccl-dev clang-19 g++-13 libstdc++-13-dev nlohmann-json3-dev
