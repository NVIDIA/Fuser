TEST_F(NVFuserTest, FusionGeneratedTest_CUDA) {
...

  {
    ...
    fusion->addInput(tv2);
    auto tv3 = expand(broadcast(tv0, {true, true, false}), {IrBuilder::create<Scalar>(1), IrBuilder::create<Scalar>(1024), IrBuilder::create<Scalar>(768)});
    auto tv4 = expand(broadcast(tv1, {true, true, false}), {IrBuilder::create<Scalar>(1), IrBuilder::create<Scalar>(1024), IrBuilder::create<Scalar>(768)});
    ...
    auto tv19 = expand(broadcast(tv17, {false, false, true}), {IrBuilder::create<Scalar>(1), IrBuilder::create<Scalar>(1024), IrBuilder::create<Scalar>(1)});
    auto tv20 = expand(broadcast(tv18, {false, false, true}), {IrBuilder::create<Scalar>(1), IrBuilder::create<Scalar>(1024), IrBuilder::create<Scalar>(1)});
    auto s21 = IrBuilder::create<Scalar>(1e-05);
    auto tv22 = add(tv19, s21);
    auto tv23 = expand(broadcast(tv20, {false, false, false}), {IrBuilder::create<Scalar>(1), IrBuilder::create<Scalar>(1024), IrBuilder::create<Scalar>(768)});
    auto tv24 = rsqrt(tv22);
    auto tv25 = sub(tv16, tv23);
    auto tv26 = expand(broadcast(tv24, {false, false, false}), {IrBuilder::create<Scalar>(1), IrBuilder::create<Scalar>(1024), IrBuilder::create<Scalar>(768)});
