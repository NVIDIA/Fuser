...
#pragma unroll
      for (nvfuser_index_t i17 = 0; i17 < 4LL; ++i17) {
        ...
        // writing more than one element per thread, which means we would
        // otherwise need a larger intermediate buffer than we allocate
        // currently. Instead here I'm reducing directly into the output.
