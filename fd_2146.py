...
# root@viking-prod-230:/opt/pytorch/nvfuser# NVFUSER_PROF=print python 2146.py
...
#     0     2    1868.104  1867.779   608.679     0.594     594.743   17.74      0       0.265      2659.397   79.33  235.344   470.221       [8192, 16]    122      [112, 4, 1]      [128, 4, 1] nvfuser_reduction_f0_c1_r0_g0
#     -     -           -         -         -         -           -       -      1       0.324      2539.557   75.76  705.448   117.445        [2048, 0]     52      [1, 264, 1]      [256, 2, 1] nvfuser_inner_outer_persistent_f0_c1_r0_g1

# root@viking-prod-230:/opt/pytorch/nvfuser# NVFUSER_ENABLE=io_to_lower_precision  NVFUSER_PROF=print python 2146.py
# Fus#  NSegs CuEvtTm(ms) HstTm(ms) CmpTm(ms) KerTm(ms) EffBw(GB/s) %PkBw   S-Seg# S-KerTm(ms) S-EffBw(GB/s) S-%PkBw S-In(MB) S-Out(MB) S-Smem[Dyn,Stat] S-Regs S-Grid           S-Block          S-KerName           
#     0     2    2368.339  2368.111   715.433     0.440     802.519   23.94      0       0.207      2268.294   67.66  235.344   235.225      [16384, 16]    127      [112, 4, 1]       [64, 8, 1] nvfuser_reduction_f0_c1_r0_g0
#     -     -           -         -         -         -           -       -      1       0.228      2579.230   76.94  470.452   117.445       [2048, 16]     64      [1, 264, 1]      [128, 4, 1] nvfuser_inner_outer_persistent_f0_c1_r0_g1