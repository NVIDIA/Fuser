...
__global__ void nvfuser_reduction_f0_c1_r0_g20(Tensor<bool, 3, 3> T2, Tensor<__bfloat, 3, 3> T1, Tensor<__bfloat, 1, 1> T256, Tensor<__bfloat, 2, 2> T244, Tensor<__bfloat, 2, 2> T286, Tensor<float, 1, 1> T289, Tensor<int64_t, 1, 1> T290) {
  ...
  nvfuser_index_t i4;
  i4 = (((12288 * ((nvfuser_index_t)threadIdx.y)) + ((i1 * i0) * ((nvfuser_index_t)blockIdx.y))) + i2) + i3;
  nvfuser_index_t i5;
  i5 = 12288 * ((nvfuser_index_t)blockDim.y);
  nvfuser_index_t i6;
  i6 = i2 + i3;
  bool b7;
  b7 = ((7 + i2) + i3) < 12288;
  nvfuser_index_t i8;
  i8 = ((nvfuser_index_t)blockDim.y) * 4;
  nvfuser_index_t i9;
  i9 = (((i8 * ((nvfuser_index_t)blockIdx.y)) * i0) + (((nvfuser_index_t)blockDim.y) * 3)) + ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i10;
  ...
  // Allocate global tensor T289
  // Allocate global tensor T290
  Array<float, 8, 8> T288;
  #pragma unroll
  for(nvfuser_index_t i12 = 0; i12 < 8; ++i12) {
    T288[i12] = 0.000000000e+00f;
  }
  ...
  for(nvfuser_index_t i13 = 0; i13 < i0; ++i13) {
    ...
    if ((b7 && ((i9 + i15) < 2048))) {
      ...
      #pragma unroll
      for(nvfuser_index_t i17 = 0; i17 < 4; ++i17) {
        loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T283[(8 * i17)],  &T1[(i14 + (i5 * (i17 + nvfuser_zero)))]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<bool, 32, 8> T282;
      #pragma unroll
      ...
      #pragma unroll
      for(nvfuser_index_t i18 = 0; i18 < 4; ++i18) {
        loadGlobalToLocal<bool, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T282[(8 * i18)],  &T2[(i14 + (i5 * (i18 + nvfuser_zero)))]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 32, 8> T285;
      Array<__bfloat, 32, 8> T287;
      #pragma unroll
      for(nvfuser_index_t i12 = 0; i12 < 8; ++i12) {
        #pragma unroll
        for(nvfuser_index_t i19 = 0; i19 < 4; ++i19) {
          ...
          T29[0]
            = T27[0]
            * T26[0];
          Array<float, 1, 1> T241;
          T241[0]
             = T29[0];
          T288[i12]
            = T288[i12]
            + T241[0];
          Array<__bfloat, 1, 1> T31;
          T31[0]
             = __float2bfloat(T29[0]);
          Array<__bfloat, 1, 1> T33;
          T33[0]
             = T31[0];
          T285[i20]
             = T33[0];
      ...
      for(nvfuser_index_t i21 = 0; i21 < 4; ++i21) {
        loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T244[(i14 + (i5 * (i21 + nvfuser_zero)))], &T285[(8 * i21)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      ...
      for(nvfuser_index_t i17 = 0; i17 < 4; ++i17) {
        nvfuser_index_t i23;
        i23 = i17 + nvfuser_zero;
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i23))))) {
          loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T283[(8 * i17)],  &T1[(i14 + (i5 * i23))]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<bool, 32, 8> T282;
      ...
      for(nvfuser_index_t i18 = 0; i18 < 4; ++i18) {
        nvfuser_index_t i24;
        i24 = i18 + nvfuser_zero;
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i24))))) {
          loadGlobalToLocal<bool, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T282[(8 * i18)],  &T2[(i14 + (i5 * i24))]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 32, 8> T285;
      ...
      for(nvfuser_index_t i21 = 0; i21 < 4; ++i21) {
        nvfuser_index_t i26;
        i26 = i21 + nvfuser_zero;
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i26))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T244[(i14 + (i5 * i26))], &T285[(8 * i21)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i22 = 0; i22 < 4; ++i22) {
        nvfuser_index_t i27;
        i27 = i22 + nvfuser_zero;
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i27))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T286[(i14 + (i5 * i27))], &T287[(8 * i22)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
    }
  ...
  if (b7) {
    Array<float, 8, 1> T242;
    #pragma unroll
    for(nvfuser_index_t i28 = 0; i28 < 8; ++i28) {
      T242[i28] = 0.000000000e+00f;
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    ...
    for(nvfuser_index_t i29 = 0; i29 < 8; ++i29) {
      if (b11) {
        T284[i29]
           = __float2bfloat(T242[i29]);
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    if (b11) {
      loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T256[i6], &T284[0]);
    }
  } else {
    Array<float, 8, 1> T242;
    #pragma unroll
