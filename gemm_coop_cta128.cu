...
__global__ __launch_bounds__(384) void nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 3, 3> T0, Tensor<__bfloat, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, Tensor<__bfloat, 2, 2> T3) {
  ...
  nvfuser_index_t i4;
  i4 = ceilDiv(((grid_swizzle_factor * (ceilDiv(T1.logical_size[1LL], 128))) * i3), 132);
  nvfuser_index_t i5;
  ...
  unsigned i9;
  i9 = toSmem(T4);
  nvfuser_index_t TIDy = (nvfuser_index_t)threadIdx.y;
  TIDy = __shfl_sync(0xffffffff, TIDy, 0);
  uint64_t i10;
  i10 = 4611686293305294848ULL + ((i9 + (8192 * TIDy)) >> 4ULL);
  nvfuser_index_t i11;
  ...
  b15 = __shfl_sync(0xffffffff, b15, 0);
  bool b16;
  b16 = TIDy == 0ULL;
  b16 = __shfl_sync(0xffffffff, b16, 0);
  bool b17;
  b17 = TIDy == 2;
  b17 = __shfl_sync(0xffffffff, b17, 0);
  bool b18;
  b18 = TIDy < 2;
  b18 = __shfl_sync(0xffffffff, b18, 0);
  nvfuser_index_t i19;
  ...
  i21 = (9 - T1.logical_size[1LL]) + (2 * (((nvfuser_index_t)threadIdx.x) % 4));
    ...
    for(nvfuser_index_t i32 = 0; i32 < load_stages; ++i32) {
      if (((Hopper::electSync(4294967295U) && b15) && b16)) {
        mbarrier::init(toSmem((&T8[i32])), 2U);
      }
    }
    #pragma unroll
    for(nvfuser_index_t i33 = 0; i33 < load_stages; ++i33) {
      if (((Hopper::electSync(4294967295U) && b15) && b16)) {
        mbarrier::init(toSmem((&T8[(i33 + load_stages)])), 256U);
      }
    }
    __syncthreads();
    ...
    if (b18) {
      #pragma unroll
      for(nvfuser_index_t i36 = 0; i36 < load_stages; ++i36) {
        mbarrier::arrive(toSmem((&T8[(i36 + load_stages)])));
      }
    }
  StageIteratorWithParity<load_stages> producer_iter{0, 0};
  #pragma unroll 1
  for(nvfuser_index_t i22 = 0; i22 < i4; ++i22) {
    ...
    i29 = (i14 + i26) + i27;
    bool b30;
    b30 = b18 && (((i20 + i26) + i27) < T0.logical_size[0LL]);
    nvfuser_index_t i31;
    i31 = i21 + i25;
    float T2[64];
    ...
    if (b17) {
      if ((Hopper::electSync(4294967295U) && b15)) {
        ...
        for(nvfuser_index_t i34 = 0; i34 < i5; ++i34) {
          nvfuser_index_t i35;
          i35 = 16384 * producer_iter.slot;
          mbarrier::waitParity(toSmem((&T8[(producer_iter.slot + load_stages)])), producer_iter.parity);
          mbarrier::arriveExpectTX(toSmem((&T8[producer_iter.slot])), 16384U);
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr6, (Array<nvfuser_index_t, 2, 1>{(64 * i34), i25}), toSmem((&T8[producer_iter.slot])) }), (i7 + i35));
          mbarrier::arriveExpectTX(toSmem((&T8[producer_iter.slot])), 16384U);
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr8, (Array<nvfuser_index_t, 2, 1>{(64 * i34), i28}), toSmem((&T8[producer_iter.slot])) }), (i9 + i35));
          ++producer_iter;
        }
      }
    } else {
      ...
      // TODO: We should probably verify that i5 >= STAGES_IN_FLIGHT during execution
#define STAGES_IN_FLIGHT 1
      ...
      StageIteratorWithParity<load_stages> read_iter{initial_slot, initial_parity};
      StageIterator<load_stages> release_iter{initial_slot};
     ...
     "n"(0) \
      ...
      for(nvfuser_index_t i47 = 0; i47 < 16; ++i47) {
        ...
        for(nvfuser_index_t i49 = 0; i49 < 2; ++i49) {
          ...
          i50 = i48 + (2 * i49);
          #pragma unroll
          for(nvfuser_index_t i51 = 0; i51 < 2; ++i51) {
            nvfuser_index_t i52;
            i52 = i50 + i51;
            T6[i52]
               = __float2bfloat(T2[i52]);
          }
        }
      }
      asm volatile("cp.async.bulk.wait_group.read %0;\n"::"n"(0LL):"memory");
      #pragma unroll
      for(nvfuser_index_t i53 = 0; i53 < 8; ++i53) {
        if ((b30 && (i31 < (-(16 * i53))))) {
          asm volatile(
            "stmatrix.sync.aligned.x4.m8n8.shared.b16 [%0], {%1, %2, %3, %4};\n"
            :
            :"r"((uint32_t)((toSmem(T7) + ((((nvfuser_index_t)threadIdx.y) * 16384) + (((i53 / 4) * 8192) + ((i11 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i53 % 4) * 2)) ^ (i11 % 8)) * 16))))))),
             "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T6[(8 * i53)]))[0]),
             "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T6[(8 * i53)]))[1]),
             "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T6[(8 * i53)]))[2]),
             "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T6[(8 * i53)]))[3])
          );
        }
      }
