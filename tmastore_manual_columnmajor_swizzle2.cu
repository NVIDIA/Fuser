...
+    i31 = i21 + i25;
    ...
    nvfuser_index_t i25_new = 256 * (i24_new / 2);
    nvfuser_index_t i26_new = 256 * (i23 % i3);
    nvfuser_index_t i24 = 128 * (i24_new % 2);
    nvfuser_index_t i25 = i26_new + i24;
    nvfuser_index_t i26 = (i14 + i26_new) + i24;
    bool b27 = b18 && (((i20 + i26_new) + i24) < T0.logical_size[0LL]);
    nvfuser_index_t i28 = i21 + i25_new;
