...
__global__ void nvfuser_inner_persistent_f0_c1_r0_g1(Tensor<__half, 4, 4> T2, Tensor<__half, 1, 1> T0, Tensor<__half, 1, 1> T1, Tensor<float, 5, 5> T46, Tensor<float, 2, 2> T48, Tensor<__half, 5, 5> T39) {
  alignas(16) extern __shared__ char array[];
  void* shared_mem = array;
  NVFUSER_DEFINE_MAGIC_ZERO;
  nvfuser_index_t i0;
  i0 = ((nvfuser_index_t)blockIdx.x) % 32;
  nvfuser_index_t i1;
  i1 = 8 * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i2;
  i2 = ceilDiv(T2.logical_size[1LL], 32);
  nvfuser_index_t i3;
  i3 = (i1 + ((256 * T2.logical_size[1LL]) * (((nvfuser_index_t)blockIdx.x) / 32))) + ((256 * i2) * i0);
  nvfuser_index_t i4;
  i4 = ((nvfuser_index_t)threadIdx.x) / 32;
  nvfuser_index_t i5;
  i5 = ceilDiv(T0.logical_size[0LL], 32);
  nvfuser_index_t i6;
  i6 = i4 + (i5 * i0);
  nvfuser_index_t i7;
  i7 = ceilDiv(T1.logical_size[0LL], 32);
  nvfuser_index_t i8;
  i8 = i4 + (i7 * i0);
  nvfuser_index_t i9;
  i9 = i1 + (2048 * ((nvfuser_index_t)blockIdx.x));
  bool b10;
  b10 = ((nvfuser_index_t)threadIdx.x) < 256;
  bool b11;
  b11 = b10 && ((i4 + (i2 * i0)) < T2.logical_size[1LL]);
  nvfuser_index_t i12;
  i12 = (((nvfuser_index_t)threadIdx.x) * 8) + 7;
  bool b13;
  b13 = b10 && (i12 < 2048);
  bool b14;
  b14 = i1 < 2048;
  ...
  b15 = b14 && b10;
  bool b16;
  b16 = ((nvfuser_index_t)threadIdx.x) == 0;
  bool b17;
  b17 = i6 < T0.logical_size[0LL];
  bool b18;
  b18 = i8 < T1.logical_size[0LL];
  bool b19;
  b19 = (((nvfuser_index_t)threadIdx.x) < (32 * i5)) && b17;
  bool b20;
  b20 = (((nvfuser_index_t)threadIdx.x) < (32 * i7)) && b18;
  double d21;
  d21 = (double)(8);
  double d22;
  ...
  d34 = (double)(8);
  double d35;
  d35 = 1.00000000000000000e+00 * d34;
  double d36;
  d36 = (double)(16);
  double d37;
  d37 = (double)(16);
  ...
  float T4[8];
  if (b11) {
    Array<__half, 8, 8> T43;
    T43.set(__half(0));
    loadGlobalToLocal<__half, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T43[0],  &T2[i3]);
    #pragma unroll
  ...
  float T40[1];
  T40[0] = 0.000000000e+00f;
  warp::warpReduceTIDX<false, true>(T40[0], T51[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, static_cast<float>(0.000000000e+00f));
  float T5[1];
  T5[0]
    = T40[0]
    / (float) d39;
  float T11[1];
  broadcast::blockBroadcast<true, false, false, true>(T11[0], T5[0], static_cast<float*>(shared_mem), true);
  float T52[1];
  T52[0] = 0.00000000000000000e+00;
  if (b13) {
    #pragma unroll
  ...
  T49[0]
     = T5[0];
  if (b16) {
    T48[((nvfuser_index_t)blockIdx.x)]
       = T49[0];
  }
  float T6[1];
  T6[0] = 0.00000000000000000e+00;
  warp::warpReduceTIDX<false, true>(T6[0], T52[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, static_cast<float>(0.00000000000000000e+00));
  float T8[1];
  T8[0]
    = T6[0]
    * (float) d33;
  float T9[1];
  broadcast::blockBroadcast<true, false, false, true>(T9[0], T8[0], static_cast<float*>(shared_mem), true);
  float T10[1];
  T10[0]
     = T9[0];
  float T13[1];
  ...
  T47[0]
     = T14[0];
  if (b16) {
    T46[((nvfuser_index_t)blockIdx.x)]
       = T47[0];
  }
  if (((((b13 && (i12 < (256 * i5))) && (i12 < (256 * i7))) && b17) && b18)) {
    ...
    NVFUSER_UPDATE_MAGIC_ZERO;
    loadLocalToGlobal<__half, /*vec_size=*/8, /*is_volatile=*/false>( &T39[i9], &T50[0]);
  } else {
    Array<__half, 8, 8> T50;
    #pragma unroll
    for(nvfuser_index_t i43 = 0; i43 < 8; ++i43) {
