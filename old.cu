...
__global__ void nvfuser_inner_outer_persistent_f0_c1_r0_g0(Tensor<__bfloat, 2, 2> T0, Tensor<__bfloat, 2, 2> T1, Tensor<float, 1, 1> T2, Tensor<float, 2, 2> T3, Tensor<__bfloat, 1, 1> T4, Tensor<__bfloat, 2, 2> T56, Tensor<__bfloat, 1, 1> T57, Tensor<__bfloat, 1, 1> T55, Tensor<float, 2, 2> T78, Tensor<float, 2, 2> T82, Tensor<int64_t, 1, 1> T87) {
  ...
  __bfloat* T73 = reinterpret_cast<__bfloat*>(array + smem_offset + (((((((((ceilDiv((ceilDiv((ceilDiv(T0.logical_size[1LL], 8)), ((nvfuser_index_t)blockDim.x))), 13)) * ((nvfuser_index_t)blockDim.x)) * 104) * 2) + 15) & -16) + ((((ceilDiv((ceilDiv((ceilDiv(T0.logical_size[1LL], 8)), ((nvfuser_index_t)blockDim.x))), 13)) * ((nvfuser_index_t)blockDim.x)) * 104) * 2)) + 15) & -16));
  __bfloat* T69 = reinterpret_cast<__bfloat*>(array + smem_offset + ((((((ceilDiv((ceilDiv((ceilDiv(T0.logical_size[1LL], 8)), ((nvfuser_index_t)blockDim.x))), 13)) * ((nvfuser_index_t)blockDim.x)) * 104) * 2) + 15) & -16));
  __bfloat* T70 = reinterpret_cast<__bfloat*>(array + smem_offset + 0);
  ...
  i2 = a1[0LL];
  nvfuser_index_t i3;
  i3 = ceilDiv(i2, ((nvfuser_index_t)gridDim.y));
  Array<nvfuser_index_t, 2, 1> a4;
  a4 = s0.logical_size;
  nvfuser_index_t i5;
  i5 = a4[1LL];
  nvfuser_index_t i6;
  i6 = ceilDiv((ceilDiv((ceilDiv(i5, 4)), ((nvfuser_index_t)blockDim.x))), ((nvfuser_index_t)gridDim.y));
  nvfuser_index_t i7;
  i7 = ceilDiv(((nvfuser_index_t)gridDim.y), ((nvfuser_index_t)blockDim.y));
  nvfuser_index_t i8;
  i8 = 8 * ((nvfuser_index_t)blockDim.x);
  nvfuser_index_t i9;
  i9 = 8 * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i10;
  i10 = i8 * ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i11;
  i11 = i9 + i10;
  nvfuser_index_t i12;
  i12 = ceilDiv((ceilDiv((ceilDiv(i5, 8)), ((nvfuser_index_t)blockDim.x))), 13);
  nvfuser_index_t i13;
  i13 = i8 * i12;
  nvfuser_index_t i14;
  i14 = i11 + ((i5 * i3) * ((nvfuser_index_t)blockIdx.y));
  nvfuser_index_t i15;
  i15 = i3 * ((nvfuser_index_t)blockIdx.y);
  nvfuser_index_t i16;
  i16 = i11 + (i5 * ((nvfuser_index_t)blockIdx.y));
  nvfuser_index_t i17;
  i17 = 4 * ((nvfuser_index_t)blockDim.x);
  nvfuser_index_t i18;
  i18 = 4 * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i19;
  i19 = i17 * ((nvfuser_index_t)blockIdx.y);
  nvfuser_index_t i20;
  i20 = ((i5 * ((nvfuser_index_t)threadIdx.y)) + i18) + i19;
  nvfuser_index_t i21;
  i21 = i17 * ((nvfuser_index_t)gridDim.y);
  nvfuser_index_t i22;
  i22 = ((nvfuser_index_t)blockDim.y) * i5;
  nvfuser_index_t i23;
  i23 = i18 + i19;
  bool b24;
  b24 = ((nvfuser_index_t)threadIdx.y) < i12;
  nvfuser_index_t i25;
  i25 = ((7 - i5) + i9) + i10;
  nvfuser_index_t i26;
  i26 = ((3 - i5) + i9) + i10;
  ...
  i27 = (3 + i18) + i19;
  bool b28;
  b28 = ((nvfuser_index_t)threadIdx.y) == 0;
  float f29;
  f29 = (float)(i5);
  float f30;
  f30 = reciprocal(f29);
  #pragma unroll
  for(nvfuser_index_t i31 = 0; i31 < 13; ++i31) {
    nvfuser_index_t i32;
    i32 = i13 * (i31 + nvfuser_zero);
    if ((b24 && (i25 < (-i32)))) {
      loadGeneric<__bfloat, 8>( &T73[(i11 + (i13 * i31))],  &T4[(i11 + i32)]);
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  // Allocate global tensor T78
  // Allocate global tensor T82
  Array<float, 104, 4> T83;
  #pragma unroll
  for(nvfuser_index_t i33 = 0; i33 < 13; ++i33) {
    nvfuser_index_t i34;
    i34 = 8 * i33;
    #pragma unroll
    for(nvfuser_index_t i35 = 0; i35 < 8; ++i35) {
      T83[(i34 + i35)] = 0.000000000e+00f;
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  Array<float, 104, 4> T79;
  #pragma unroll
  for(nvfuser_index_t i33 = 0; i33 < 13; ++i33) {
    nvfuser_index_t i36;
    i36 = 8 * i33;
    #pragma unroll
    for(nvfuser_index_t i35 = 0; i35 < 8; ++i35) {
      T79[(i36 + i35)] = 0.000000000e+00f;
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll 1
  for(nvfuser_index_t i37 = 0; i37 < i3; ++i37) {
    nvfuser_index_t i38;
    i38 = i14 + (i5 * i37);
    nvfuser_index_t i39;
    i39 = i15 + i37;
    ...
    b41 = b24 && b40;
    #pragma unroll
    for(nvfuser_index_t i42 = 0; i42 < 13; ++i42) {
      nvfuser_index_t i43;
      i43 = i13 * (i42 + nvfuser_zero);
      if ((b41 && (i25 < (-i43)))) {
        loadGeneric<__bfloat, 8>( &T69[(i11 + (i13 * i42))],  &T0[(i38 + i43)]);
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    #pragma unroll
    for(nvfuser_index_t i44 = 0; i44 < 13; ++i44) {
      nvfuser_index_t i45;
      i45 = i13 * (i44 + nvfuser_zero);
      if ((b41 && (i25 < (-i45)))) {
        loadGeneric<__bfloat, 8>( &T70[(i11 + (i13 * i44))],  &T1[(i38 + i45)]);
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    float T72[1];
    ...
    T43[0]
       = T40[0];
    float T24[1];
    T24[0] = 0.000000000e+00f;
    float T28[1];
    T28[0] = 0.000000000e+00f;
    float T77[1];
    T77[0] = 0.000000000e+00f;
    float T86[1];
    T86[0] = 0.000000000e+00f;
    #pragma unroll
    for(nvfuser_index_t i33 = 0; i33 < 13; ++i33) {
      nvfuser_index_t i46;
      i46 = i11 + (i13 * i33);
      ...
      if (b49) {
        ...
        for(nvfuser_index_t i35 = 0; i35 < 8; ++i35) {
          ...
          T5[0] = 0;
          T5[0]
             = __bfloat2float(T69[i51]);
          float T7[1];
          T7[0] = 0;
          T7[0]
             = __bfloat2float(T73[i51]);
          float T16[1];
          T16[0]
             = T7[0];
          float T17[1];
        ...
        for(nvfuser_index_t i35 = 0; i35 < 8; ++i35) {
          ...
          if (b49) {
            T5[0]
               = __bfloat2float(T69[i53]);
          }
          float T7[1];
          T7[0] = 0;
          if (b50) {
            T7[0]
               = __bfloat2float(T73[i53]);
          }
          float T16[1];
          T16[0]
             = T7[0];
    ...
    NVFUSER_UPDATE_MAGIC_ZERO;
    blockReduce<true, true, false, true>(T24[0], T77[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, true, float(0.000000000e+00f));
    blockReduce<true, true, false, true>(T28[0], T86[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, true, float(0.000000000e+00f));
    float T25[1];
    broadcast::blockBroadcast<true, true, false, true>(T25[0], T24[0], static_cast<float*>(shared_mem), true);
    float T31[1];
    T31[0]
    ...
    T44[0]
      ...
      * T39[0];
    float T29[1];
    broadcast::blockBroadcast<true, true, false, true>(T29[0], T28[0], static_cast<float*>(shared_mem), true);
    float T51[1];
    T51[0]
       = T29[0];
    float T52[1];
    T52[0]
      ...
      * T51[0];
    #pragma unroll
    for(nvfuser_index_t i55 = 0; i55 < 13; ++i55) {
      nvfuser_index_t i56;
      i56 = i11 + (i13 * i55);
      nvfuser_index_t i57;
      i57 = i13 * (i55 + nvfuser_zero);
      nvfuser_index_t i58;
      i58 = i38 + i57;
      bool b59;
      b59 = i25 < (-i57);
      ...
      if (b60) {
        ...
        for(nvfuser_index_t i62 = 0; i62 < 8; ++i62) {
          ...
          T58[0] = 0;
          T58[0]
             = __bfloat2float(T70[i63]);
          float T59[1];
          T59[0] = 0;
          T59[0]
             = __bfloat2float(T73[i63]);
          float T60[1];
          T60[0]
             = T59[0];
          float T61[1];
          ...
          T54[0]
            ...
            + T53[0];
          T74[i62]
             = __float2bfloat(T54[0]);
        }
        loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T56[i58], &T74[0]);
      } else {
        Array<__bfloat, 8, 8> T74;
        #pragma unroll
        for(nvfuser_index_t i62 = 0; i62 < 8; ++i62) {
          ...
          if (b60) {
            T58[0]
               = __bfloat2float(T70[i64]);
          }
          float T59[1];
          T59[0] = 0;
          if (b61) {
            T59[0]
               = __bfloat2float(T73[i64]);
          }
          float T60[1];
          T60[0]
             = T59[0];
  ...
  #pragma unroll
  for(nvfuser_index_t i65 = 0; i65 < 13; ++i65) {
    nvfuser_index_t i66;
    i66 = 8 * i65;
    nvfuser_index_t i67;
    i67 = i13 * i65;
    ...
    nvfuser_index_t i69;
    i69 = -i67;
    if ((b24 && (i25 < (-(i13 * (i65 + nvfuser_zero)))))) {
      #pragma unroll
      for(nvfuser_index_t i70 = 0; i70 < 2; ++i70) {
        loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/true>( &*(volatile float*)&T78[(i68 + (4 * (i70 + nvfuser_zero)))], &T79[(i66 + (4 * i70))]);
      }
    } else {
      #pragma unroll
      for(nvfuser_index_t i70 = 0; i70 < 2; ++i70) {
        nvfuser_index_t i71;
        i71 = 4 * (i70 + nvfuser_zero);
        if ((b24 && (i26 < (i69 - i71)))) {
          loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/true>( &*(volatile float*)&T78[(i68 + i71)], &T79[(i66 + (4 * i70))]);
        }
      }
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll
  for(nvfuser_index_t i72 = 0; i72 < 13; ++i72) {
    nvfuser_index_t i73;
    i73 = 8 * i72;
    nvfuser_index_t i74;
    i74 = i13 * i72;
    ...
    nvfuser_index_t i76;
    i76 = -i74;
    if ((b24 && (i25 < (-(i13 * (i72 + nvfuser_zero)))))) {
      #pragma unroll
      for(nvfuser_index_t i77 = 0; i77 < 2; ++i77) {
        loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/true>( &*(volatile float*)&T82[(i75 + (4 * (i77 + nvfuser_zero)))], &T83[(i73 + (4 * i77))]);
      }
    } else {
      #pragma unroll
      for(nvfuser_index_t i77 = 0; i77 < 2; ++i77) {
        nvfuser_index_t i78;
        i78 = 4 * (i77 + nvfuser_zero);
        if ((b24 && (i26 < (i76 - i78)))) {
          loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/true>( &*(volatile float*)&T82[(i75 + i78)], &T83[(i73 + (4 * i77))]);
        }
      }
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  // Allocate global tensor T87
  grid_sync::sync<false, true, false, true, true>(T87[index_utils::maskedOffset<true, false, true>(blockIdx, gridDim)], index_utils::maskedSize<false, true, false>(gridDim));
  #pragma unroll 1
  for(nvfuser_index_t i79 = 0; i79 < i6; ++i79) {
    nvfuser_index_t i80;
    i80 = i21 * i79;
    nvfuser_index_t i81;
    i81 = i20 + i80;
    ...
    for(nvfuser_index_t i83 = 0; i83 < 4; ++i83) {
      T81[i83] = 0.000000000e+00f;
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    #pragma unroll 1
    for(nvfuser_index_t i84 = 0; i84 < i7; ++i84) {
      Array<float, 4, 4> T80;
      T80.set(float(0.000000000e+00f));
      if ((b82 && ((((nvfuser_index_t)threadIdx.y) + (((nvfuser_index_t)blockDim.y) * i84)) < ((nvfuser_index_t)gridDim.y)))) {
        loadGlobalToLocal<float, /*vec_size=*/4, /*is_volatile=*/true, CacheOp::Streaming>(&T80[0],  &*(volatile float*)&T78[(i81 + (i22 * i84))]);
      }
      #pragma unroll
      for(nvfuser_index_t i83 = 0; i83 < 4; ++i83) {
        T81[i83]
    ...
    Array<__bfloat, 4, 4> T75;
    #pragma unroll
    for(nvfuser_index_t i85 = 0; i85 < 4; ++i85) {
      float T21[1];
      T21[0] = 0.000000000e+00f;
      blockReduce<false, true, false, true>(T21[0], T81[i85], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, true, float(0.000000000e+00f));
      T75[i85]
         = __float2bfloat(T21[0]);
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    if ((b28 && b82)) {
      loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T57[(i23 + i80)], &T75[0]);
    }
  }
  #pragma unroll 1
  for(nvfuser_index_t i86 = 0; i86 < i6; ++i86) {
    nvfuser_index_t i87;
    i87 = i21 * i86;
    nvfuser_index_t i88;
    i88 = i20 + i87;
    ...
    float T85[4];
    #pragma unroll
    for(nvfuser_index_t i90 = 0; i90 < 4; ++i90) {
      T85[i90] = 0.000000000e+00f;
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    #pragma unroll 1
    for(nvfuser_index_t i91 = 0; i91 < i7; ++i91) {
      Array<float, 4, 4> T84;
      T84.set(float(0.000000000e+00f));
      if ((b89 && ((((nvfuser_index_t)threadIdx.y) + (((nvfuser_index_t)blockDim.y) * i91)) < ((nvfuser_index_t)gridDim.y)))) {
        loadGlobalToLocal<float, /*vec_size=*/4, /*is_volatile=*/true, CacheOp::Streaming>(&T84[0],  &*(volatile float*)&T82[(i88 + (i22 * i91))]);
      }
      #pragma unroll
      for(nvfuser_index_t i90 = 0; i90 < 4; ++i90) {
        T85[i90]
    ...
    Array<__bfloat, 4, 4> T76;
    #pragma unroll
    for(nvfuser_index_t i92 = 0; i92 < 4; ++i92) {
      float T18[1];
      T18[0] = 0.000000000e+00f;
      blockReduce<false, true, false, true>(T18[0], T85[i92], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, true, float(0.000000000e+00f));
      T76[i92]
         = __float2bfloat(T18[0]);
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    if ((b28 && b89)) {
      loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T55[(i23 + i87)], &T76[0]);
    }
  }
}
}
