...
__global__ void __cluster_dims__(2, 1, 1) nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 3, 3> T0, Tensor<__bfloat, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, Tensor<__bfloat, 2, 2> T3) {
  ...
  ptr7 = &var1;
  __bfloat* T4 = reinterpret_cast<__bfloat*>(array + smem_offset + 0);
  unsigned i8;
  i8 = toSmem(T4);
  unsigned i9;
  i9 = i8 + (8192 * ((nvfuser_index_t)threadIdx.y));
  nvfuser_index_t i10;
  ...
  i13 = i10 % 8;
  nvfuser_index_t i14;
  i14 = ((i11 + ((16 * T1.logical_size[1LL]) * i12)) + (T1.logical_size[1LL] * i13)) + ((64 * T1.logical_size[1LL]) * ((nvfuser_index_t)threadIdx.y));
  nvfuser_index_t i15;
  i15 = 128 * T1.logical_size[1LL];
  nvfuser_index_t i16;
  i16 = 8 * T1.logical_size[1LL];
  bool b17;
  ...
  nvfuser_index_t i21;
  i21 = (1 - T1.logical_size[1LL]) + i11;
  nvfuser_index_t i22;
  i22 = (((-T0.logical_size[0LL]) + (16 * i12)) + i13) + (64 * ((nvfuser_index_t)threadIdx.y));

    uint64_t* T7 = reinterpret_cast<uint64_t*>(array + smem_offset + 147456);
    #pragma unroll
    for(nvfuser_index_t i31 = 0; i31 < 3; ++i31) {
      if (((Hopper::electSync(4294967295U) && b17) && b18)) {
        mbarrier::init(toSmem((&T7[i31])), 2U);
      }
    }
    #pragma unroll
    for(nvfuser_index_t i32 = 0; i32 < 3; ++i32) {
      if (((Hopper::electSync(4294967295U) && b17) && b18)) {
        mbarrier::init(toSmem((&T7[(i32 + 3LL)])), 256U);
      }
    }
    ...
    if (b20) {
      ...
      for(nvfuser_index_t i35 = 0; i35 < 3; ++i35) {
        mbarrier::arrive(toSmem((&T7[(i35 + 3LL)])));
      }
    }
    ...
    if (b19) {
      ...
      for(nvfuser_index_t i33 = 0; i33 < i4; ++i33) {
        ...
        if ((Hopper::electSync(4294967295U) && b17)) {
          mbarrier::waitParity(toSmem((&T7[(i34 + 3LL)])), (uint32_t)((((i33 / 3) + i23) % 2)));
      ...
      for(nvfuser_index_t i36 = 0; i36 < i4; ++i36) {
        ...
        unsigned i39;
        i39 = i6 + (32768 * i37);
        mbarrier::waitParity(toSmem((&T7[i37])), (uint32_t)((((i36 / 3) + i23) % 2)));
        asm volatile("wgmma.fence.sync.aligned;\n");
        #pragma unroll
      ...
      for(nvfuser_index_t i46 = 0; i46 < 32; ++i46) {
        ...
        for(nvfuser_index_t i51 = 0; i51 < 2; ++i51) {
          nvfuser_index_t i52;
          i52 = i47 + (2 * i51);
          Array<__bfloat, 2, 2> T6;
          #pragma unroll
          for(nvfuser_index_t i53 = 0; i53 < 2; ++i53) {
            T6[i53]
               = __float2bfloat(T2[(i52 + i53)]);
          }
          if ((b50 && (i30 < (-(8 * i51))))) {
            loadLocalToGlobal<__bfloat, /*vec_size=*/2, /*is_volatile=*/false>( &T3[(i49 + (i16 * i51))], &T6[0]);
          }
        }
      }
    }
  }
  /* Don't need to invalidate since we will not be reusing the smem of the mbarriers
     
      #pragma unroll
      for(nvfuser_index_t i44 = 0; i44 < 3; ++i44) {
        if (((Hopper::electSync(4294967295U) && b17) && b18)) {
          mbarrier::inval(toSmem((&T7[(i44 + 3LL)])));
        }
      }
      #pragma unroll
      for(nvfuser_index_t i45 = 0; i45 < 3; ++i45) {
        if (((Hopper::electSync(4294967295U) && b17) && b18)) {
          mbarrier::inval(toSmem((&T7[i45])));
        }
      }
      */
}
