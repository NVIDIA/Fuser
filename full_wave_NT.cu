...
__device__ __inline__ void m64n128k16BF16(Array<float, 64, 1>& out0, uint64_t in0, uint64_t in1, bool in2) {
  asm volatile(
    "{\n"
    "  .reg .pred p0; \n"
    "  setp.ne.b32 p0, %66, 0;\n"
...
__global__ void __launch_bounds__(/*maxThreadsPerBlock=*/384, /*minBlocksPerMultiprocessor=*/1) __cluster_dims__(1, 2, 1) nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 3, 3> T0, Tensor<__bfloat, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, Tensor<__bfloat, 2, 2> T3) {
  alignas(16) extern __shared__ char array[];
  const unsigned smem_offset = 0;
  nvfuser_index_t i3;
  i3 = ceilDiv((ceilDiv(T1.logical_size[2LL], 256)), 8);
  nvfuser_index_t i4;
  i4 = ceilDiv(((128 * (ceilDiv((ceilDiv(T0.logical_size[1LL], 128)), 16))) * i3), 132);
  nvfuser_index_t i5;
  i5 = ceilDiv(T0.logical_size[0LL], 64);
  nvfuser_index_t i6;
  i6 = 2 * i5;
  nvfuser_index_t i7;
  ...
  nvfuser_index_t i21;
  i21 = ((8 - T0.logical_size[1LL]) + (16 * (((nvfuser_index_t)threadIdx.x) / 32))) + ((((nvfuser_index_t)threadIdx.x) / 4) % 8);
  nvfuser_index_t i22;
  i22 = ((9 - T1.logical_size[2LL]) + (2 * (((nvfuser_index_t)threadIdx.x) % 4))) + i12;
  bool b23;
  b23 = b17 && b20;
  ...
  if ((((nvfuser_index_t)threadIdx.y) >= 2)) {
    ...
    if ((((((nvfuser_index_t)threadIdx.x) / 32ULL) == 0ULL) && Hopper::electSync(4294967295U))) {
      ...
      for(nvfuser_index_t i27 = 0; i27 < i4; ++i27) {
        ...
        for(nvfuser_index_t i30 = 0; i30 < 2; ++i30) {
          nvfuser_index_t i31;
          i31 = i28 + (66 * i30);
	  if (i31 >= ((128 * (ceilDiv((ceilDiv(T0.logical_size[1LL], 128)), 16))) * i3)) {
		  continue;
	  }
          nvfuser_index_t i32;
          i32 = i31 % 128;
          ...
          i33 = i31 / 128;
          nvfuser_index_t i34;
          i34 = (128 * (i32 / 8)) + (2048 * (i33 / i3));
          nvfuser_index_t i35;
          i35 = i29 + (i5 * i30);
          nvfuser_index_t i36;
          i36 = (i12 + (256 * (i32 % 8))) + (2048 * (i33 % i3));
          #pragma unroll 1
          for(nvfuser_index_t i37 = 0; i37 < i5; ++i37) {
            int i38;
            i38 = __to_int32((64 * i37));
            nvfuser_index_t i39;
            i39 = 16384 * ((i35 + i37) % 6);
            uint32_t i40;
            i40 = i10 + i39;
    ...
    #pragma unroll 1
    for(nvfuser_index_t i45 = 0; i45 < i4; ++i45) {
      nvfuser_index_t i46;
      i46 = i7 + (i6 * i45);
      nvfuser_index_t i47;
      i47 = i16 + (132 * i45);
      if (i47 >= ((128 * (ceilDiv((ceilDiv(T0.logical_size[1LL], 128)), 16))) * i3)) {
          continue;
      }
      nvfuser_index_t i48;
      i48 = i47 % 128;
      ...
      nvfuser_index_t i57;
      i57 = (i22 + i50) + i51;
      mbarrier::waitParity(toSmem((&T9[(((nvfuser_index_t)threadIdx.y) * 2)])), __to_uint32((i45 % 2)));
      Array<float, 128, 1> T2;
      #pragma unroll 1
      for(nvfuser_index_t i58 = 0; i58 < i5; ++i58) {
        nvfuser_index_t i59;
        i59 = 16384 * ((i46 + i58) % 6);
        uint32_t i60;
        i60 = i10 + i59;
        uint32_t i61;
        i61 = i13 + i59;
        mbarrier::waitParity(toSmem((&T8[(((i7 + (i6 * i45)) + i58) % 6)])), __to_uint32(((((i7 + (i6 * i45)) + i58) / 6) % 2)));
        wgmma::fence();
        #pragma unroll
        for(nvfuser_index_t i62 = 0; i62 < 2; ++i62) {
          ...
          i64 = 64 * i62;
          #pragma unroll
          for(nvfuser_index_t i65 = 0; i65 < 4; ++i65) {
            nvfuser_index_t i66;
            i66 = 2048 * i65;
            uint32_t i67;
            i67 = i63 + i66;
            uint32_t i68;
            i68 = i61 + i66;
            wgmma::m64n128k16BF16<1, 1, 1, 1>((*reinterpret_cast<Array<float, 64, 1>*>(&T2[i64])), (4611686293305294848ULL | ((262143ULL & __to_uint64(i67)) >> 4ULL)), (4611686293338849280ULL | ((262143ULL & __to_uint64(i68)) >> 4ULL)), (!((i58 == 0) && (i65 == 0))));
          }
        }
        wgmma::commit();
        wgmma::wait<1LL>();
      ...
      for(nvfuser_index_t i69 = 0; i69 < 2; ++i69) {
        ...
        i70 = 64 * i69;
        int i71;
        i71 = __to_int32((i55 + i70));
        bool b72;
        b72 = b20 && (i56 < (-i70));
        #pragma unroll
        for(nvfuser_index_t i73 = 0; i73 < 8; ++i73) {
          nvfuser_index_t i74;
          i74 = i70 + (8 * i73);
          Array<__bfloat, 8, 8> T6;
          #pragma unroll
          for(nvfuser_index_t i75 = 0; i75 < 8; ++i75) {
            T6[i75]
