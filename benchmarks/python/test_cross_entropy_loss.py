...
def nvfuser_cross_entropy_fusion(fd: FusionDefinition, batch_size: int, vocab_size: int) -> None:
    """
    ...
    T1 = fd.define_tensor(shape=[batch_size], contiguity=[True], dtype=DataType.Int, is_cpu=False, stride_order=[0])
