...
def test_cat_qwen2_fwd_11(benchmark, executor: str):
    ...
    if executor == "torchcompile":
        ...
        raise NotImplementedError(f"unknown executor '{executor}'")

    run_benchmark(benchmark, benchmark_fn, inputs)


@pytest.mark.parametrize("executor", ["thunder", "torchcompile"])
def test_cat_phi3_1(benchmark, executor: str):
...
@pytest.mark.parametrize("executor", ["thunder", "torchcompile"])
def test_cat_nanogpt_bwd_6(benchmark, executor: str):
