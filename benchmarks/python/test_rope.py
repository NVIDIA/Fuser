...
def test_rope_hf_qwen2_fwd(benchmark):
    ...
    def nvfuser_fusion_id0(fd: FusionDefinition) -> None :
        T0 = fd.define_tensor(shape=[1, 4096, 3584], contiguity=[None, True, True], dtype=DataType.BFloat16, is_cpu=False, stride_order=[2, 1, 0])
        T1 = fd.define_tensor(shape=[1, 4096, 512], contiguity=[None, True, True], dtype=DataType.BFloat16, is_cpu=False, stride_order=[2, 1, 0])
        T2 = fd.define_tensor(shape=[1, 4096, 512], contiguity=[None, True, True], dtype=DataType.BFloat16, is_cpu=False, stride_order=[2, 1, 0])
        T3 = fd.define_tensor(shape=[1, 4096, 128], contiguity=[None, True, True], dtype=DataType.BFloat16, is_cpu=False, stride_order=[2, 1, 0])
        T4 = fd.define_tensor(shape=[1, 4096, 128], contiguity=[None, True, True], dtype=DataType.BFloat16, is_cpu=False, stride_order=[2, 1, 0])
        ...
        T31 = fd.ops.broadcast_in_dim(T3, shape=[1, 1, 4096, 128], broadcast_dims=[0, 2, 3])
        T37 = fd.ops.broadcast_in_dim(T4, shape=[1, 1, 4096, 128], broadcast_dims=[0, 2, 3])
        T43 = fd.ops.broadcast_in_dim(T31, shape=[1, 28, 4096, 128], broadcast_dims=[0, 1, 2, 3])
        T44 = fd.ops.cast(T11, dtype=DataType.Float)
        T45 = fd.ops.cast(T43, dtype=DataType.Float)
        T46 = fd.ops.mul(T44, T45)
        T62 = fd.ops.slice(T11, start_indices=[0, 0, 0, 0], end_indices=[1, 28, 4096, 64], strides=[1, 1, 1, 1], manual_normalization=0)
        T78 = fd.ops.slice(T11, start_indices=[0, 0, 0, 64], end_indices=[1, 28, 4096, 128], strides=[1, 1, 1, 1], manual_normalization=0)
        ...
        T88 = fd.ops.broadcast_in_dim(T37, shape=[1, 28, 4096, 128], broadcast_dims=[0, 1, 2, 3])
        ...
        T99 = fd.ops.broadcast_in_dim(T31, shape=[1, 4, 4096, 128], broadcast_dims=[0, 1, 2, 3])
        T100 = fd.ops.cast(T18, dtype=DataType.Float)
        T101 = fd.ops.cast(T99, dtype=DataType.Float)
        T102 = fd.ops.mul(T100, T101)
        T118 = fd.ops.slice(T18, start_indices=[0, 0, 0, 0], end_indices=[1, 4, 4096, 64], strides=[1, 1, 1, 1], manual_normalization=0)
        T134 = fd.ops.slice(T18, start_indices=[0, 0, 0, 64], end_indices=[1, 4, 4096, 128], strides=[1, 1, 1, 1], manual_normalization=0)
        ...
        T144 = fd.ops.broadcast_in_dim(T37, shape=[1, 4, 4096, 128], broadcast_dims=[0, 1, 2, 3])
        ...
        T156 = fd.ops.broadcast_in_dim(T149, shape=[1, 4, 1, 4096, 128], broadcast_dims=[0, 1, 3, 4])
        T163 = fd.ops.broadcast_in_dim(T156, shape=[1, 4, 7, 4096, 128], broadcast_dims=[0, 1, 2, 3, 4])
        T169 = fd.ops.reshape(T163, new_shape=[1, 28, 4096, 128])
        T176 = fd.ops.broadcast_in_dim(T25, shape=[1, 4, 1, 4096, 128], broadcast_dims=[0, 1, 3, 4])
        T183 = fd.ops.broadcast_in_dim(T176, shape=[1, 4, 7, 4096, 128], broadcast_dims=[0, 1, 2, 3, 4])
