...
class Repro(torch.nn.Module):
    ...
    def forward(self, primals_1, primals_2, primals_3):
        clone = torch.ops.aten.clone.default(primals_3, memory_format = torch.contiguous_format)
        view = torch.ops.aten.view.default(clone, [1024, 32, 8, 256]);  clone = None
...
def load_args(reader):
    ...
    reader.tensor(buf2, (1024, 256, 16, 16), (65536, 1, 4096, 256), dtype=torch.float16, is_leaf=True)  # primals_3
