class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f16[256]", primals_2: "f16[256]", primals_3: "f16[1024, 256, 16, 16]"):
        ...
        view: "f16[1024, 32, 8, 256]" = torch.ops.aten.reshape.default(clone, [1024, 32, 8, 256]);  clone = None
        ...
        view_1: "f32[1024, 256, 16, 16]" = torch.ops.aten.reshape.default(mul, [1024, 256, 16, 16]);  mul = None
