...
__global__ void nvfuser_pointwise_f0_c1_r0_g8(Tensor<__bfloat, 4, 5> T133, Tensor<__bfloat, 4, 5> T138) {
  nvfuser_index_t i0;
  ...
  if (((48 + i0) < 96)) {
    ...
    T284.set(__bfloat(0));
    loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T284[0],  &T133[i1]);
    ...
    loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T138[i4], &T285[0]);
  } else {
    Array<__bfloat, 8, 8> T284;
    T284.set(__bfloat(0));
    if (b5) {
