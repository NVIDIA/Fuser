...
__global__ void nvfuser_pointwise_f0_c1_r0_g8(Tensor<__bfloat, 4, 4> T134, Tensor<__bfloat, 4, 4> T137) {
  nvfuser_index_t i0;
  ...
  if ((((i1 + 7) + i2) < 12582912)) {
    ...
    T282.set(__bfloat(0));
    loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T282[0],  &T134[i0]);
    ...
    loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T137[i3], &T283[0]);
  } else {
    Array<__bfloat, 8, 8> T282;
    T282.set(__bfloat(0));
    if (b4) {
