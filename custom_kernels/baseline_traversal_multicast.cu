...
__global__ void __cluster_dims__(2, 1, 1) nvfuser_none_f0_c0_r0_g0(
    ...
    Tensor<__bfloat, 2, 2> T4) {
  alignas(16) extern __shared__ char array[];
  const unsigned smem_offset = 0;
  nvfuser_index_t i3;
  i3 = ceilDiv((ceilDiv(T1.logical_size[1LL], 256)), 8);
  nvfuser_index_t i4;
  i4 = (ceilDiv((ceilDiv(T0.logical_size[0LL], 128)), 16))*i3;
  nvfuser_index_t i5;
  i5 = ceilDiv(T0.logical_size[2LL], 64);
  const TensorMap* ptr6;
  ptr6 = &var0;
  nvfuser_index_t i7;
  i7 = 256 * (((nvfuser_index_t)blockIdx.x) % 8);
  __bfloat* T6 = reinterpret_cast<__bfloat*>(array + smem_offset + 114688);
  uint32_t i8;
  i8 = toSmem(T6);
  const TensorMap* ptr9;
  ptr9 = &var1;
  nvfuser_index_t i10;
  i10 = 128 * (((nvfuser_index_t)blockIdx.x) / 8);
  __bfloat* T5 = reinterpret_cast<__bfloat*>(array + smem_offset + 65536);
  uint32_t i11;
  i11 = toSmem(T5);
  uint32_t i12;
  i12 = i11 + (8192 * ((nvfuser_index_t)threadIdx.y));
  nvfuser_index_t i13;
  i13 = ((((nvfuser_index_t)threadIdx.x) / 32) * 16) +
      ((((nvfuser_index_t)threadIdx.x) % 32) % 16);
  __bfloat* T8 = reinterpret_cast<__bfloat*>(array + smem_offset + 0);
  uint32_t i14;
  i14 = toSmem(T8) + (32768 * ((nvfuser_index_t)threadIdx.y));
  const TensorMap* ptr15;
  ptr15 = &var2;
  nvfuser_index_t i16;
  i16 = 64 * ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i17;
  i17 = i16 + i10;
  bool b18;
  ...
  bool b21;
  b21 = ((nvfuser_index_t)threadIdx.y) < 2;
  nvfuser_index_t i22;
  i22 = ((nvfuser_index_t)threadIdx.x) / 4;
  nvfuser_index_t i23;
  i23 = (((8 + (16 * (i22 / 8))) + (i22 % 8)) + i16) + i10;
  nvfuser_index_t i24;
  i24 = ((9 - T1.logical_size[1LL]) +
...
#pragma unroll 1
  for (nvfuser_index_t i25 = 0; i25 < i4; ++i25) {
    ...
    i30 = (int32_t)((i17 + i28));
    bool b31;
    b31 = b21 && ((i23 + i28) < T0.logical_size[0LL]);
    nvfuser_index_t i32;
    i32 = i24 + i26;
...
#pragma unroll
    for (nvfuser_index_t i33 = 0; i33 < 3; ++i33) {
      if (((Hopper::electSync(4294967295U) && b18) && b19)) {
        mbarrier::init(toSmem((&T9[i33])), 2U);
      }
    }
#pragma unroll
    for (nvfuser_index_t i34 = 0; i34 < 3; ++i34) {
      if (((Hopper::electSync(4294967295U) && b18) && b19)) {
        mbarrier::init(toSmem((&T9[(i34 + 3LL)])), 256U);
      }
    }
    __syncthreads();
    if (b20) {
#pragma unroll 2
      for (nvfuser_index_t i35 = 0; i35 < i5; ++i35) {
        int i36;
        i36 = (int32_t)((64 * i35));
        nvfuser_index_t i37;
        i37 = i35 % 3;
        ...
        if ((Hopper::electSync(4294967295U) && b18)) {
          mbarrier::waitParity(
              toSmem((&T9[((i35 % 3) + 3LL)])), (uint32_t)(((i35 / 3) % 2)));
          mbarrier::arriveExpectTX(toSmem((&T9[(i35 % 3)])), 32768U);
#pragma unroll
          for (nvfuser_index_t i39 = 0; i39 < 2; ++i39) {
            Hopper::cpAsyncBulkTensorTileG2S(
                (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{
                    ptr6,
                    (Array<int, 2, 1>{i36, (int32_t)((i27 + (128 * i39)))}),
                    toSmem((&T9[(i35 % 3)]))}),
                (i38 + (16384 * i39)));
          }
          mbarrier::arriveExpectTX(toSmem((&T9[(i35 % 3)])), 16384U);
          Hopper::cpAsyncBulkTensorTileG2S(
              (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{
                  ptr9,
                  (Array<int, 2, 1>{i36, i29}),
                  toSmem((&T9[(i35 % 3)]))}),
              (i11 + (16384 * i37)));
        }
      }
...
#pragma unroll
      for (nvfuser_index_t i40 = 0; i40 < 3; ++i40) {
        mbarrier::arrive(toSmem((&T9[(i40 + 3LL)])));
      }
#pragma unroll 2
      for (nvfuser_index_t i41 = 0; i41 < i5; ++i41) {
        nvfuser_index_t i42;
        i42 = i41 % 3;
        uint32_t i43;
        i43 = i12 + (16384 * i42);
        ...
        i44 = i8 + (32768 * i42);
        mbarrier::waitParity(
            toSmem((&T9[(i41 % 3)])), (uint32_t)(((i41 / 3) % 2)));
#pragma unroll
        for (nvfuser_index_t i45 = 0; i45 < 4; ++i45) {
          ...
          wgmma::m64n256k16BF16<1, 1, 0, 0>(
              ...
              (4611686293305294848ULL |
               ((262143ULL & (uint64_t)(i47)) >> 4ULL)),
              (4611686293305294848ULL |
               ((262143ULL & (uint64_t)(i48)) >> 4ULL)),
              true);
        }
        wgmma::commit();
        wgmma::wait<0LL>();
        mbarrier::arrive(toSmem((&T9[((i41 % 3) + 3LL)])));
      }
    }
#pragma unroll
    for (nvfuser_index_t i49 = 0; i49 < 3; ++i49) {
      if (((Hopper::electSync(4294967295U) && b18) && b19)) {
        mbarrier::inval(toSmem((&T9[(i49 + 3LL)])));
      }
    }
#pragma unroll
    for (nvfuser_index_t i50 = 0; i50 < 3; ++i50) {
      if (((Hopper::electSync(4294967295U) && b18) && b19)) {
        mbarrier::inval(toSmem((&T9[i50])));
      }
    }
    wgmma::wait<0LL>();
    Array<__bfloat, 128, 8> T7;
#pragma unroll
    for (nvfuser_index_t i51 = 0; i51 < 32; ++i51) {
      nvfuser_index_t i52;
      i52 = 4 * i51;
#pragma unroll
                 ...
                 (((i57 / 4) * 8192) +
                  ((i13 * 128) +
                   (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) +
                     ...
                     (i13 % 8)) *
                    16)))))),
            (*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T7[(8 * i57)])));
      }
    }
    __syncthreads();
#pragma unroll
    for (nvfuser_index_t i58 = 0; i58 < 4; ++i58) {
      fenceAsyncProxy();
      if (((Hopper::electSync(4294967295U) && b18) && b21)) {
        Hopper::cpAsyncBulkTensorTileS2G(
            (Hopper::CpAsyncBulkTensorTileS2GIndex<2>{
                ptr15, (Array<int, 2, 1>{(int32_t)((i27 + (64 * i58))), i30})}),
            (i14 + (8192 * i58)));
      }
    }
    __syncthreads();
