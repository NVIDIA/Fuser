...
#pragma unroll 2
      for (nvfuser_index_t i40 = 0; i40 < i6; ++i40) {
        ...
        if ((Hopper::electSync(4294967295U) && b23)) {
          mbarrier::waitParity(
              toSmem((&T19[((stage % 3) + 3LL)])),
              (uint32_t)(((stage / 3) % 2)));
          mbarrier::arriveExpectTX(toSmem((&T19[(stage % 3)])), 32768U);
          Hopper::cpAsyncBulkTensorTileG2S(
              (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{
                  ...
                  toSmem((&T19[(stage % 3)]))}),
              (i9 + (32768 * i41)));
          mbarrier::arriveExpectTX(toSmem((&T19[(stage % 3)])), 16384U);
#pragma unroll
...
#pragma unroll 2
      for (nvfuser_index_t i46 = 0; i46 < i6; ++i46) {
        ...
        i49 = i9 + (32768 * i47);
        mbarrier::waitParity(
            toSmem((&T19[(stage % 3)])), (uint32_t)(((stage / 3) % 2)));
#pragma unroll
        ...
        wgmma::commit();
        wgmma::wait<0LL>();
        mbarrier::arrive(toSmem((&T19[((stage % 3) + 3LL)])));
      }
      wgmma::wait<0LL>();
      cpAsyncBulkWaitGroup<0LL>();

      if (((Hopper::electSync(4294967295U) && b23) && b26)) {
        mbarrier::arriveExpectTX(toSmem(T20), 8192U * 4);
#pragma unroll
        for (nvfuser_index_t i56 = 0; i56 < 4; ++i56) {
          ...
          Hopper::cpAsyncBulkTensorTileG2S(
              (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{
                  ptr14, a57, toSmem(T20)}),
              (i18 + (8192 * i56)));
        }
      }
      mbarrier::waitParity(toSmem(T20), i29 % 2);
