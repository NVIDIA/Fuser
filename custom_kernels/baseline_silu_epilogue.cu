...
#pragma unroll
    for (nvfuser_index_t i38 = 0; i38 < 3; ++i38) {
      if (((Hopper::electSync(4294967295U) && b23) && b24)) {
        mbarrier::init(toSmem((&T19[i38])), 2U);
      }
    }
#pragma unroll
    for (nvfuser_index_t i39 = 0; i39 < 3; ++i39) {
      if (((Hopper::electSync(4294967295U) && b23) && b24)) {
        mbarrier::init(toSmem((&T19[(i39 + 3LL)])), 256U);
      }
    }
    __syncthreads();
    if (b25) {
#pragma unroll 2
      for (nvfuser_index_t i40 = 0; i40 < i6; ++i40) {
        ...
        if ((Hopper::electSync(4294967295U) && b23)) {
          mbarrier::waitParity(
              toSmem((&T19[((i40 % 3) + 3LL)])), (uint32_t)(((i40 / 3) % 2)));
          mbarrier::arriveExpectTX(toSmem((&T19[(i40 % 3)])), 32768U);
          Hopper::cpAsyncBulkTensorTileG2S(
              (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{
                  ...
                  toSmem((&T19[(i40 % 3)]))}),
              (i9 + (32768 * i41)));
          mbarrier::arriveExpectTX(toSmem((&T19[(i40 % 3)])), 16384U);
#pragma unroll
...
#pragma unroll
      for (nvfuser_index_t i45 = 0; i45 < 3; ++i45) {
        mbarrier::arrive(toSmem((&T19[(i45 + 3LL)])));
      }
#pragma unroll 2
      for (nvfuser_index_t i46 = 0; i46 < i6; ++i46) {
        ...
        i49 = i9 + (32768 * i47);
        mbarrier::waitParity(
            toSmem((&T19[(i46 % 3)])), (uint32_t)(((i46 / 3) % 2)));
#pragma unroll
        ...
        wgmma::commit();
        wgmma::wait<0LL>();
        mbarrier::arrive(toSmem((&T19[((i46 % 3) + 3LL)])));
      }
    }
#pragma unroll
    for (nvfuser_index_t i54 = 0; i54 < 3; ++i54) {
      if (((Hopper::electSync(4294967295U) && b23) && b24)) {
        mbarrier::inval(toSmem((&T19[(i54 + 3LL)])));
      }
    }
#pragma unroll
    for (nvfuser_index_t i55 = 0; i55 < 3; ++i55) {
      if (((Hopper::electSync(4294967295U) && b23) && b24)) {
        mbarrier::inval(toSmem((&T19[i55])));
      }
    }
    wgmma::wait<0LL>();
#pragma unroll
    for (nvfuser_index_t i56 = 0; i56 < 4; ++i56) {
      ...
      mbarrier::init(toSmem(T20), 2U);
      __syncthreads();
      if (((Hopper::electSync(4294967295U) && b23) && b26)) {
        uint64_t i58;
        i58 = mbarrier::arriveExpectTX(toSmem(T20), 8192U);
        Hopper::cpAsyncBulkTensorTileG2S(
            (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ptr14, a57, toSmem(T20)}),
            (i18 + (8192 * i56)));
        mbarrier::wait(toSmem(T20), i58);
      }
      __syncthreads();
...
#pragma unroll
        for (nvfuser_index_t i64 = 0; i64 < 2; ++i64) {
          ...
          T9[0] = T4[0] * T8[0];
          Array<float, 1, 1> T10;
          T10[0] = __bfloat2float(T17[i65]);
          Array<float, 1, 1> T11;
          T11[0] = T9[0] * T10[0];
          T16[i65] = __float2bfloat(T11[0]);
        }
      }
    }
#pragma unroll
                 ...
                 (((i66 / 4) * 8192) +
                  ((i20 * 128) +
                   (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) +
                     ...
                     (i20 % 8)) *
                    16)))))),
            (*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T16[(8 * i66)])));
      }
    }
    __syncthreads();
#pragma unroll
