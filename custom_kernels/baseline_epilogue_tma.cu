...
__device__ __inline__ void m64n256k16BF16(
    Array<float, 128, 1>& out0,
    uint64_t in0,
    uint64_t in1,
    bool in2) {
  asm volatile(
...
__global__ void __cluster_dims__(2, 1, 1) nvfuser_none_f0_c0_r0_g0(
    ...
    Tensor<__bfloat, 2, 2> T12) {
  alignas(16) extern __shared__ char array[];
  const unsigned smem_offset = 0;
  nvfuser_index_t i4;
  i4 = ceilDiv((ceilDiv(T1.logical_size[1LL], 256)), 8);
  nvfuser_index_t i5;
  i5 = (ceilDiv((ceilDiv(T0.logical_size[0LL], 128)), 16))*i4;
  nvfuser_index_t i6;
  i6 = ceilDiv(T0.logical_size[2LL], 64);
  const TensorMap* ptr7;
  ptr7 = &var0;
  nvfuser_index_t i8;
  i8 = 256 * (((nvfuser_index_t)blockIdx.x) % 8);
  __bfloat* T14 = reinterpret_cast<__bfloat*>(array + smem_offset + 114688);
  uint32_t i9;
  i9 = toSmem(T14);
  const TensorMap* ptr10;
  ptr10 = &var1;
  nvfuser_index_t i11;
  i11 = 128 * (((nvfuser_index_t)blockIdx.x) / 8);
  __bfloat* T13 = reinterpret_cast<__bfloat*>(array + smem_offset + 65536);
  uint32_t i12;
  i12 = toSmem(T13);
  uint32_t i13;
  i13 = i12 + (8192 * ((nvfuser_index_t)threadIdx.y));
  const TensorMap* ptr14;
  ptr14 = &var2;
  __bfloat* T17 = reinterpret_cast<__bfloat*>(array + smem_offset + 0);
  uint32_t i15;
  i15 = toSmem(T17);
  nvfuser_index_t i16;
  i16 = ((nvfuser_index_t)threadIdx.x) / 4;
  nvfuser_index_t i17;
  i17 = i16 % 8;
  nvfuser_index_t i18;
  i18 = i16 / 8;
  nvfuser_index_t i19;
  i19 = ((1024 * i18) + (64 * i17)) + (4096 * ((nvfuser_index_t)threadIdx.y));
  nvfuser_index_t i20;
  i20 = 2 * (((nvfuser_index_t)threadIdx.x) % 4);
  nvfuser_index_t i21;
  i21 = i17 % 8;
  nvfuser_index_t i22;
  i22 = ((((nvfuser_index_t)threadIdx.x) / 32) * 16) +
      ((((nvfuser_index_t)threadIdx.x) % 32) % 16);
  // Alias Allocation - shared
  auto& T18 = T17;
  uint32_t i23;
  i23 = toSmem(T18) + (32768 * ((nvfuser_index_t)threadIdx.y));
  const TensorMap* ptr24;
  ptr24 = &var3;
  nvfuser_index_t i25;
  i25 = 64 * ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i26;
  i26 = i25 + i11;
  bool b27;
  b27 = ((nvfuser_index_t)threadIdx.x) < 32ULL;
  bool b28;
  b28 = ((nvfuser_index_t)threadIdx.y) == 0ULL;
  bool b29;
  b29 = ((nvfuser_index_t)threadIdx.y) == 2;
  bool b30;
  b30 = ((nvfuser_index_t)threadIdx.y) < 2;
  nvfuser_index_t i31;
  i31 = 16 * i18;
  nvfuser_index_t i32;
  i32 = ((((-T0.logical_size[0LL]) + i31) + i17) + i25) + i11;
  nvfuser_index_t i33;
  i33 = ((-T1.logical_size[1LL]) + i20) + i8;
  nvfuser_index_t i34;
...
#pragma unroll 1
  for (nvfuser_index_t i36 = 0; i36 < i5; ++i36) {
    ...
    i45 = i33 + i37;
    bool b46;
    b46 = b30 && ((i34 + i40) < T0.logical_size[0LL]);
    nvfuser_index_t i47;
    i47 = i35 + i37;
    ...
    wgmma::fence();
    fenceAsyncProxy();
    uint64_t* T19 = reinterpret_cast<uint64_t*>(array + smem_offset + 213008);
#pragma unroll
    for (nvfuser_index_t i48 = 0; i48 < 3; ++i48) {
      if (((Hopper::electSync(4294967295U) && b27) && b28)) {
        mbarrier::init(toSmem((&T19[i48])), 2U);
      }
    }
#pragma unroll
    for (nvfuser_index_t i49 = 0; i49 < 3; ++i49) {
      if (((Hopper::electSync(4294967295U) && b27) && b28)) {
        mbarrier::init(toSmem((&T19[(i49 + 3LL)])), 256U);
      }
    }
    __syncthreads();
    if (b29) {
#pragma unroll 2
      for (nvfuser_index_t i50 = 0; i50 < i6; ++i50) {
        nvfuser_index_t i51;
        i51 = i50 % 3;
        int i52;
        i52 = (int32_t)((64 * i50));
        uint32_t i53;
        i53 = i12 + (16384 * i51);
        if ((Hopper::electSync(4294967295U) && b27)) {
          mbarrier::waitParity(
              toSmem((&T19[((i50 % 3) + 3LL)])), (uint32_t)(((i50 / 3) % 2)));
          mbarrier::arriveExpectTX(toSmem((&T19[(i50 % 3)])), 32768U);
          Hopper::cpAsyncBulkTensorTileG2S(
              (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{
                  ptr7,
                  (Array<int, 2, 1>{(int32_t)((64 * i50)), i39}),
                  toSmem((&T19[(i50 % 3)]))}),
              (i9 + (32768 * i51)));
          mbarrier::arriveExpectTX(toSmem((&T19[(i50 % 3)])), 16384U);
#pragma unroll
          for (nvfuser_index_t i54 = 0; i54 < 2; ++i54) {
            Hopper::cpAsyncBulkTensorTileG2S(
                (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{
                    ptr10,
                    (Array<int, 2, 1>{i52, (int32_t)((i41 + (64 * i54)))}),
                    toSmem((&T19[(i50 % 3)]))}),
                (i53 + (8192 * i54)));
          }
        }
...
#pragma unroll
      for (nvfuser_index_t i55 = 0; i55 < 3; ++i55) {
        mbarrier::arrive(toSmem((&T19[(i55 + 3LL)])));
      }
#pragma unroll 2
      for (nvfuser_index_t i56 = 0; i56 < i6; ++i56) {
        nvfuser_index_t i57;
        i57 = i56 % 3;
        uint32_t i58;
        i58 = i13 + (16384 * i57);
        ...
        i59 = i9 + (32768 * i57);
        mbarrier::waitParity(
            toSmem((&T19[(i56 % 3)])), (uint32_t)(((i56 / 3) % 2)));
#pragma unroll
        for (nvfuser_index_t i60 = 0; i60 < 4; ++i60) {
          ...
          wgmma::m64n256k16BF16<1, 1, 0, 0>(
              ...
              (4611686293305294848ULL |
               ((262143ULL & (uint64_t)(i62)) >> 4ULL)),
              (4611686293305294848ULL |
               ((262143ULL & (uint64_t)(i63)) >> 4ULL)),
              true);
        }
        wgmma::commit();
        wgmma::wait<0LL>();
        mbarrier::arrive(toSmem((&T19[((i56 % 3) + 3LL)])));
      }
    }
#pragma unroll
    for (nvfuser_index_t i64 = 0; i64 < 3; ++i64) {
      if (((Hopper::electSync(4294967295U) && b27) && b28)) {
        mbarrier::inval(toSmem((&T19[(i64 + 3LL)])));
      }
    }
#pragma unroll
    for (nvfuser_index_t i65 = 0; i65 < 3; ++i65) {
      if (((Hopper::electSync(4294967295U) && b27) && b28)) {
        mbarrier::inval(toSmem((&T19[i65])));
      }
    }
#pragma unroll
    for (nvfuser_index_t i66 = 0; i66 < 4; ++i66) {
      ...
      uint64_t* T20 = reinterpret_cast<uint64_t*>(array + smem_offset + 212992);
      mbarrier::init(toSmem(T20), 1U);
      __syncthreads();
      if (((Hopper::electSync(4294967295U) && b27) && b28)) {
        uint64_t i68;
        i68 = mbarrier::arriveExpectTX(toSmem(T20), 16384U);
        Hopper::cpAsyncBulkTensorTileG2S(
            (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ptr14, a67, toSmem(T20)}),
            (i15 + (16384 * i66)));
        mbarrier::wait(toSmem(T20), i68);
      }
      __syncthreads();
      mbarrier::inval(toSmem(T20));
    }
    wgmma::wait<0LL>();
