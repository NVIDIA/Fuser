...
def huggingface_attn_bwd_fusion(
    ...
    T5 = fd.define_tensor(shape=[-1, -1, -1], contiguity=[True, True, True], dtype=dtype, is_cpu=False)
    T6 = fd.define_tensor(shape=[-1, -1, -1], contiguity=[True, True, True], dtype=dtype, is_cpu=False)
    T7 = fd.define_tensor(shape=[-1, -1, -1], contiguity=[True, True, True], dtype=DataType.Bool, is_cpu=False)
    ...
    V34 = fd.define_vector([batch_size, num_heads, T5.size(1), T5.size(2)], dtype=DataType.Int)
