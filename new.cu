...
__global__ void nvfuser_inner_outer_persistent_f0_c1_r0_g0(Tensor<__bfloat, 2, 2> T0, Tensor<__bfloat, 2, 2> T1, Tensor<float, 1, 1> T2, Tensor<float, 2, 2> T3, Tensor<__bfloat, 1, 1> T4, Tensor<__bfloat, 2, 2> T56, Tensor<__bfloat, 1, 1> T57, Tensor<__bfloat, 1, 1> T55, Tensor<float, 2, 2> T78, Tensor<float, 2, 2> T82, Tensor<int64_t, 1, 1> T87) {
  ...
  nvfuser_index_t i4;
  i4 = ceilDiv(((nvfuser_index_t)gridDim.y), ((nvfuser_index_t)blockDim.y));
  nvfuser_index_t i5;
  i5 = 8 * ((nvfuser_index_t)blockDim.x);
  nvfuser_index_t i6;
  ...
  nvfuser_index_t i8;
  i8 = i6 + i7;
  Array<nvfuser_index_t, 2, 1> a9;
  a9 = s0.logical_size;
  nvfuser_index_t i10;
  i10 = a9[1LL];
  nvfuser_index_t i11;
  i11 = ceilDiv((ceilDiv((ceilDiv(i10, 8)), ((nvfuser_index_t)blockDim.x))), 13);
  nvfuser_index_t i12;
  i12 = i5 * i11;
  nvfuser_index_t i13;
  i13 = i8 + ((i10 * i3) * ((nvfuser_index_t)blockIdx.y));
  nvfuser_index_t i14;
  i14 = i3 * ((nvfuser_index_t)blockIdx.y);
  nvfuser_index_t i15;
  i15 = i8 + (i10 * ((nvfuser_index_t)blockIdx.y));
  nvfuser_index_t i16;
  i16 = 4 * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i17;
  i17 = (4 * ((nvfuser_index_t)blockDim.x)) * ((nvfuser_index_t)blockIdx.y);
  nvfuser_index_t i18;
  i18 = ((i10 * ((nvfuser_index_t)threadIdx.y)) + i16) + i17;
  nvfuser_index_t i19;
  i19 = ((nvfuser_index_t)blockDim.y) * i10;
  nvfuser_index_t i20;
  i20 = i16 + i17;
  bool b21;
  b21 = ((nvfuser_index_t)threadIdx.y) < i11;
  nvfuser_index_t i22;
  i22 = ((7 - i10) + i6) + i7;
  nvfuser_index_t i23;
  i23 = ((3 - i10) + i6) + i7;
  bool b24;
  b24 = ((nvfuser_index_t)blockIdx.y) < (ceilDiv((ceilDiv(i10, 4)), ((nvfuser_index_t)blockDim.x)));
  bool b25;
  b25 = ((3 + i16) + i17) < i10;
  bool b26;
  b26 = b24 && b25;
  bool b27;
  b27 = ((((nvfuser_index_t)threadIdx.y) == 0) && b24) && b25;
  float f28;
  f28 = (float)(i10);
  float f29;
  f29 = reciprocal(f28);
  #pragma unroll
  for(nvfuser_index_t i30 = 0; i30 < 13; ++i30) {
    nvfuser_index_t i31;
    i31 = i12 * (i30 + nvfuser_zero);
    if ((b21 && (i22 < (-i31)))) {
      loadGeneric<__bfloat, 8>( &T73[(i8 + (i12 * i30))],  &T4[(i8 + i31)]);
    }
  }
  ...
  #pragma unroll
  for(nvfuser_index_t i32 = 0; i32 < 13; ++i32) {
    nvfuser_index_t i33;
    i33 = 8 * i32;
    #pragma unroll
    for(nvfuser_index_t i34 = 0; i34 < 8; ++i34) {
      T83[(i33 + i34)] = 0.000000000e+00f;
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  ...
  for(nvfuser_index_t i36 = 0; i36 < i3; ++i36) {
    ...
    b40 = b21 && b39;
    #pragma unroll
    for(nvfuser_index_t i41 = 0; i41 < 13; ++i41) {
      nvfuser_index_t i42;
      i42 = i12 * (i41 + nvfuser_zero);
      if ((b40 && (i22 < (-i42)))) {
        loadGeneric<__bfloat, 8>( &T69[(i8 + (i12 * i41))],  &T0[(i37 + i42)]);
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    #pragma unroll
    for(nvfuser_index_t i43 = 0; i43 < 13; ++i43) {
      nvfuser_index_t i44;
      i44 = i12 * (i43 + nvfuser_zero);
      if ((b40 && (i22 < (-i44)))) {
        loadGeneric<__bfloat, 8>( &T70[(i8 + (i12 * i43))],  &T1[(i37 + i44)]);
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    float T72[1];
    ...
    for(nvfuser_index_t i32 = 0; i32 < 13; ++i32) {
      ...
      if (b48) {
        ...
        for(nvfuser_index_t i34 = 0; i34 < 8; ++i34) {
          ...
          T5[0] = 0;
          T5[0]
             = __bfloat2float(T69[i50]);
          float T7[1];
          T7[0] = 0;
          T7[0]
             = __bfloat2float(T73[i50]);
          float T16[1];
          T16[0]
             = T7[0];
          float T17[1];
        ...
        for(nvfuser_index_t i34 = 0; i34 < 8; ++i34) {
          ...
          if (b48) {
            T5[0]
               = __bfloat2float(T69[i52]);
          }
          float T7[1];
          T7[0] = 0;
          if (b49) {
            T7[0]
               = __bfloat2float(T73[i52]);
          }
          float T16[1];
          T16[0]
             = T7[0];
    ...
    T52[0]
      ...
      * T51[0];
    #pragma unroll
    for(nvfuser_index_t i54 = 0; i54 < 13; ++i54) {
      nvfuser_index_t i55;
      i55 = i8 + (i12 * i54);
      nvfuser_index_t i56;
      i56 = i12 * (i54 + nvfuser_zero);
      nvfuser_index_t i57;
      i57 = i37 + i56;
      bool b58;
      b58 = i22 < (-i56);
      ...
      if (b59) {
        ...
        #pragma unroll
        for(nvfuser_index_t i61 = 0; i61 < 8; ++i61) {
          nvfuser_index_t i62;
          i62 = i55 + i61;
          float T67[1];
          T67[0] = 0;
          T67[0]
             = __bfloat2float(T69[i62]);
          float T45[1];
          T45[0]
            = T67[0]
            - T43[0];
          ...
          T58[0] = 0;
          T58[0]
             = __bfloat2float(T70[i62]);
          float T59[1];
          T59[0] = 0;
          T59[0]
             = __bfloat2float(T73[i62]);
          float T60[1];
          T60[0]
             = T59[0];
          float T61[1];
        ...
        loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T56[i57], &T74[0]);
      } else {
        Array<__bfloat, 8, 8> T74;
        #pragma unroll
        for(nvfuser_index_t i61 = 0; i61 < 8; ++i61) {
  ...
  #pragma unroll
  for(nvfuser_index_t i64 = 0; i64 < 13; ++i64) {
    nvfuser_index_t i65;
    i65 = 8 * i64;
    nvfuser_index_t i66;
    i66 = i12 * i64;
    ...
    nvfuser_index_t i68;
    i68 = -i66;
    if ((b21 && (i22 < (-(i12 * (i64 + nvfuser_zero)))))) {
      #pragma unroll
      for(nvfuser_index_t i69 = 0; i69 < 2; ++i69) {
        loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/true>( &*(volatile float*)&T78[(i67 + (4 * (i69 + nvfuser_zero)))], &T79[(i65 + (4 * i69))]);
      }
    } else {
      #pragma unroll
      for(nvfuser_index_t i69 = 0; i69 < 2; ++i69) {
        nvfuser_index_t i70;
        i70 = 4 * (i69 + nvfuser_zero);
        if ((b21 && (i23 < (i68 - i70)))) {
          loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/true>( &*(volatile float*)&T78[(i67 + i70)], &T79[(i65 + (4 * i69))]);
        }
      }
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll
  for(nvfuser_index_t i71 = 0; i71 < 13; ++i71) {
    nvfuser_index_t i72;
    i72 = 8 * i71;
    nvfuser_index_t i73;
    i73 = i12 * i71;
    ...
    nvfuser_index_t i75;
    i75 = -i73;
    if ((b21 && (i22 < (-(i12 * (i71 + nvfuser_zero)))))) {
      #pragma unroll
      for(nvfuser_index_t i76 = 0; i76 < 2; ++i76) {
        loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/true>( &*(volatile float*)&T82[(i74 + (4 * (i76 + nvfuser_zero)))], &T83[(i72 + (4 * i76))]);
      }
    } else {
      #pragma unroll
      for(nvfuser_index_t i76 = 0; i76 < 2; ++i76) {
        nvfuser_index_t i77;
        i77 = 4 * (i76 + nvfuser_zero);
        if ((b21 && (i23 < (i75 - i77)))) {
          loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/true>( &*(volatile float*)&T82[(i74 + i77)], &T83[(i72 + (4 * i76))]);
        }
      }
    }
  }
  ...
  for(nvfuser_index_t i78 = 0; i78 < 4; ++i78) {
    T81[i78] = 0.000000000e+00f;
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll 1
  for(nvfuser_index_t i79 = 0; i79 < i4; ++i79) {
    Array<float, 4, 4> T80;
    T80.set(float(0.000000000e+00f));
    if ((b26 && ((((nvfuser_index_t)threadIdx.y) + (((nvfuser_index_t)blockDim.y) * i79)) < ((nvfuser_index_t)gridDim.y)))) {
      loadGlobalToLocal<float, /*vec_size=*/4, /*is_volatile=*/true, CacheOp::Streaming>(&T80[0],  &*(volatile float*)&T78[(i18 + (i19 * i79))]);
    }
    #pragma unroll
    for(nvfuser_index_t i78 = 0; i78 < 4; ++i78) {
      T81[i78]
  ...
  for(nvfuser_index_t i80 = 0; i80 < 4; ++i80) {
    ...
    blockReduce<false, true, false, true>(T21[0], T81[i80], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, true, float(0.000000000e+00f));
    T75[i80]
       = __float2bfloat(T21[0]);
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  if (b27) {
    loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T57[i20], &T75[0]);
  }
  float T85[4];
  #pragma unroll
  for(nvfuser_index_t i81 = 0; i81 < 4; ++i81) {
    T85[i81] = 0.000000000e+00f;
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll 1
  for(nvfuser_index_t i82 = 0; i82 < i4; ++i82) {
    Array<float, 4, 4> T84;
    T84.set(float(0.000000000e+00f));
    if ((b26 && ((((nvfuser_index_t)threadIdx.y) + (((nvfuser_index_t)blockDim.y) * i82)) < ((nvfuser_index_t)gridDim.y)))) {
      loadGlobalToLocal<float, /*vec_size=*/4, /*is_volatile=*/true, CacheOp::Streaming>(&T84[0],  &*(volatile float*)&T82[(i18 + (i19 * i82))]);
    }
    #pragma unroll
    for(nvfuser_index_t i81 = 0; i81 < 4; ++i81) {
      T85[i81]
  ...
  for(nvfuser_index_t i83 = 0; i83 < 4; ++i83) {
    ...
    blockReduce<false, true, false, true>(T18[0], T85[i83], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, true, float(0.000000000e+00f));
    T76[i83]
       = __float2bfloat(T18[0]);
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  if (b27) {
    loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T55[i20], &T76[0]);
  }
}
}
