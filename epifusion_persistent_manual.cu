...
__global__ void nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 3, 3> T0, Tensor<__bfloat, 3, 3> T1, Tensor<__bfloat, 2, 2> T2, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, const __grid_constant__ TensorMap var3, Tensor<__bfloat, 2, 2> T4, Tensor<__bfloat, 2, 2> T12) {
  ...
  nvfuser_index_t i4;
  i4 = ceilDiv(T0.logical_size[0LL], 128);
  nvfuser_index_t i5;
  i5 = ceilDiv(((ceilDiv(T1.logical_size[1LL], 128)) * i4), 132);
  nvfuser_index_t i6;
  ...
  nvfuser_index_t i22;
  i22 = 128 * T1.logical_size[1LL];
  nvfuser_index_t i23;
  i23 = 8 * T1.logical_size[1LL];
  ...
  i31 = ((8 + i30) + i19) + i16;
  nvfuser_index_t i32;
  i32 = (9 - T1.logical_size[1LL]) + i20;
  nvfuser_index_t i33;
  i33 = (((-T0.logical_size[0LL]) + i30) + i19) + i16;
  nvfuser_index_t i34;
  i34 = (-T1.logical_size[1LL]) + i20;
  #pragma unroll 1
  for(nvfuser_index_t i35 = 0; i35 < i5; ++i35) {
    nvfuser_index_t i36;
    i36 = ((nvfuser_index_t)blockIdx.x) + (132 * i35);
    nvfuser_index_t i37;
    i37 = 128 * (i36 / i4);
    nvfuser_index_t i38;
    i38 = i36 % i4;
    ...
    i41 = (i21 + i37) + (i22 * i38);
    bool b42;
    b42 = b29 && ((i31 + i39) < T0.logical_size[0LL]);
    nvfuser_index_t i43;
    i43 = i32 + i37;
    nvfuser_index_t i44;
    i44 = i33 + i39;
    ...
    for(nvfuser_index_t i46 = 0; i46 < 3; ++i46) {
      if (((Hopper::electSync(4294967295U) && b26) && b27)) {
        mbarrier::init(toSmem((&T21[i46])), 2U);
      }
    }
    #pragma unroll
    for(nvfuser_index_t i47 = 0; i47 < 3; ++i47) {
      if (((Hopper::electSync(4294967295U) && b26) && b27)) {
        mbarrier::init(toSmem((&T21[(i47 + 3LL)])), 256U);
      }
    }
    __syncthreads();
    if (b28) {
      #pragma unroll 2
      for(nvfuser_index_t i48 = 0; i48 < i6; ++i48) {
        nvfuser_index_t i49;
        i49 = 16384 * (i48 % 3);
        if ((Hopper::electSync(4294967295U) && b26)) {
          mbarrier::waitParity(toSmem((&T21[((i48 % 3) + 3LL)])), (uint32_t)(((i48 / 3) % 2)));
          mbarrier::arriveExpectTX(toSmem((&T21[(i48 % 3)])), 16384U);
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr7, (Array<nvfuser_index_t, 2, 1>{(64 * i48), i37}), toSmem((&T21[(i48 % 3)])) }), (i8 + i49));
          mbarrier::arriveExpectTX(toSmem((&T21[(i48 % 3)])), 16384U);
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr9, (Array<nvfuser_index_t, 2, 1>{(64 * i48), i39}), toSmem((&T21[(i48 % 3)])) }), (i10 + i49));
        }
      }
    } else {
      #pragma unroll
      for(nvfuser_index_t i50 = 0; i50 < 3; ++i50) {
        mbarrier::arrive(toSmem((&T21[(i50 + 3LL)])));
      }
      #pragma unroll 2
      for(nvfuser_index_t i51 = 0; i51 < i6; ++i51) {
        nvfuser_index_t i52;
        i52 = 16384 * (i51 % 3);
        unsigned i53;
        i53 = i11 + i52;
        unsigned i54;
        i54 = i8 + i52;
        mbarrier::waitParity(toSmem((&T21[(i51 % 3)])), (uint32_t)(((i51 / 3) % 2)));
        #pragma unroll
        ...
        mbarrier::arrive(toSmem((&T21[((i51 % 3) + 3LL)])));
      }
    }
    #pragma unroll
    for(nvfuser_index_t i59 = 0; i59 < 3; ++i59) {
      if (((Hopper::electSync(4294967295U) && b26) && b27)) {
        mbarrier::inval(toSmem((&T21[(i59 + 3LL)])));
      }
    }
    #pragma unroll
    for(nvfuser_index_t i60 = 0; i60 < 3; ++i60) {
      if (((Hopper::electSync(4294967295U) && b26) && b27)) {
        mbarrier::inval(toSmem((&T21[i60])));
      }
    }
    ...
    for(nvfuser_index_t i67 = 0; i67 < 8; ++i67) {
      if ((b42 && (i43 < (-(16 * i67))))) {
        asm volatile(
          ...
          :
          :"r"((uint32_t)((toSmem(T19) + ((((nvfuser_index_t)threadIdx.y) * 16384) + (((i67 / 4) * 8192) + ((i12 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i67 % 4) * 2)) ^ (i12 % 8)) * 16))))))),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T16[(8 * i67)]))[0]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T16[(8 * i67)]))[1]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T16[(8 * i67)]))[2]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T16[(8 * i67)]))[3])
        );
      }
    }
    __syncthreads();
    ...
    for(nvfuser_index_t i68 = 0; i68 < 2; ++i68) {
      asm volatile("fence.proxy.async;\n");
      if (b29) {
        Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr15, (Array<nvfuser_index_t, 2, 1>{(i37 + (64 * i68)), i40}) }), (i14 + (8192 * i68)));
      }
    }
    __syncthreads();
    ...
    #pragma unroll
    for(nvfuser_index_t i69 = 0; i69 < 16; ++i69) {
      nvfuser_index_t i70;
      i70 = 8 * i69;
      nvfuser_index_t i71;
      i71 = i41 + i70;
    ...
    #pragma unroll
    for(nvfuser_index_t i80 = 0; i80 < 8; ++i80) {
      if ((b42 && (i43 < (-(16 * i80))))) {
        asm volatile(
          "stmatrix.sync.aligned.x4.m8n8.shared.b16 [%0], {%1, %2, %3, %4};\n"
          :
          :"r"((uint32_t)((toSmem(T20) + ((((nvfuser_index_t)threadIdx.y) * 16384) + (((i80 / 4) * 8192) + ((i12 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i80 % 4) * 2)) ^ (i12 % 8)) * 16))))))),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i80)]))[0]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i80)]))[1]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i80)]))[2]),
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i80)]))[3])
        );
      }
    }
    __syncthreads();
    #pragma unroll
    for(nvfuser_index_t i81 = 0; i81 < 2; ++i81) {
      asm volatile("fence.proxy.async;\n");
      if (b29) {
        if ((Hopper::electSync(4294967295U) && b26)) {
        Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr25, (Array<nvfuser_index_t, 2, 1>{(i37 + (64 * i81)), i40}) }), (i24 + (8192 * i81)));
        }
      }
    }
    __syncthreads();
