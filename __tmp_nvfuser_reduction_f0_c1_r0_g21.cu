...
__global__ void nvfuser_reduction_f0_c1_r0_g21(Tensor<float, 3, 3> T20, Tensor<__bfloat, 3, 3> T9, Tensor<float, 2, 2> T19, Tensor<__bfloat, 1, 1> T21, Tensor<__bfloat, 1, 1> T18, Tensor<__bfloat, 2, 2> T145, Tensor<__bfloat, 1, 1> T246, Tensor<__bfloat, 1, 1> T247, Tensor<float, 3, 3> T292, Tensor<float, 3, 3> T294, Tensor<__bfloat, 2, 2> T227, Tensor<float, 3, 3> T155, Tensor<float, 1, 1> T300, Tensor<int64_t, 1, 1> T301, Tensor<float, 1, 1> T302, Tensor<int64_t, 1, 1> T303) {
  alignas(16) extern __shared__ char array[];
  void* shared_mem = array;
  NVFUSER_DEFINE_MAGIC_ZERO;
  nvfuser_index_t i0;
  i0 = ceilDiv((ceilDiv((ceilDiv(2048, ((nvfuser_index_t)blockDim.y))), 2)), ((nvfuser_index_t)gridDim.y));
  nvfuser_index_t i1;
  i1 = 4 * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i2;
  i2 = (4 * ((nvfuser_index_t)blockDim.x)) * ((nvfuser_index_t)blockIdx.x);
  nvfuser_index_t i3;
  i3 = i1 + i2;
  nvfuser_index_t i4;
  i4 = ((nvfuser_index_t)blockDim.y) * 24576;
  nvfuser_index_t i5;
  i5 = (((12288 * ((nvfuser_index_t)threadIdx.y)) + ((i4 * i0) * ((nvfuser_index_t)blockIdx.y))) + i1) + i2;
  nvfuser_index_t i6;
  i6 = 12288 * ((nvfuser_index_t)blockDim.y);
  nvfuser_index_t i7;
  i7 = ((nvfuser_index_t)blockDim.y) * 2;
  nvfuser_index_t i8;
  i8 = (i7 * i0) * ((nvfuser_index_t)blockIdx.y);
  nvfuser_index_t i9;
  i9 = ((nvfuser_index_t)threadIdx.y) + i8;
  bool b10;
  b10 = ((3 + i1) + i2) < 12288;
  nvfuser_index_t i11;
  i11 = (((i7 * ((nvfuser_index_t)blockIdx.y)) * i0) + ((nvfuser_index_t)blockDim.y)) + ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i12;
  i12 = (-2048 + ((nvfuser_index_t)threadIdx.y)) + i8;
  bool b13;
  b13 = (((nvfuser_index_t)blockIdx.y) == (((nvfuser_index_t)gridDim.y) + -1)) && (((nvfuser_index_t)threadIdx.y) == 0);
  bool b14;
  b14 = b13 && b10;
  // Allocate global tensor T300
  // Allocate global tensor T301
  // Allocate global tensor T302
  // Allocate global tensor T303
  Array<float, 4, 4> T299;
  #pragma unroll
  for(nvfuser_index_t i15 = 0; i15 < 4; ++i15) {
    T299[i15] = 0.000000000e+00f;
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  Array<float, 4, 4> T298;
  #pragma unroll
  for(nvfuser_index_t i15 = 0; i15 < 4; ++i15) {
    T298[i15] = 0.000000000e+00f;
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll 1
  for(nvfuser_index_t i16 = 0; i16 < i0; ++i16) {
    ...
    i20 = i12 + i18;
    if ((b10 && ((i11 + i18) < 2048))) {
      Array<__bfloat, 4, 4> T287;
      T287.set(__bfloat(0));
      loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T287[0],  &T21[i3]);
      Array<__bfloat, 4, 4> T288;
      T288.set(__bfloat(0));
      loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T288[0],  &T18[i3]);
      Array<__bfloat, 8, 4> T289;
      #pragma unroll
      ...
      #pragma unroll
      for(nvfuser_index_t i21 = 0; i21 < 2; ++i21) {
        loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T289[(4 * i21)],  &T145[(i17 + (i6 * (i21 + nvfuser_zero)))]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 8, 4> T285;
      #pragma unroll
      ...
      #pragma unroll
      for(nvfuser_index_t i22 = 0; i22 < 2; ++i22) {
        loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T285[(4 * i22)],  &T9[(i17 + (i6 * (i22 + nvfuser_zero)))]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<float, 8, 4> T295;
      Array<float, 8, 4> T297;
      Array<__bfloat, 8, 4> T296;
      #pragma unroll
      for(nvfuser_index_t i15 = 0; i15 < 4; ++i15) {
        Array<__bfloat, 1, 1> T147;
        T147[0]
           = T288[i15];
        Array<__bfloat, 1, 1> T148;
        T148[0]
           = T147[0];
        Array<float, 1, 1> T152;
        T152[0]
           = __bfloat2float(T148[0]);
        Array<__bfloat, 1, 1> T191;
        T191[0]
           = T287[i15];
        Array<__bfloat, 1, 1> T192;
        T192[0]
           = T191[0];
        Array<float, 1, 1> T200;
        T200[0]
           = __bfloat2float(T192[0]);
        #pragma unroll
        for(nvfuser_index_t i23 = 0; i23 < 2; ++i23) {
          nvfuser_index_t i24;
          i24 = i19 + (((nvfuser_index_t)blockDim.y) * (i23 + nvfuser_zero));
          nvfuser_index_t i25;
          i25 = i15 + (4 * i23);
          ...
          T286[0]
             = T19[i24];
          Array<float, 1, 1> T149;
          T149[0]
             = T286[0];
          Array<float, 1, 1> T150;
          T150[0]
             = T149[0];
          Array<float, 1, 1> T279;
          T279[0]
             = __bfloat2float(T285[i25]);
          Array<float, 1, 1> T154;
          T154[0]
             = T150[0];
          Array<float, 1, 1> T156;
          T156[0]
            = T279[0]
            - T154[0];
          T295[i25]
          ...
          T284[0]
             = T20[i24];
          Array<float, 1, 1> T162;
          T162[0]
             = T284[0];
          Array<float, 1, 1> T163;
          T163[0]
             = T162[0];
          Array<__bfloat, 1, 1> T146;
          T146[0]
             = T289[i25];
          Array<float, 1, 1> T151;
          T151[0]
             = __bfloat2float(T146[0]);
          Array<float, 1, 1> T223;
          T223[0]
             = T151[0];
          T299[i15]
            = T299[i15]
          ...
          T297[i25]
            = T152[0]
            * T151[0];
          Array<float, 1, 1> T193;
          T193[0]
            = T156[0]
            * T163[0];
          Array<float, 1, 1> T201;
          T201[0]
            = T193[0]
            * T152[0];
          Array<float, 1, 1> T207;
          T207[0]
            = T201[0]
            + T200[0];
          Array<__bfloat, 1, 1> T215;
          T215[0]
             = __float2bfloat(T207[0]);
          T296[i25]
             = T215[0];
          Array<float, 1, 1> T213;
          T213[0]
            = T193[0]
            * T151[0];
          Array<float, 1, 1> T221;
          T221[0]
             = T213[0];
          T298[i15]
            = T298[i15]
      ...
      for(nvfuser_index_t i26 = 0; i26 < 2; ++i26) {
        loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/false>( &T294[(i17 + (i6 * (i26 + nvfuser_zero)))], &T295[(4 * i26)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i27 = 0; i27 < 2; ++i27) {
        loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T227[(i17 + (i6 * (i27 + nvfuser_zero)))], &T296[(4 * i27)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i28 = 0; i28 < 2; ++i28) {
        loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/false>( &T155[(i17 + (i6 * (i28 + nvfuser_zero)))], &T297[(4 * i28)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
    } else {
      Array<__bfloat, 4, 4> T287;
      ...
      for(nvfuser_index_t i21 = 0; i21 < 2; ++i21) {
        ...
        if ((b10 && (i20 < (-(((nvfuser_index_t)blockDim.y) * i29))))) {
          loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T289[(4 * i21)],  &T145[(i17 + (i6 * i29))]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 8, 4> T285;
      ...
      for(nvfuser_index_t i22 = 0; i22 < 2; ++i22) {
        nvfuser_index_t i30;
        i30 = i22 + nvfuser_zero;
        if ((b10 && (i20 < (-(((nvfuser_index_t)blockDim.y) * i30))))) {
          loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T285[(4 * i22)],  &T9[(i17 + (i6 * i30))]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<float, 8, 4> T295;
      ...
      for(nvfuser_index_t i15 = 0; i15 < 4; ++i15) {
        ...
        for(nvfuser_index_t i23 = 0; i23 < 2; ++i23) {
          nvfuser_index_t i31;
          i31 = ((nvfuser_index_t)blockDim.y) * (i23 + nvfuser_zero);
          nvfuser_index_t i32;
          i32 = i19 + i31;
          nvfuser_index_t i33;
          i33 = i15 + (4 * i23);
      ...
      for(nvfuser_index_t i26 = 0; i26 < 2; ++i26) {
        nvfuser_index_t i36;
        i36 = i26 + nvfuser_zero;
        if ((b10 && (i20 < (-(((nvfuser_index_t)blockDim.y) * i36))))) {
          loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/false>( &T294[(i17 + (i6 * i36))], &T295[(4 * i26)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i27 = 0; i27 < 2; ++i27) {
        nvfuser_index_t i37;
        i37 = i27 + nvfuser_zero;
        if ((b10 && (i20 < (-(((nvfuser_index_t)blockDim.y) * i37))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T227[(i17 + (i6 * i37))], &T296[(4 * i27)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i28 = 0; i28 < 2; ++i28) {
        nvfuser_index_t i38;
        i38 = i28 + nvfuser_zero;
        if ((b10 && (i20 < (-(((nvfuser_index_t)blockDim.y) * i38))))) {
          loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/false>( &T155[(i17 + (i6 * i38))], &T297[(4 * i28)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
    }
  ...
  if (b10) {
    Array<float, 4, 1> T224;
    #pragma unroll
    for(nvfuser_index_t i39 = 0; i39 < 4; ++i39) {
      T224[i39] = 0.000000000e+00f;
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    reduction::iterGroupedGridReduce<false, true, false, false, true, false, false, false, 4>(
      ...
      DefaultBlockDim());
    NVFUSER_UPDATE_MAGIC_ZERO;
    Array<__bfloat, 4, 4> T291;
    #pragma unroll
    for(nvfuser_index_t i40 = 0; i40 < 4; ++i40) {
      if (b13) {
        T291[i40]
           = __float2bfloat(T224[i40]);
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    if (b13) {
      loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T247[i3], &T291[0]);
    }
  } else {
    Array<float, 4, 1> T224;
    #pragma unroll
  ...
  if (b10) {
    ...
    reduction::iterGroupedGridReduce<false, true, false, false, true, false, false, false, 4>(
      ...
      DefaultBlockDim());
    NVFUSER_UPDATE_MAGIC_ZERO;
    Array<__bfloat, 4, 4> T290;
    #pragma unroll
    for(nvfuser_index_t i42 = 0; i42 < 4; ++i42) {
      if (b13) {
        T290[i42]
           = __float2bfloat(T222[i42]);
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
    if (b13) {
      loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T246[i3], &T290[0]);
    }
  } else {
    // Alias Allocation - register
    auto& T222 = T299;
