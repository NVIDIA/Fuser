...
list of IterDomain
    The root iteration domains.
      ...
      .def(
          "get_maybe_allocation_domain",
          &TensorView::getMaybeAllocationDomain,
          R"(
...
TensorView
    A TensorView with the split axes in its loop domain.
      ...
      .def(
          "merge",
          static_cast<TensorView* (TensorView::*)(int64_t)>(&TensorView::merge),
          py::arg("axis"),
          py::return_value_policy::reference,
          R"(
...
TensorViewBuilder
    The builder instance for method chaining.
      ...
      .def(
          "contiguity",
          static_cast<TensorViewBuilder& (
              TensorViewBuilder::*)(std::vector<std::optional<bool>>)>(
              &TensorViewBuilder::contiguity),
          py::arg("contiguity"),
          R"(
...
TensorViewBuilder
    The builder instance for method chaining.
      ...
      .def(
          "contiguity",
          static_cast<TensorViewBuilder& (TensorViewBuilder::*)(bool)>(
              &TensorViewBuilder::contiguity),
          py::arg("contiguous"),
          R"(
...
TensorViewBuilder
    The builder instance for method chaining.
      ...
      .def(
          "shape",
          static_cast<TensorViewBuilder& (
              TensorViewBuilder::*)(std::vector<Val*>)>(
...
TensorViewBuilder
    The builder instance for method chaining.
      ...
      .def(
          "shape",
          static_cast<TensorViewBuilder& (
              TensorViewBuilder::*)(const std::vector<int64_t>&)>(
              &TensorViewBuilder::shape),
          py::arg("shape"),
          R"(
...
void bindFusionIr(py::module& direct_bindings) {
  ...
  bindInternalBaseNodes(direct_bindings);
  bindInterfaceNodes(direct_bindings);
  bindScalar(direct_bindings);
  bindDefineTensor(direct_bindings);
}
