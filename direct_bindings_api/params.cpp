...
void defineHeuristicParamBindings(py::module& direct_bindings) {
  py::class_<LaunchParams> launch_parameters(direct_bindings, "LaunchParams");
...
#define DEFINECLASS(type) py::class_<type>(direct_bindings, #type)
...
#define PARAM(internal_type, name) def_readwrite(#name, &internal_type::name)
  ...
  py::class_<MatmulParams::CircularBufferOptions>(
      direct_bindings, "CircularBufferOptions")
  ...
  py::class_<MatmulParams::SupportedVectorization>(
      direct_bindings, "SupportedVectorization")
      .def(py::init<int64_t, int64_t, int64_t>())
  ...
  py::enum_<MatmulParams::TileRasterizationOrder>(
      direct_bindings, "MatmulTileRasterizationOrder")
  ...
  py::class_<MatmulParams::ClusterDims>(direct_bindings, "ClusterDims")
      .def(py::init<int64_t, int64_t, int64_t>())
  ...
  py::enum_<MmaMacroEncode::Arch>(direct_bindings, "MmaMacroArch")
...
#undef MMAMACROPROP
  ...
  py::enum_<MatmulParams::TilingStrategy>(
      direct_bindings, "MatmulTilingStrategy")
  ...
  py::enum_<MatmulParams::BufferingLoopLevel>(
      direct_bindings, "MatmulBufferingLoopLevel")
  ...
  py::enum_<MatmulParams::CircularBufferingStrategy>(
      direct_bindings, "MatmulCircularBufferingStrategy")
...
#define INITHEURISTICPARAMS(internal_type)                                    \
  py::class_<internal_type, HeuristicParams>(direct_bindings, #internal_type) \
      .def(py::init())                                                        \
...
void bindEnums(py::module& direct_bindings) {
  //! DataTypes supported by nvFuser in the FusionDefinition
  py::enum_<PrimDataType>(direct_bindings, "DataType")
  ...
  py::enum_<ParallelType>(direct_bindings, "ParallelType")
...
void bindParams(py::module& direct_bindings) {
  defineHeuristicParamBindings(direct_bindings);
  bindEnums(direct_bindings);
}
