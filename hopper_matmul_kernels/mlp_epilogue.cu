...
__global__ void __launch_bounds__(/*MAX_THREADS_PER_BLOCK=*/384) __cluster_dims__(1, 2, 1) nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 2, 2> T0, Tensor<__bfloat, 2, 2> T1, Tensor<__bfloat, 2, 2> T2, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, const __grid_constant__ TensorMap var3, Tensor<__bfloat, 2, 2> T16, Tensor<__bfloat, 2, 2> T12) {
  ...
  ptr5 = &var0;
  nvfuser_index_t i6;
  i6 = 256 * ((nvfuser_index_t)blockIdx.y);
  ...
  ptr8 = &var1;
  nvfuser_index_t i9;
  i9 = 128 * ((nvfuser_index_t)blockIdx.x);
  ...
  nvfuser_index_t i16;
  i16 = ((((i15 + ((16 * T1.logical_size[0LL]) * i13)) + (T1.logical_size[0LL] * i14)) + ((64 * T1.logical_size[0LL]) * ((nvfuser_index_t)threadIdx.y))) + i6) + ((128 * T1.logical_size[0LL]) * ((nvfuser_index_t)blockIdx.x));
  nvfuser_index_t i17;
  ...
  for(nvfuser_index_t i67 = 0; i67 < 4; ++i67) {
    asm volatile("fence.proxy.async;\n");
    if (Hopper::electSync(4294967295U) && b26 && b28) {
