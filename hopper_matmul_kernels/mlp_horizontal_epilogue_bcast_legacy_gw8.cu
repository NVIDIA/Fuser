...
__global__ void __launch_bounds__(/*MAX_THREADS_PER_BLOCK=*/384) nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 3, 3> T0, Tensor<__bfloat, 3, 3> T1, Tensor<__bfloat, 3, 3> T2, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, const __grid_constant__ TensorMap var3, const __grid_constant__ TensorMap var4, const __grid_constant__ TensorMap var5, Tensor<__bfloat, 2, 2> T4, Tensor<__bfloat, 2, 2> T19, Tensor<__bfloat, 2, 2> T14) {
  ...
  ptr7 = &var0;
  nvfuser_index_t i8;
  i8 = 128 * (((nvfuser_index_t)blockIdx.x) / 8);
  __bfloat* T16 = reinterpret_cast<__bfloat*>(array + smem_offset + 163968);
  unsigned i9;
  i9 = toSmem(T16);
  ...
  nvfuser_index_t i12;
  i12 = 1024 * ((nvfuser_index_t)blockIdx.y);
  nvfuser_index_t i13;
  i13 = i11 + i12;
  __bfloat* T15 = reinterpret_cast<__bfloat*>(array + smem_offset + 98432);
  unsigned i14;
  i14 = toSmem(T15);
  const TensorMap* ptr15;
  ptr15 = &var2;
  __bfloat* T17 = reinterpret_cast<__bfloat*>(array + smem_offset + 32896);
  unsigned i16;
  i16 = toSmem(T17);
  unsigned i17;
  i17 = i14 + (8192 * ((nvfuser_index_t)threadIdx.y));
  nvfuser_index_t i18;
  i18 = ((((nvfuser_index_t)threadIdx.x) / 32) * 16) + ((((nvfuser_index_t)threadIdx.x) % 32) % 16);
  nvfuser_index_t i19;
  i19 = 16384 * ((nvfuser_index_t)threadIdx.y);
  ...
  nvfuser_index_t i23;
  i23 = (i22 + i11) + i12;
  __bfloat* T23 = reinterpret_cast<__bfloat*>(array + smem_offset + 65536);
  unsigned i24;
  i24 = toSmem(T23) + i19;
  ...
  unsigned i26;
  i26 = toSmem(T24) + i19;
  const TensorMap* ptr27;
  ptr27 = &var5;
  bool b28;
  b28 = ((nvfuser_index_t)threadIdx.x) < 32ULL;
  bool b29;
  b29 = ((nvfuser_index_t)threadIdx.y) == 0ULL;
  nvfuser_index_t i30;
  i30 = ((nvfuser_index_t)threadIdx.x) / 4;
  bool b31;
  b31 = ((nvfuser_index_t)threadIdx.y) < 2;
  bool b32;
  b32 = b31 && ((((((8 + (16 * (i30 / 8))) + (i30 % 8)) + i22) + i11) + i12) < T0.logical_size[0LL]);
  nvfuser_index_t i33;
  i33 = ((9 - T1.logical_size[1LL]) + (2 * (((nvfuser_index_t)threadIdx.x) % 4))) + i8;
  float T3[64];
  ...
  asm volatile("wgmma.fence.sync.aligned;\n");
  asm volatile("fence.proxy.async;\n");
  uint64_t* T25 = reinterpret_cast<uint64_t*>(array + smem_offset + 32768);
  #pragma unroll
  for(nvfuser_index_t i34 = 0; i34 < 4; ++i34) {
    if (((Hopper::electSync(4294967295U) && b28) && b29)) {
      mbarrier::init(toSmem((&T25[i34])), 3U);
    }
  }
  #pragma unroll
  for(nvfuser_index_t i35 = 0; i35 < 4; ++i35) {
    if (((Hopper::electSync(4294967295U) && b28) && b29)) {
      mbarrier::init(toSmem((&T25[(i35 + 4LL)])), 256U);
    }
  }
  __syncthreads();
  if ((((nvfuser_index_t)threadIdx.y) == 2)) {
    ...
    #pragma unroll 3
    for(nvfuser_index_t i36 = 0; i36 < i6; ++i36) {
      nvfuser_index_t i37;
      i37 = 16384 * (i36 % 4);
      if ((Hopper::electSync(4294967295U) && b28)) {
        mbarrier::waitParity(toSmem((&T25[((i36 % 4) + 4LL)])), (uint32_t)(((i36 / 4) % 2)));
        mbarrier::arriveExpectTX(toSmem((&T25[(i36 % 4)])), 16384U);
        Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr7, (Array<nvfuser_index_t, 2, 1>{(64 * i36), i8}), toSmem((&T25[(i36 % 4)])) }), (i9 + i37));
        mbarrier::arriveExpectTX(toSmem((&T25[(i36 % 4)])), 16384U);
        Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr10, (Array<nvfuser_index_t, 2, 1>{(64 * i36), i13}), toSmem((&T25[(i36 % 4)])) }), (i14 + i37));
        mbarrier::arriveExpectTX(toSmem((&T25[(i36 % 4)])), 16384U);
        Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr15, (Array<nvfuser_index_t, 2, 1>{(64 * i36), i8}), toSmem((&T25[(i36 % 4)])) }), (i16 + i37));
      }
    }
    return;
  } else {
    ...
    for(nvfuser_index_t i38 = 0; i38 < 4; ++i38) {
      mbarrier::arrive(toSmem((&T25[(i38 + 4LL)])));
    }
    #pragma unroll 3
    for(nvfuser_index_t i39 = 0; i39 < i6; ++i39) {
      nvfuser_index_t i40;
      i40 = 16384 * (i39 % 4);
      unsigned i41;
      i41 = i17 + i40;
      ...
      unsigned i43;
      i43 = i16 + i40;
      mbarrier::waitParity(toSmem((&T25[(i39 % 4)])), (uint32_t)(((i39 / 4) % 2)));
      #pragma unroll
      ...
      mbarrier::arrive(toSmem((&T25[((i39 % 4) + 4LL)])));
    }
  }
  #pragma unroll
  for(nvfuser_index_t i54 = 0; i54 < 16; ++i54) {
    nvfuser_index_t i55;
    i55 = 4 * i54;
    #pragma unroll
    for(nvfuser_index_t i56 = 0; i56 < 2; ++i56) {
      ...
      for(nvfuser_index_t i58 = 0; i58 < 2; ++i58) {
        ...
        i59 = i57 + i58;
        T18[i59]
           = __float2bfloat(T3[i59]);
      }
    }
  }
  #pragma unroll
  for(nvfuser_index_t i60 = 0; i60 < 16; ++i60) {
    nvfuser_index_t i61;
    i61 = 4 * i60;
    #pragma unroll
    for(nvfuser_index_t i62 = 0; i62 < 2; ++i62) {
      ...
      for(nvfuser_index_t i64 = 0; i64 < 2; ++i64) {
        ...
        T13[0]
          ...
          * T12[0];
        T21[i65]
           = __float2bfloat(T13[0]);
      }
    }
  }
  #pragma unroll
  for(nvfuser_index_t i66 = 0; i66 < 8; ++i66) {
    if ((b32 && (i33 < (-(16 * i66))))) {
      asm volatile(
        "stmatrix.sync.aligned.x4.m8n8.shared.b16 [%0], {%1, %2, %3, %4};\n"
        :
        :"r"((uint32_t)((toSmem(T22) + ((((nvfuser_index_t)threadIdx.y) * 16384) + (((i66 / 4) * 8192) + ((i18 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i66 % 4) * 2)) ^ (i18 % 8)) * 16))))))),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T18[(8 * i66)]))[0]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T18[(8 * i66)]))[1]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T18[(8 * i66)]))[2]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T18[(8 * i66)]))[3])
      );
    }
  }
  __syncthreads();
  ...
  for(nvfuser_index_t i67 = 0; i67 < 2; ++i67) {
    asm volatile("fence.proxy.async;\n");
    if (Hopper::electSync(4294967295U) && b28 && b31) {
      Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr21, (Array<nvfuser_index_t, 2, 1>{(i8 + (64 * i67)), i23}) }), (i20 + (8192 * i67)));
    }
  }
  ...
  for(nvfuser_index_t i68 = 0; i68 < 8; ++i68) {
    if ((b32 && (i33 < (-(16 * i68))))) {
      asm volatile(
        "stmatrix.sync.aligned.x4.m8n8.shared.b16 [%0], {%1, %2, %3, %4};\n"
        :
        :"r"((uint32_t)((toSmem(T23) + ((((nvfuser_index_t)threadIdx.y) * 16384) + (((i68 / 4) * 8192) + ((i18 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i68 % 4) * 2)) ^ (i18 % 8)) * 16))))))),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T20[(8 * i68)]))[0]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T20[(8 * i68)]))[1]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T20[(8 * i68)]))[2]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T20[(8 * i68)]))[3])
      );
    }
  }
  __syncthreads();
  ...
  for(nvfuser_index_t i69 = 0; i69 < 2; ++i69) {
    asm volatile("fence.proxy.async;\n");
    if (Hopper::electSync(4294967295U) && b28 && b31) {
      Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr25, (Array<nvfuser_index_t, 2, 1>{(i8 + (64 * i69)), i23}) }), (i24 + (8192 * i69)));
    }
  }
  asm volatile("cp.async.bulk.commit_group;\n");
  asm volatile("cp.async.bulk.wait_group.read %0;\n"::"n"(0LL):"memory");
  ...
  for(nvfuser_index_t i70 = 0; i70 < 8; ++i70) {
    if ((b32 && (i33 < (-(16 * i70))))) {
      asm volatile(
        "stmatrix.sync.aligned.x4.m8n8.shared.b16 [%0], {%1, %2, %3, %4};\n"
        :
        :"r"((uint32_t)((toSmem(T24) + ((((nvfuser_index_t)threadIdx.y) * 16384) + (((i70 / 4) * 8192) + ((i18 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i70 % 4) * 2)) ^ (i18 % 8)) * 16))))))),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T21[(8 * i70)]))[0]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T21[(8 * i70)]))[1]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T21[(8 * i70)]))[2]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T21[(8 * i70)]))[3])
      );
    }
  }
  __syncthreads();
  ...
  for(nvfuser_index_t i71 = 0; i71 < 2; ++i71) {
    asm volatile("fence.proxy.async;\n");
    if (Hopper::electSync(4294967295U) && b28 && b31) {
      Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr27, (Array<nvfuser_index_t, 2, 1>{(i8 + (64 * i71)), i23}) }), (i26 + (8192 * i71)));
    }
  }
  asm volatile("cp.async.bulk.commit_group;\n");
  asm volatile("cp.async.bulk.wait_group.read %0;\n"::"n"(0LL):"memory");
  ...
  for(nvfuser_index_t i52 = 0; i52 < 4; ++i52) {
    if (((Hopper::electSync(4294967295U) && b28) && b29)) {
      mbarrier::inval(toSmem((&T25[(i52 + 4LL)])));
    }
  }
  #pragma unroll
  for(nvfuser_index_t i53 = 0; i53 < 4; ++i53) {
    if (((Hopper::electSync(4294967295U) && b28) && b29)) {
      mbarrier::inval(toSmem((&T25[i53])));
    }
  }
}
}
