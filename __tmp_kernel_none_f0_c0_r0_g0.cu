...
__global__ void __cluster_dims__(2, 1, 1) nvfuser_none_f0_c0_r0_g0(Tensor<__half, 3, 3> T0, Tensor<__half, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, Tensor<__half, 2, 2> T3) {
  ...
  nvfuser_index_t i3;
  i3 = ceilDiv(T0.logical_size[0LL], 16);
  const TensorMap* ptr4;
  ptr4 = &var0;
  nvfuser_index_t i5;
  i5 = 256 * ((nvfuser_index_t)blockIdx.x);
  __half* T5 = reinterpret_cast<__half*>(array + smem_offset + 82048);
  unsigned i6;
  i6 = toSmem(T5);
  ...
  for(nvfuser_index_t i36 = 0; i36 < 4; ++i36) {
    if (((Hopper::electSync(4294967295U) && b16) && b17)) {
      mbarrier::inval(toSmem((&T8[(i36 + 4LL)])));
    }
  }
  #pragma unroll
  for(nvfuser_index_t i37 = 0; i37 < 4; ++i37) {
    if (((Hopper::electSync(4294967295U) && b16) && b17)) {
      mbarrier::inval(toSmem((&T8[i37])));
    }
  }
  #pragma unroll
  for(nvfuser_index_t i38 = 0; i38 < 32; ++i38) {
    nvfuser_index_t i39;
    i39 = 4 * i38;
    #pragma unroll
    for(nvfuser_index_t i40 = 0; i40 < 2; ++i40) {
      nvfuser_index_t i41;
      i41 = i39 + (2 * i40);
      #pragma unroll
