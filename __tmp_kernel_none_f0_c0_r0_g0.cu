...
__global__ void nvfuser_none_f0_c0_r0_g0(Tensor<__half, 3, 3> T0, Tensor<__half, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, Tensor<__half, 2, 2> T3) {
  ...
  __half* T5 = reinterpret_cast<__half*>(array + smem_offset + 10368);
  unsigned i6;
  i6 = toSmem(T5);
  ...
  #pragma unroll
  for(nvfuser_index_t i19 = 0; i19 < 5; ++i19) {
    if (b16) {
  ...
  #pragma unroll
  for(nvfuser_index_t i20 = 0; i20 < 5; ++i20) {
    if (b16) {
  ...
  for(nvfuser_index_t i25 = 0; i25 < i3; ++i25) {
    ...
    i33 = (i25 + 3) % 5;
    if (b16) {
      mbarrier::arriveExpectTX(toSmem((&T7[((3 + i25) % 5)])), 8192U);
      #pragma unroll
      for(nvfuser_index_t i24 = 0; i24 < 4; ++i24) {
        Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr4, (Array<nvfuser_index_t, 2, 1>{(i5 + (64 * i24)), i26}), toSmem((&T7[((3 + i25) % 5)])) }), (i28 + (2048 * i24)));
      }
    } else {
  ...
  for(nvfuser_index_t i34 = (i2 - 3); i34 < i2; ++i34) {
    ...
    unsigned i37;
    i37 = i6 + (8192 * i35);
    mbarrier::waitParity(toSmem((&T7[(i34 % 5)])), (((uint32_t)(i34) / 5U) % 2U));
    mbarrier::waitParity(toSmem((&T8[(i34 % 5)])), (((uint32_t)(i34) / 5U) % 2U));
    asm volatile(
      "{\n"
      "  .reg .pred p0; \n"
      "  setp.ne.b32 p0, %130, 0;\n"
