...
__global__ void nvfuser_none_f0_c0_r0_g0(Tensor<__half, 3, 3> T0, Tensor<__half, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, Tensor<__half, 2, 2> T3) {
  ...
  i8 = toSmem(T4);
  unsigned i9;
  i9 = i8 + (2048 * ((nvfuser_index_t)threadIdx.y));
  nvfuser_index_t i10;
  ...
  i13 = i10 % 8;
  nvfuser_index_t i14;
  i14 = ((((i11 + ((16 * T1.logical_size[2LL]) * i12)) + (T1.logical_size[2LL] * i13)) + ((64 * T1.logical_size[2LL]) * ((nvfuser_index_t)threadIdx.y))) + i4) + ((128 * T1.logical_size[2LL]) * ((nvfuser_index_t)blockIdx.y));
  nvfuser_index_t i15;
  ...
  nvfuser_index_t i19;
  i19 = ((1 - T1.logical_size[2LL]) + i11) + i4;
  nvfuser_index_t i20;
  i20 = ((((-T0.logical_size[1LL]) + (16 * i12)) + i13) + (64 * ((nvfuser_index_t)threadIdx.y))) + i7;
  float T2[128];
  ...
  for(nvfuser_index_t i21 = 0; i21 < 4; ++i21) {
    if (((Hopper::electSync(4294967295U) && b16) && b17)) {
      mbarrier::init(toSmem((&T7[i21])), 2U);
    }
  }
  #pragma unroll
  for(nvfuser_index_t i22 = 0; i22 < 4; ++i22) {
    if (((Hopper::electSync(4294967295U) && b16) && b17)) {
      mbarrier::init(toSmem((&T7[(i22 + 4LL)])), 256U);
    }
  }
  __syncthreads();
  if ((((nvfuser_index_t)threadIdx.y) == 2)) {
    ...
    for(nvfuser_index_t i23 = 0; i23 < i2; ++i23) {
      ...
      if ((Hopper::electSync(4294967295U) && b16)) {
        mbarrier::waitParity(toSmem((&T7[((i23 % 4) + 4LL)])), (uint32_t)(((i23 / 4) % 2)));
        mbarrier::arriveExpectTX(toSmem((&T7[(i23 % 4)])), 8192U);
        #pragma unroll
        for(nvfuser_index_t i28 = 0; i28 < 4; ++i28) {
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr3, (Array<nvfuser_index_t, 2, 1>{(i4 + (64 * i28)), i24}), toSmem((&T7[(i23 % 4)])) }), (i26 + (2048 * i28)));
        }
        mbarrier::arriveExpectTX(toSmem((&T7[(i23 % 4)])), 4096U);
        #pragma unroll
        for(nvfuser_index_t i29 = 0; i29 < 2; ++i29) {
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr6, (Array<nvfuser_index_t, 2, 1>{(i7 + (64 * i29)), i24}), toSmem((&T7[(i23 % 4)])) }), (i27 + (2048 * i29)));
        }
      }
    }
  } else {
    ...
    for(nvfuser_index_t i30 = 0; i30 < 4; ++i30) {
      mbarrier::arrive(toSmem((&T7[(i30 + 4LL)])));
    }
    #pragma unroll 4
    for(nvfuser_index_t i31 = 0; i31 < i2; ++i31) {
      nvfuser_index_t i32;
      i32 = i31 % 4;
      unsigned i33;
      i33 = i9 + (4096 * i32);
      unsigned i34;
      i34 = i5 + (8192 * i32);
      mbarrier::waitParity(toSmem((&T7[(i31 % 4)])), (uint32_t)(((i31 / 4) % 2)));
      asm volatile(
        "{\n"
        "  .reg .pred p0; \n"
  ...
  for(nvfuser_index_t i35 = 0; i35 < 4; ++i35) {
    if (((Hopper::electSync(4294967295U) && b16) && b17)) {
      mbarrier::inval(toSmem((&T7[(i35 + 4LL)])));
    }
  }
  #pragma unroll
  for(nvfuser_index_t i36 = 0; i36 < 4; ++i36) {
    if (((Hopper::electSync(4294967295U) && b16) && b17)) {
      mbarrier::inval(toSmem((&T7[i36])));
    }
  }
  ...
  for(nvfuser_index_t i37 = 0; i37 < 32; ++i37) {
    ...
    for(nvfuser_index_t i42 = 0; i42 < 2; ++i42) {
      ...
      for(nvfuser_index_t i44 = 0; i44 < 2; ++i44) {
        T6[i44]
           = __float2half(T2[(i43 + i44)]);
      }
      if ((b41 && (i20 < (-(8 * i42))))) {
        loadLocalToGlobal<__half, /*vec_size=*/2, /*is_volatile=*/false>( &T3[(i40 + (i15 * i42))], &T6[0]);
      }
    }
  }
}
