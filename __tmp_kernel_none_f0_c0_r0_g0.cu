...
__global__ void nvfuser_none_f0_c0_r0_g0(Tensor<__half, 3, 3> T0, Tensor<__half, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, Tensor<__half, 2, 2> T3) {
  ...
  for(nvfuser_index_t i21 = 0; i21 < 3; ++i21) {
    ...
    if (b16) {
      mbarrier::arriveExpectTX(toSmem((&T9[i21])), 2048U);
  ...
  for(nvfuser_index_t i25 = 0; i25 < i3; ++i25) {
    ...
    i33 = (i25 + (4 - 1)) % 4;
    if (b16) {
      mbarrier::arriveExpectTX(toSmem((&T7[((3 + i25) % 4)])), 8192U);
      #pragma unroll
      for(nvfuser_index_t i24 = 0; i24 < 4; ++i24) {
    ...
    if (b16) {
      mbarrier::arriveExpectTX(toSmem((&T9[((3 + i25) % 4)])), 2048U);
      ...
      mbarrier::arrive(toSmem((&T9[((3 + i25) % 4)])));
    }
    mbarrier::wait(toSmem((&T9[i32])), parity[i32]);
    asm volatile(
      "{\n"
      "  .reg .pred p0; \n"
    ...
    parity[((3 + i25) % 4)] = 1 - parity[((3 + i25) % 4)];
  }
  #pragma unroll 1
  for(nvfuser_index_t i34 = (i2 - 3); i34 < i2; ++i34) {
    ...
    unsigned i37;
    i37 = i6 + (8192 * i35);
    mbarrier::wait(toSmem((&T7[(i34 % 4)])), parity[(i34 % 4)]);
    mbarrier::wait(toSmem((&T9[(i34 % 4)])), parity[(i34 % 4)]);
    asm volatile(
      "{\n"
      "  .reg .pred p0; \n"
      "  setp.ne.b32 p0, %130, 0;\n"
  ...
  for(nvfuser_index_t i40 = 0; i40 < 32; ++i40) {
    ...
    for(nvfuser_index_t i45 = 0; i45 < 2; ++i45) {
      ...
      for(nvfuser_index_t i47 = 0; i47 < 2; ++i47) {
        T6[i47]
           = __float2half(T2[(i46 + i47)]);
      }
      if ((b44 && (i18 < (-(8 * i45))))) {
        loadLocalToGlobal<__half, /*vec_size=*/2, /*is_volatile=*/false>( &T3[(i43 + (i15 * i45))], &T6[0]);
      }
    }
  }
}
