...
__global__ void nvfuser_none_f0_c0_r0_g0(Tensor<__half, 3, 3> T0, Tensor<__half, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, Tensor<__half, 2, 2> T3) {
  ...
  ptr7 = &var1;
  nvfuser_index_t i8;
  i8 = 64 * ((nvfuser_index_t)blockIdx.y);
  ...
  i13 = i10 % 8;
  nvfuser_index_t i14;
  i14 = (((i11 + ((16 * T1.logical_size[2LL]) * i12)) + (T1.logical_size[2LL] * i13)) + i5) + ((64 * T1.logical_size[2LL]) * ((nvfuser_index_t)blockIdx.y));
  nvfuser_index_t i15;
  i15 = 8 * T1.logical_size[2LL];
  bool b16;
  b16 = (((((nvfuser_index_t)threadIdx.x) < 32ULL) && (((nvfuser_index_t)threadIdx.y) == 0ULL)) && (((nvfuser_index_t)threadIdx.z) == 0ULL)) && Hopper::electSync(4294967295U);
  bool b17;
  b17 = ((nvfuser_index_t)threadIdx.x) == 0;
  nvfuser_index_t i18;
  ...
  for(nvfuser_index_t i22 = 0; i22 < 3; ++i22) {
    ...
    if (b16) {
      ...
      for(nvfuser_index_t i28 = 0; i28 < 2; ++i28) {
        ...
        for(nvfuser_index_t i30 = 0; i30 < 4; ++i30) {
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr4, (Array<nvfuser_index_t, 2, 1>{(i5 + (64 * i30)), i31}), toSmem((&T7[i22])) }), (i32 + (1024 * i30)));
          __nanosleep(10000);
        }
      }
    } else {
    ...
    if (b16) {
      ...
      #pragma unroll
      for(nvfuser_index_t i33 = 0; i33 < 2; ++i33) {
        Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr7, (Array<nvfuser_index_t, 2, 1>{i8, (i24 + (8 * i33))}), toSmem((&T9[i22])) }), (i27 + (1024 * i33)));
        __nanosleep(10000);
      }
    } else {
  ...
  #pragma unroll 1
  for(nvfuser_index_t i34 = 0; i34 < i3; ++i34) {
    nvfuser_index_t i35;
    i35 = (3 + i34) % 4;
    nvfuser_index_t i36;
    i36 = 4096 * i35;
    ...
    i46 = (i34 + (4 - 1)) % 4;
    if (b16) {
      T8[((3 + i34) % 4)] = mbarrier::arriveExpectTX(toSmem((&T7[((3 + i34) % 4)])), 8192U);
      #pragma unroll
      for(nvfuser_index_t i28 = 0; i28 < 2; ++i28) {
        nvfuser_index_t i47;
        i47 = i37 + (8 * i28);
        ...
        #pragma unroll
        for(nvfuser_index_t i30 = 0; i30 < 4; ++i30) {
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr4, (Array<nvfuser_index_t, 2, 1>{(i5 + (64 * i30)), i47}), toSmem((&T7[((3 + i34) % 4)])) }), (i48 + (1024 * i30)));
          __nanosleep(10000);
        }
      }
    } else {
      T8[((3 + i34) % 4)] = mbarrier::arrive(toSmem((&T7[((3 + i34) % 4)])));
    }
    ...
    if (b16) {
      ...
      #pragma unroll
      for(nvfuser_index_t i33 = 0; i33 < 2; ++i33) {
        Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr7, (Array<nvfuser_index_t, 2, 1>{i8, (i37 + (8 * i33))}), toSmem((&T9[((3 + i34) % 4)])) }), (i40 + (1024 * i33)));
        __nanosleep(10000);
      }
    } else {
      T10[((3 + i34) % 4)] = mbarrier::arrive(toSmem((&T9[((3 + i34) % 4)])));
    }
    mbarrier::wait(toSmem((&T9[i45])), T10[i45]);
    ...
    asm volatile(
      ...
      :"l"((4611686293305294848ULL | ((262143ULL & (uint64_t)(i42)) >> 4ULL))),
       "l"((4611687117943209984ULL | ((262143ULL & (uint64_t)(i43)) >> 4ULL))),
       "n"((uint32_t)(true)),
       "n"(1),
       "n"(1),
       "n"(1),
  ...
  #pragma unroll 1
  for(nvfuser_index_t i49 = (i2 - 3); i49 < i2; ++i49) {
    nvfuser_index_t i50;
    i50 = (3 + i49) % 4;
    nvfuser_index_t i51;
    i51 = 4096 * i50;
    ...
    #pragma unroll
    for(nvfuser_index_t i33 = 0; i33 < (ceilDiv(16, 8)); ++i33) {
      #pragma unroll
      for(nvfuser_index_t i57 = 0; i57 < (ceilDiv(64, 64)); ++i57) {
        mbarrier::wait(toSmem((&T9[(i49 % 4)])), T10[(i49 % 4)]);
      }
    }
    __nanosleep(10000);
    asm volatile("wgmma.fence.sync.aligned;\n");
    ...
    asm volatile(
      ...
      :"l"((4611686293305294848ULL | ((262143ULL & (uint64_t)(i54)) >> 4ULL))),
       "l"((4611687117943209984ULL | ((262143ULL & (uint64_t)(i55)) >> 4ULL))),
       "n"((uint32_t)(true)),
       "n"(1),
       "n"(1),
       "n"(1),
  ...
  for(nvfuser_index_t i58 = 0; i58 < 4; ++i58) {
    if (b16) {
      mbarrier::inval(toSmem((&T9[i58])));
    }
  }
  #pragma unroll
  for(nvfuser_index_t i59 = 0; i59 < 4; ++i59) {
    if (b16) {
      mbarrier::inval(toSmem((&T7[i59])));
    }
  }
  __nanosleep(10000);
  #pragma unroll
  for(nvfuser_index_t i60 = 0; i60 < 32; ++i60) {
    ...
    b64 = i18 < (-i62);
    #pragma unroll
    for(nvfuser_index_t i65 = 0; i65 < 2; ++i65) {
      nvfuser_index_t i66;
      i66 = i61 + (2 * i65);
      Array<__half, 2, 2> T6;
      #pragma unroll
      for(nvfuser_index_t i67 = 0; i67 < 2; ++i67) {
        T6[i67]
           = __float2half(T2[(i66 + i67)]);
      }
      if ((b64 && (i19 < (-(8 * i65))))) {
        loadLocalToGlobal<__half, /*vec_size=*/2, /*is_volatile=*/false>( &T3[(i63 + (i15 * i65))], &T6[0]);
      }
    }
  }
}
