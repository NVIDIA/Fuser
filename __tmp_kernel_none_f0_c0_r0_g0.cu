...
void nvfuser_none_f0_c0_r0_g0(Tensor<__half, 3, 3> T0, Tensor<__half, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, Tensor<__half, 2, 2> T3) {
  ...
  if (threadIdx.y == 2) {
    ...
    for(nvfuser_index_t i27 = 0; i27 < i2; ++i27) {
      ...
      mbarrier::arriveExpectTX(toSmem((&T7[i29])), 4096U);
      #pragma unroll
  ...
  for(nvfuser_index_t i27 = 0; i27 < i2; ++i27) {
    ...
    unsigned i31;
    i31 = i9 + (4096 * i29);
    mbarrier::waitParity(toSmem((&T7[i29])), (uint32_t)((i27 / 4U) % 2U));
    asm volatile(
      "{\n"
      "  .reg .pred p0; \n"
      ...
      :"l"((4611686293305294848ULL | ((262143ULL & (uint64_t)(i31)) >> 4ULL))),
       "l"((4611686293313683456ULL | ((262143ULL & (uint64_t)(i30)) >> 4ULL))),
       "n"((uint32_t)(true)),
       "n"(1),
       "n"(1),
       "n"(1),
    ...
    mbarrier::arrive(toSmem((&T7[4 + i29])));
  }
  #pragma unroll
  if ((b17 && Hopper::electSync(4294967295U))) {
