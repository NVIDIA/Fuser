...
nvfuser_none_f0_c0_r0_g0(Tensor<__half, 3, 3> T0, Tensor<__half, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, Tensor<__half, 2, 2> T3) {
  ...
  nvfuser_index_t i2;
  i2 = ceilDiv(T0.logical_size[0], 16);
  nvfuser_index_t i3;
  i3 = -3 + i2;
  ...
  i14 = i11 % 8;
  nvfuser_index_t i15;
  i15 = ((((i12 + ((16 * T1.logical_size[2]) * i13)) + (T1.logical_size[2] * i14)) + ((64 * T1.logical_size[2]) * ((nvfuser_index_t)threadIdx.y))) + i5) + ((128 * T1.logical_size[2]) * ((nvfuser_index_t)blockIdx.y));
  nvfuser_index_t i16;
  i16 = 8 * T1.logical_size[2];
  bool b17;
  b17 = (threadIdx.x / 32 == 0);
  nvfuser_index_t i18;
  i18 = ((1 - T1.logical_size[2]) + i12) + i5;
  nvfuser_index_t i19;
  i19 = ((((-T0.logical_size[1]) + (16 * i13)) + i14) + (64 * ((nvfuser_index_t)threadIdx.y))) + i8;
  float T2[128];
  ...
  if ((b17 && Hopper::electSync(4294967295U))) {
    #pragma unroll
    for(nvfuser_index_t i20 = 0; i20 < 4; ++i20) {
      mbarrier::init(toSmem((&T7[i20 + (1 + threadIdx.y) * 4])), 1U);
    }
  }
  __syncthreads();
  #pragma unroll
  ...
  for(nvfuser_index_t i27 = 0; i27 < i3; ++i27) {
    ...
    if (Hopper::electSync(4294967295U) && b17) {
      ...
      Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr7, (Array<nvfuser_index_t, 2, 1>{(i8 + (64 * threadIdx.y)), i28}), toSmem((&T7[i29 + (1 + threadIdx.y) * 4])) }), (i31 + (2048 * threadIdx.y)));
    }
    mbarrier::waitParity(toSmem((&T7[i32])), (uint32_t)((i27 / 4) % 2));
    mbarrier::waitParity(toSmem((&T7[i32 + (1 + threadIdx.y) * 4])), (uint32_t)((i27 / 4) % 2));
    // __syncthreads();
    // continue;
    asm volatile(
      "{\n"
  ...
  for(nvfuser_index_t i35 = (i2 - 3); i35 < i2; ++i35) {
    ...
    unsigned i38;
    i38 = i6 + (8192 * i36);
    mbarrier::waitParity(toSmem((&T7[(i35 % 4)])), (uint32_t)((i35 / 4) % 2));
    mbarrier::waitParity(toSmem((&T7[(i35 % 4) + (1 + threadIdx.y) * 4])), (uint32_t)((i35 / 4) % 2));
    asm volatile(
      "{\n"
      "  .reg .pred p0; \n"
      "  setp.ne.b32 p0, %130, 0;\n"
      ...
      :"+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T2[0]))[0]),
       ...
       "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T2[0]))[126]),
       "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T2[0]))[127])
      :"l"((4611686293305294848ULL | ((262143ULL & (uint64_t)(i37)) >> 4ULL))),
       "l"((4611686293313683456ULL | ((262143ULL & (uint64_t)(i38)) >> 4ULL))),
       "n"((uint32_t)(true)),
       "n"(1),
       "n"(1),
       "n"(1),
  ...
  if ((b17 && Hopper::electSync(4294967295U)) && threadIdx.y == 0) {
    #pragma unroll
    for(nvfuser_index_t i20 = 0; i20 < 4; ++i20) {
      mbarrier::inval(toSmem((&T7[i20])));
    }
  }
  if ((b17 && Hopper::electSync(4294967295U))) {
    #pragma unroll
    for(nvfuser_index_t i20 = 0; i20 < 4; ++i20) {
      mbarrier::inval(toSmem((&T7[i20 + (1 + threadIdx.y) * 4])));
    }
  }
  asm volatile("wgmma.commit_group.sync.aligned;\n");
  asm volatile("wgmma.wait_group.sync.aligned %0;\n"::"n"(0):"memory");
  ...
  for(nvfuser_index_t i40 = 0; i40 < 32; ++i40) {
    ...
    for(nvfuser_index_t i45 = 0; i45 < 2; ++i45) {
      ...
      if ((b44 && (i19 < (-(8 * i45))))) {
        loadLocalToGlobal<__half, /*vec_size=*/2, /*is_volatile=*/false>( &T3[(i43 + (i16 * i45))], &T6[0]);
      }
    }
  }
}
