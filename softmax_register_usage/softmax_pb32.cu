...
__global__ void nvfuser_none_f0_c0_r0_g0(Tensor<__half, 2, 2> T0, Tensor<__half, 2, 2> T10) {
  alignas(16) extern __shared__ char array[];
  void* shared_mem = array;
  NVFUSER_DEFINE_MAGIC_ZERO;
  nvfuser_index_t i0;
  i0 = 8LL * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i1;
  i1 = i0 + (T0.logical_size[1LL] * ((nvfuser_index_t)blockIdx.x));
  nvfuser_index_t i2;
  i2 = ceilDiv((ceilDiv(T0.logical_size[1LL], 8)), 32);
  nvfuser_index_t i3;
  i3 = 8LL * i2;
  bool b4;
  b4 = ((nvfuser_index_t)threadIdx.x) < i2;
  nvfuser_index_t i5;
  i5 = (7 - T0.logical_size[1LL]) + i0;
  Array<__half, 256, 8> T17;
  #pragma unroll
  for(nvfuser_index_t i6 = 0; i6 < 32; ++i6) {
    T17.set(__half(0));
  }
  ...
  for(nvfuser_index_t i6 = 0; i6 < 32; ++i6) {
    nvfuser_index_t i7;
    i7 = i3 * (i6 + nvfuser_zero);
    if ((b4 && (i5 < (-i7)))) {
      loadGlobalToLocal<__half, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T17[(8LL * i6)],  &T0[(i1 + i7)]);
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  float T2[1];
  ...
  T19[0] = NEG_INFINITY;
  #pragma unroll
  for(nvfuser_index_t i8 = 0; i8 < 32; ++i8) {
    nvfuser_index_t i9;
    i9 = 8LL * i8;
    bool b10;
    b10 = b4 && (i5 < (-(i3 * (i8 + nvfuser_zero))));
    if (b10) {
      #pragma unroll
      for(nvfuser_index_t i11 = 0; i11 < 8; ++i11) {
        float T1[1];
        T1[0]
           = __half2float(T17[(i9 + i11)]);
        T19[0] = fmax(
          T19[0],
          T1[0]);
      }
  ...
  NVFUSER_UPDATE_MAGIC_ZERO;
  warp::warpReduceTIDX<false, true>(T2[0], T19[0], [](float &a, float b) { a = fmax(a, b); }, static_cast<float*>(shared_mem), true, static_cast<float>(NEG_INFINITY));
  float T3[1];
  broadcast::blockBroadcast<true, false, false, true>(T3[0], T2[0], static_cast<float*>(shared_mem), true);
  float T6[1];
  T6[0] = 0.000000000e+00f;
  float T20[1];
  T20[0] = 0.000000000e+00f;
  #pragma unroll
  for(nvfuser_index_t i12 = 0; i12 < 32; ++i12) {
    nvfuser_index_t i13;
    i13 = 8LL * i12;
    bool b14;
    b14 = b4 && (i5 < (-(i3 * (i12 + nvfuser_zero))));
    if (b14) {
      #pragma unroll
      for(nvfuser_index_t i15 = 0; i15 < 8; ++i15) {
        float T11[1];
        T11[0]
           = __half2float(T17[(i13 + i15)]);
        float T4[1];
        T4[0]
          = T11[0]
          - T3[0];
  ...
  NVFUSER_UPDATE_MAGIC_ZERO;
  warp::warpReduceTIDX<false, true>(T6[0], T20[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, static_cast<float>(0.000000000e+00f));
  float T7[1];
  broadcast::blockBroadcast<true, false, false, true>(T7[0], T6[0], static_cast<float*>(shared_mem), true);
  float T8[1];
  T8[0]
     = reciprocal(T7[0]);
  #pragma unroll
  for(nvfuser_index_t i16 = 0; i16 < 32; ++i16) {
    nvfuser_index_t i17;
    i17 = 8LL * i16;
    nvfuser_index_t i18;
    i18 = i3 * (i16 + nvfuser_zero);
    nvfuser_index_t i19;
    i19 = i1 + i18;
    bool b20;
    b20 = b4 && (i5 < (-i18));
    if (b20) {
      Array<__half, 8, 8> T18;
      #pragma unroll
      for(nvfuser_index_t i21 = 0; i21 < 8; ++i21) {
        float T13[1];
        T13[0]
           = __half2float(T17[(i17 + i21)]);
        float T14[1];
        T14[0]
          = T13[0]
          - T3[0];
      ...
      loadLocalToGlobal<__half, /*vec_size=*/8, /*is_volatile=*/false>( &T10[i19], &T18[0]);
    } else {
      Array<__half, 8, 8> T18;
      #pragma unroll
      for(nvfuser_index_t i21 = 0; i21 < 8; ++i21) {
