...
__global__ void nvfuser_none_f0_c0_r0_g0(Tensor<__half, 2, 2> T0, Tensor<__half, 2, 2> T10) {
  ...
  nvfuser_index_t i2;
  i2 = ceilDiv((ceilDiv(T0.logical_size[1LL], 8)), 16);
  nvfuser_index_t i3;
  i3 = 8LL * i2;
  bool b4;
  ...
  Array<__half, 128, 8> T17;
  #pragma unroll
  for(nvfuser_index_t i6 = 0; i6 < 16; ++i6) {
    T17.set(__half(0));
  }
  ...
  T19[0] = NEG_INFINITY;
  #pragma unroll
  for(nvfuser_index_t i8 = 0; i8 < 16; ++i8) {
    nvfuser_index_t i9;
    i9 = 8LL * i8;
    bool b10;
  ...
  #pragma unroll
  for(nvfuser_index_t i12 = 0; i12 < 16; ++i12) {
    nvfuser_index_t i13;
    i13 = 8LL * i12;
    bool b14;
  ...
  T8[0]
     = reciprocal(T7[0]);
  #pragma unroll
  for(nvfuser_index_t i16 = 0; i16 < 16; ++i16) {
    nvfuser_index_t i17;
    i17 = 8LL * i16;
    nvfuser_index_t i18;
