  ...
  do {
    ...
    if ((((i1 + 7175) + i0) < i3)) {
      if (threadIdx.x < 32 && Hopper::electSync(4294967295U)) {
        ...
        Hopper::cpAsyncBulkG2S((Hopper::CpAsyncBulkG2SIndex{ (T0.data + i0), 16384U, toSmem(T11) }), toSmem(T6));
      }
      mbarrier::waitParity(toSmem(T11), tma_parity_phase);
      tma_parity_phase ^= 1;
