...
for data, perf in zip(parameters, performance):
    ...
    best_config, best_perf = max(all_config[shape])
    ...
    if random.random() < test_data_percentage:
        ...
        train_output.append([*best_config, best_perf])
...
for hidden_shape in empirical_hidden_sizes:
    ...
    estimate_config = find_best_parameters(clf, (empirical_batch_size, hidden_shape))
