...
__device__ __half max(__half a, __half b) {
  ...
  return __float2half(max(a_float, b_float));
}

__device__ __bfloat max(__bfloat a, __bfloat b) {
  auto a_float = __bfloat2float(a);
  auto b_float = __bfloat2float(b);
  return __float2bfloat(max(a_float, b_float));
}

// fmax(double, double) is the cuda built-in
...
// fmin(double, double) is the cuda built-in
...
__device__ float clamp(float x, double minv, double maxv) {
  return min(max((double)x, minv), maxv);
}
...
__global__ void __launch_bounds__(
  ...
  ptr2 = &var0;
  __bfloat* T7 = reinterpret_cast<__bfloat*>(array + smem_offset + 114816);
  uint32_t i3;
  i3 = toSmem(T7);
  const TensorMap* ptr4;
  ptr4 = &var1;
  __bfloat* T6 = reinterpret_cast<__bfloat*>(array + smem_offset + 128);
  uint32_t i5;
  i5 = toSmem(T6);
  nvfuser_index_t i6;
  i6 = 8 * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i7;
  i7 = 8 * (((nvfuser_index_t)threadIdx.x) % 16);
  nvfuser_index_t i8;
  i8 = ((nvfuser_index_t)threadIdx.x) / 16;
  nvfuser_index_t i9;
  i9 = (8192 * i8) + i7;
  bool b10;
  b10 = ((nvfuser_index_t)threadIdx.x) < 32ULL;
  bool b11;
  b11 = ((nvfuser_index_t)threadIdx.x) < 512;
  nvfuser_index_t i12;
  i12 = -8185 + i7;
  nvfuser_index_t i13;
  i13 = -8192 + i8;
  uint64_t* T11 = reinterpret_cast<uint64_t*>(array + smem_offset + 0);
#pragma unroll
  for (nvfuser_index_t i14 = 0; i14 < 7; ++i14) {
    if ((Hopper::electSync(4294967295U) && b10)) {
      mbarrier::init(toSmem((&T11[i14])), 2U);
    }
  }
#pragma unroll
  for (nvfuser_index_t i15 = 0; i15 < 7; ++i15) {
    if ((Hopper::electSync(4294967295U) && b10)) {
      mbarrier::init(toSmem((&T11[(i15 + 7LL)])), 512U);
    }
  }
  __syncthreads();
  if ((((nvfuser_index_t)threadIdx.x) >= 512)) {
    decreaseRegisters<32>();
#pragma unroll 6
    for (nvfuser_index_t i16 = 0; i16 < 54; ++i16) {
      nvfuser_index_t i17;
      i17 = ((nvfuser_index_t)blockIdx.x) + (152 * i16);
      nvfuser_index_t i18;
      i18 = 16384 * (i16 % 7);
      if (((((((nvfuser_index_t)threadIdx.x) + -512) / 32ULL) == 0ULL) &&
           Hopper::electSync(4294967295U))) {
        mbarrier::waitParity(
            toSmem((&T11[((i16 % 7) + 7LL)])), __to_uint32(((i16 / 7) % 2)));
        mbarrier::arriveExpectTX(toSmem((&T11[(i16 % 7)])), 16384U);
        Hopper::cpAsyncBulkTensorTileG2S(
            (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{
                ptr2,
                (Array<int, 2, 1>{
                    __to_int32((128 * (i17 % 64))),
                    __to_int32((64 * (i17 / 64)))}),
                toSmem((&T11[(i16 % 7)]))}),
            (i3 + i18));
        mbarrier::arriveExpectTX(toSmem((&T11[(i16 % 7)])), 16384U);
        Hopper::cpAsyncBulkTensorTileG2S(
    ...
    increaseRegisters<112>();
#pragma unroll
    for (nvfuser_index_t i19 = 0; i19 < 7; ++i19) {
      mbarrier::arrive(toSmem((&T11[(i19 + 7LL)])));
    }
#pragma unroll 1
    for (nvfuser_index_t i20 = 0; i20 < 54; ++i20) {
      nvfuser_index_t i21;
      i21 = i6 + (8192 * (i20 % 7));
      nvfuser_index_t i22;
      i22 = ((nvfuser_index_t)blockIdx.x) + (152 * i20);
      nvfuser_index_t i23;
      i23 = 128 * (i22 % 64);
      nvfuser_index_t i24;
      i24 = i22 / 64;
      nvfuser_index_t i25;
      i25 = (i9 + (524288 * i24)) + i23;
      bool b26;
      b26 = b11 && (i12 < (-i23));
      nvfuser_index_t i27;
      i27 = -(64 * i24);
      mbarrier::waitParity(
          toSmem((&T11[(i20 % 7)])), __to_uint32(((i20 / 7) % 2)));
#pragma unroll
      for (nvfuser_index_t i28 = 0; i28 < 2; ++i28) {
        nvfuser_index_t i29;
        i29 = i21 + (4096 * i28);
        Array<__bfloat, 8, 8> T9;
        loadGeneric<__bfloat, 8>(&T9[0], &T7[i29]);
        Array<__bfloat, 8, 8> T8;
        loadGeneric<__bfloat, 8>(&T8[0], &T6[i29]);
        // Alias Allocation - register
        auto& T10 = T8;
#pragma unroll
        for (nvfuser_index_t i30 = 0; i30 < 8; ++i30) {
          Array<float, 1, 1> T3;
          T3[0] = __bfloat2float(T9[i30]);
          Array<float, 1, 1> T2;
          T2[0] = __bfloat2float(T8[i30]);
          Array<float, 1, 1> T4;
          T4[0] = T2[0] * T3[0];
          T10[i30] = __float2bfloat(T4[0]);
        }
        if ((b26 && (i13 < (i27 - (32 * i28))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>(
              &T5[(i25 + (262144 * i28))], &T10[0]);
        }
      }
      mbarrier::arrive(toSmem((&T11[((i20 % 7) + 7LL)])));
    }
  }
#pragma unroll
  for (nvfuser_index_t i31 = 0; i31 < 7; ++i31) {
    if ((Hopper::electSync(4294967295U) && b10)) {
      mbarrier::inval(toSmem((&T11[(i31 + 7LL)])));
    }
  }
#pragma unroll
  for (nvfuser_index_t i32 = 0; i32 < 7; ++i32) {
    if ((Hopper::electSync(4294967295U) && b10)) {
      mbarrier::inval(toSmem((&T11[i32])));
    }
  }
}
