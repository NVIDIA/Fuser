...
__global__ void nvfuser_none_f0_c0_r0_g0(
  ...
  ptr2 = &var0;
  nvfuser_index_t i3;
  i3 = 256 * ((nvfuser_index_t)blockIdx.x);
  nvfuser_index_t i4;
  ...
  nvfuser_index_t i8;
  i8 = i7 + (512 * ((nvfuser_index_t)threadIdx.y));
  nvfuser_index_t i9;
  i9 = ((i7 + ((2 * T0.logical_size[1LL]) * ((nvfuser_index_t)threadIdx.y))) +
        i3) +
      ((64 * T0.logical_size[1LL]) * ((nvfuser_index_t)blockIdx.y));
  bool b10;
  b10 = (((nvfuser_index_t)threadIdx.x) == 0ULL) &&
      (((nvfuser_index_t)threadIdx.y) == 0ULL);
  nvfuser_index_t i11;
  i11 = 2 * ((nvfuser_index_t)threadIdx.y);
  bool b12;
  b12 = ((1 + i11) + i4) < T0.logical_size[0LL];
  nvfuser_index_t i13;
  i13 = ((7 - T0.logical_size[1LL]) + i7) + i3;
  nvfuser_index_t i14;
  i14 = ((-T0.logical_size[0LL]) + i11) + i4;
  __bfloat* T7 = reinterpret_cast<__bfloat*>(array + smem_offset + 0);
  __bfloat* T6 = reinterpret_cast<__bfloat*>(array + smem_offset + 32896);
  uint64_t* T11 = reinterpret_cast<uint64_t*>(array + smem_offset + 32896);
  uint64_t* T12 = reinterpret_cast<uint64_t*>(array + smem_offset + 32768);

  mbarrier::init(toSmem(T11), 1U);
  mbarrier::init(toSmem(T12), 1U);
  __syncthreads();
  if (b10) {
    mbarrier::arriveExpectTX(toSmem(T11), 32768U);
    mbarrier::arriveExpectTX(toSmem(T12), 32768U);
    Hopper::cpAsyncBulkTensorTileG2S(
        (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ptr2, a5, toSmem(T11)}),
        toSmem(T7));
    Hopper::cpAsyncBulkTensorTileG2S(
        (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ptr6, a5, toSmem(T12)}),
        toSmem(T6));
  }
  mbarrier::waitParity(toSmem(T11), 0);
  mbarrier::waitParity(toSmem(T12), 0);
...
#pragma unroll
      for (nvfuser_index_t i23 = 0; i23 < 2; ++i23) {
        loadGeneric<__bfloat, 8>(&T8[(8 * i23)], &T6[(i19 + (256 * i23))]);
      }
    } else {
#pragma unroll
      for (nvfuser_index_t i23 = 0; i23 < 2; ++i23) {
...
#pragma unroll
    for (nvfuser_index_t i24 = 0; i24 < 2; ++i24) {
      ...
      i25 = 8 * i24;
#pragma unroll
      for (nvfuser_index_t i26 = 0; i26 < 8; ++i26) {
        nvfuser_index_t i27;
        i27 = i25 + i26;
        T2[i27] = __bfloat2float(T8[i27]);
      }
    }
...
#pragma unroll
      for (nvfuser_index_t i28 = 0; i28 < 2; ++i28) {
        loadGeneric<__bfloat, 8>(&T9[(8 * i28)], &T7[(i19 + (256 * i28))]);
      }
    } else {
#pragma unroll
      for (nvfuser_index_t i28 = 0; i28 < 2; ++i28) {
...
#pragma unroll
      for (nvfuser_index_t i41 = 0; i41 < 2; ++i41) {
        loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>(
            &T5[(i20 + (T0.logical_size[1LL] * i41))], &T10[(8 * i41)]);
      }
    } else {
#pragma unroll
      for (nvfuser_index_t i41 = 0; i41 < 2; ++i41) {
