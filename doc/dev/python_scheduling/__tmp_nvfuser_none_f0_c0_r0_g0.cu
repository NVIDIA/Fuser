...
__global__ void __launch_bounds__(
  ...
  nvfuser_index_t i7;
  i7 = ((nvfuser_index_t)threadIdx.x) / 16;
  nvfuser_index_t i8;
  ...
  bool b12;
  b12 = ((nvfuser_index_t)threadIdx.x) < 512;
  nvfuser_index_t i13;
  i13 = i7 + -8160;
  nvfuser_index_t i14;
  i14 = (i8 * 8) + -8185;
...
#pragma unroll
  for (nvfuser_index_t i17 = 0; i17 < 7; ++i17) {
    if ((Hopper::electSync(4294967295U) && b11)) {
      mbarrier::init(toSmem((&T11[i17])), 2U);
    }
  }
#pragma unroll
  for (nvfuser_index_t i18 = 0; i18 < 7; ++i18) {
    if ((Hopper::electSync(4294967295U) && b11)) {
      mbarrier::init(toSmem((&T11[(i18 + 7LL)])), 512U);
    }
  }
  __syncthreads();
...
#pragma unroll 6
    for (nvfuser_index_t i19 = 0; i19 < 54; ++i19) {
      nvfuser_index_t i20;
      i20 = ((nvfuser_index_t)blockIdx.x) + (152 * i19);
      nvfuser_index_t i21;
      i21 = 16384 * (i19 % 7);
      if (((((((nvfuser_index_t)threadIdx.x) + -512) / 32ULL) == 0ULL) &&
           Hopper::electSync(4294967295U))) {
        mbarrier::waitParity(
            toSmem((&T11[((i19 % 7) + 7LL)])), __to_uint32(((i19 / 7) % 2)));
        mbarrier::arriveExpectTX(toSmem((&T11[(i19 % 7)])), 16384U);
        Hopper::cpAsyncBulkTensorTileG2S(
            (Hopper::CpAsyncBulkTensorTileG2SIndex<2>{
                ptr2,
                (Array<int, 2, 1>{
                    __to_int32((128 * (i20 % 64))),
                    __to_int32((64 * (i20 / 64)))}),
                toSmem((&T11[(i19 % 7)]))}),
            (i3 + i21));
        mbarrier::arriveExpectTX(toSmem((&T11[(i19 % 7)])), 16384U);
        Hopper::cpAsyncBulkTensorTileG2S(
...
#pragma unroll
    for (nvfuser_index_t i22 = 0; i22 < 7; ++i22) {
      mbarrier::arrive(toSmem((&T11[(i22 + 7LL)])));
    }
#pragma unroll
    for (nvfuser_index_t i23 = 0; i23 < 54; ++i23) {
      nvfuser_index_t i24;
      i24 = i6 + (8192 * (i23 % 7));
      nvfuser_index_t i25;
      i25 = ((nvfuser_index_t)blockIdx.x) + (152 * i23);
      nvfuser_index_t i26;
      i26 = i25 / 64;
      nvfuser_index_t i27;
      i27 = 128 * (i25 % 64);
      nvfuser_index_t i28;
      i28 = (i10 + (524288 * i26)) + i27;
      nvfuser_index_t i29;
      i29 = -i27;
      nvfuser_index_t i30;
      i30 = -(64 * i26);
      bool b31;
      b31 = (b12 && (i13 < i30)) && (i14 < i29);
      bool b32;
      b32 = b12 && (i15 < i29);
      mbarrier::waitParity(
          toSmem((&T11[(i23 % 7)])), __to_uint32(((i23 / 7) % 2)));
...
#pragma unroll
        for (nvfuser_index_t i33 = 0; i33 < 2; ++i33) {
          loadGeneric<__bfloat, 8>(&T8[(8 * i33)], &T6[(i24 + (4096 * i33))]);
        }
      } else {
#pragma unroll
        for (nvfuser_index_t i33 = 0; i33 < 2; ++i33) {
          if ((b32 && (i16 < (i30 - (32 * i33))))) {
            loadGeneric<__bfloat, 8>(&T8[(8 * i33)], &T6[(i24 + (4096 * i33))]);
          }
        }
      }
...
#pragma unroll
        for (nvfuser_index_t i38 = 0; i38 < 2; ++i38) {
          loadGeneric<__bfloat, 8>(&T9[(8 * i38)], &T7[(i24 + (4096 * i38))]);
        }
      } else {
#pragma unroll
        for (nvfuser_index_t i38 = 0; i38 < 2; ++i38) {
          if ((b32 && (i16 < (i30 - (32 * i38))))) {
            loadGeneric<__bfloat, 8>(&T9[(8 * i38)], &T7[(i24 + (4096 * i38))]);
          }
        }
      }
...
#pragma unroll
      for (nvfuser_index_t i43 = 0; i43 < 2; ++i43) {
        ...
        i44 = 8 * i43;
#pragma unroll
        for (nvfuser_index_t i45 = 0; i45 < 8; ++i45) {
          nvfuser_index_t i46;
          i46 = i44 + i45;
          T4[i46] = T2[i46] * T3[i46];
        }
      }
...
#pragma unroll
      for (nvfuser_index_t i47 = 0; i47 < 2; ++i47) {
        ...
        i48 = 8 * i47;
#pragma unroll
        for (nvfuser_index_t i49 = 0; i49 < 8; ++i49) {
          nvfuser_index_t i50;
          i50 = i48 + i49;
          T10[i50] = __float2bfloat(T4[i50]);
        }
      }
      if (b31) {
#pragma unroll
        for (nvfuser_index_t i51 = 0; i51 < 2; ++i51) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>(
              &T5[(i28 + (262144 * i51))], &T10[(8 * i51)]);
        }
      } else {
#pragma unroll
        for (nvfuser_index_t i51 = 0; i51 < 2; ++i51) {
          if ((b32 && (i16 < (i30 - (32 * i51))))) {
            loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>(
                &T5[(i28 + (262144 * i51))], &T10[(8 * i51)]);
          }
        }
      }
      mbarrier::arrive(toSmem((&T11[((i23 % 7) + 7LL)])));
    }
  }
#pragma unroll
  for (nvfuser_index_t i52 = 0; i52 < 7; ++i52) {
    if ((Hopper::electSync(4294967295U) && b11)) {
      mbarrier::inval(toSmem((&T11[(i52 + 7LL)])));
    }
  }
#pragma unroll
  for (nvfuser_index_t i53 = 0; i53 < 7; ++i53) {
    if ((Hopper::electSync(4294967295U) && b11)) {
      mbarrier::inval(toSmem((&T11[i53])));
    }
  }
}
