...
__global__ void __launch_bounds__(
  ...
  ptr4 = &var1;
  __bfloat* T7 = reinterpret_cast<__bfloat*>(array + smem_offset + 128);
  uint32_t i5;
  i5 = toSmem(T7);
  nvfuser_index_t i6;
...
#pragma unroll
  for (nvfuser_index_t i15 = 0; i15 < 4; ++i15) {
    if ((Hopper::electSync(4294967295U) && b10)) {
      mbarrier::init(toSmem((&T11[(i15 + 4LL)])), 512U);
    }
  }
  __syncthreads();
...
#pragma unroll 3
    for (nvfuser_index_t i16 = 0; i16 < 54; ++i16) {
      ...
      if (((((((nvfuser_index_t)threadIdx.x) + -512) / 32ULL) == 0ULL) &&
        ...
        mbarrier::waitParity(
            toSmem((&T11[((i16 % 4) + 4LL)])), __to_uint32(((i16 / 4) % 2)));
        mbarrier::arriveExpectTX(toSmem((&T11[(i16 % 4)])), 16384U);
...
#pragma unroll
    for (nvfuser_index_t i19 = 0; i19 < 4; ++i19) {
      mbarrier::arrive(toSmem((&T11[(i19 + 4LL)])));
    }
#pragma unroll
    for (nvfuser_index_t i20 = 0; i20 < 54; ++i20) {
      ...
      nvfuser_index_t i27;
      i27 = -(64 * i24);
      Array<__bfloat, 64, 8> T8;
      mbarrier::waitParity(
          toSmem((&T11[(i20 % 4)])), __to_uint32(((i20 / 4) % 2)));
#pragma unroll
      for (nvfuser_index_t i28 = 0; i28 < 8; ++i28) {
        if (((b26 && (i28 < 2)) && (i13 < (i27 - (32 * i28))))) {
          loadGeneric<__bfloat, 8>(&T8[(8 * i28)], &T6[(i21 + (4096 * i28))]);
        }
      }
      Array<__bfloat, 64, 8> T9;
#pragma unroll
      for (nvfuser_index_t i29 = 0; i29 < 8; ++i29) {
        if (((b26 && (i29 < 2)) && (i13 < (i27 - (32 * i29))))) {
          loadGeneric<__bfloat, 8>(&T9[(8 * i29)], &T7[(i21 + (4096 * i29))]);
        }
      }
      mbarrier::arrive(toSmem((&T11[((i20 % 4) + 4LL)])));
#pragma unroll
      for (nvfuser_index_t i30 = 0; i30 < 8; ++i30) {
        nvfuser_index_t i31;
        i31 = 8 * i30;
        bool b32;
        b32 = (b26 && (i30 < 2)) && (i13 < (i27 - (32 * i30)));
        Array<__bfloat, 8, 8> T10;
#pragma unroll
        for (nvfuser_index_t i33 = 0; i33 < 8; ++i33) {
          nvfuser_index_t i34;
          i34 = i31 + i33;
          Array<float, 1, 1> T3;
          if (b32) {
            T3[0] = __bfloat2float(T9[i34]);
          }
          Array<float, 1, 1> T2;
          if (b32) {
            T2[0] = __bfloat2float(T8[i34]);
          }
          Array<float, 1, 1> T4;
          if (b32) {
            T4[0] = T2[0] * T3[0];
...
#pragma unroll
  for (nvfuser_index_t i35 = 0; i35 < 4; ++i35) {
    if ((Hopper::electSync(4294967295U) && b10)) {
      mbarrier::inval(toSmem((&T11[(i35 + 4LL)])));
    }
  }
#pragma unroll
  for (nvfuser_index_t i36 = 0; i36 < 4; ++i36) {
    if ((Hopper::electSync(4294967295U) && b10)) {
      mbarrier::inval(toSmem((&T11[i36])));
    }
  }
}
