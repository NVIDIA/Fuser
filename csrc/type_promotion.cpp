...
ResultTypeState updateResultTypeState(
  ...
  if (scalar == DataType::Half || scalar == DataType::BFloat16 || scalar == DataType::Float8_e4m3fn || scalar == DataType::Float8_e5m2) {
...
DataType computeTypes(
  ...
  if (cast_half_to_float &&
      (common_type == DataType::Half || common_type == DataType::BFloat16 || common_type == DataType::Float8_e4m3fn || common_type == DataType::Float8_e5m2)) {
