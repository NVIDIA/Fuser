...
// found from the State after the definition is read and the Fusion IR is in
// the process of being created.  However, pior to that point, the size is
// needed for matching a Fusion Record node in the Trie used to cache
// definitions.
struct BroadcastInDimOpRecord : RecordFunctor {
 ...
 private:
  //! Number of dims of shape Vector used to communicate the output tensor
  //! shape
