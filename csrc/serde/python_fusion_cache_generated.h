...
#ifndef FLATBUFFERS_GENERATED_PYTHONFUSIONCACHE_NVFUSER_SERDE_H_
#define FLATBUFFERS_GENERATED_PYTHONFUSIONCACHE_NVFUSER_SERDE_H_
...
enum RecordType {
  ...
  RecordType_ConstantBool = 7,
  RecordType_ConstantInt = 8,
  RecordType_ConstantDouble = 9,
  RecordType_ConstantComplexDouble = 10,
  RecordType_End = 11,
  RecordType_FullOp = 12,
  RecordType_IotaOp = 13,
  RecordType_IndexSelectOp = 14,
  RecordType_TorchGatherOp = 15,
  RecordType_Unary_TV = 16,
  RecordType_Unary_VAL = 17,
  RecordType_Binary_TV = 18,
  RecordType_Binary_VAL = 19,
  RecordType_Binary_TV_VAL = 20,
  RecordType_Binary_VAL_TV = 21,
  RecordType_Ternary_TV = 22,
  RecordType_Ternary_VAL = 23,
  RecordType_Ternary_TV_TV_VAL = 24,
  RecordType_Ternary_TV_VAL_TV = 25,
  RecordType_Ternary_VAL_TV_TV = 26,
  RecordType_Ternary_VAL_VAL_TV = 27,
  RecordType_Ternary_TV_VAL_VAL = 28,
  RecordType_Ternary_VAL_TV_VAL = 29,
  RecordType_Ternary_Alpha_TV = 30,
  RecordType_Ternary_Alpha_VAL = 31,
  RecordType_Ternary_Alpha_TV_TV_VAL = 32,
  RecordType_Ternary_Alpha_TV_VAL_TV = 33,
  RecordType_Ternary_Alpha_VAL_TV_TV = 34,
  RecordType_Ternary_Alpha_VAL_VAL_TV = 35,
  RecordType_Ternary_Alpha_TV_VAL_VAL = 36,
  RecordType_Ternary_Alpha_VAL_TV_VAL = 37,
  RecordType_OutputTv = 38,
  RecordType_OutputVal = 39,
  ...
  RecordType_SqueezeOp = 47,
  RecordType_Start = 48,
  RecordType_Tensor = 49,
  RecordType_TensorSizes = 50,
  RecordType_VarianceOp = 51,
  RecordType_VarianceMeanOp = 52,
  RecordType_ReshapeOp = 53,
  RecordType_MIN = RecordType_Base,
  RecordType_MAX = RecordType_ReshapeOp
};

inline const RecordType (&EnumValuesRecordType())[54] {
...
inline const char *EnumNameRecordType(RecordType e) {
  if (flatbuffers::IsOutRange(e, RecordType_Base, RecordType_ReshapeOp)) return "";
  const size_t index = static_cast<size_t>(e);
...
enum RecordData {
  ...
  RecordData_Squeeze = 14,
  RecordData_Reduction = 15,
  ...
  RecordData_MAX = RecordData_Reshape
};
...
inline const char *EnumNameRecordData(RecordData e) {
  if (flatbuffers::IsOutRange(e, RecordData_NONE, RecordData_Reshape)) return "";
  const size_t index = static_cast<size_t>(e);
...
#endif  // FLATBUFFERS_GENERATED_PYTHONFUSIONCACHE_NVFUSER_SERDE_H_
