...
inline const char* EnumNameRecordType(RecordType e) {
  if (::flatbuffers::IsOutRange(e, RecordType_Base, RecordType_Vector))
    return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char* EnumNameRecordData(RecordData e) {
  if (::flatbuffers::IsOutRange(e, RecordData_NONE, RecordData_Vector))
    return "";
  const size_t index = static_cast<size_t>(e);
...
template <>
struct RecordDataTraits<nvfuser::serde::Scalar> {
...
template <>
struct RecordDataTraits<nvfuser::serde::Vector> {
...
inline const char* const* EnumNamesArgAbstractData() {
  static const char* const names[6] = {
      "NONE", "Scalar", "PhiloxCudaState", "ScalarCpu", "TensorArg", nullptr};
  return names;
}
...
template <>
struct ArgAbstractDataTraits<nvfuser::serde::Scalar> {
...
struct Scalar FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  nvfuser::serde::DataType value_type() const {
    return static_cast<nvfuser::serde::DataType>(
        GetField<int32_t>(VT_VALUE_TYPE, 0));
  }
  ...
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
        ...
        VerifyField<double>(verifier, VT_IMAG_VALUE, 8) && verifier.EndTable();
  }
};
...
struct ScalarBuilder {
  ...
  void add_has_value(bool has_value) {
    fbb_.AddElement<uint8_t>(
        Scalar::VT_HAS_VALUE, static_cast<uint8_t>(has_value), 0);
  }
  void add_value_type(nvfuser::serde::DataType value_type) {
    fbb_.AddElement<int32_t>(
        Scalar::VT_VALUE_TYPE, static_cast<int32_t>(value_type), 0);
  }
  void add_bool_value(bool bool_value) {
    fbb_.AddElement<uint8_t>(
        Scalar::VT_BOOL_VALUE, static_cast<uint8_t>(bool_value), 0);
  }
  ...
  explicit ScalarBuilder(::flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) {
...
struct ArgAbstract FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const nvfuser::serde::Scalar* data_as_Scalar() const {
    return data_type() == nvfuser::serde::ArgAbstractData_Scalar
        ? static_cast<const nvfuser::serde::Scalar*>(data())
        : nullptr;
  }
...
template <>
inline const nvfuser::serde::Scalar* ArgAbstract::data_as<
    nvfuser::serde::Scalar>() const {
...
struct GlobalBufferInfoBuilder {
  ...
  void add_is_fusion_output(bool is_fusion_output) {
    fbb_.AddElement<uint8_t>(
        GlobalBufferInfo::VT_IS_FUSION_OUTPUT,
        static_cast<uint8_t>(is_fusion_output),
        0);
  }
...
struct VectorBuilder {
  ...
  explicit VectorBuilder(::flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct FusionExecutorBuilder {
  ...
  void add_index_type(nvfuser::serde::DataType index_type) {
    fbb_.AddElement<int32_t>(
        FusionExecutor::VT_INDEX_TYPE, static_cast<int32_t>(index_type), 0);
  }
...
struct RecordFunctor FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const nvfuser::serde::Scalar* data_as_Scalar() const {
    return data_type() == nvfuser::serde::RecordData_Scalar
        ? static_cast<const nvfuser::serde::Scalar*>(data())
        : nullptr;
  }
  ...
  const nvfuser::serde::Vector* data_as_Vector() const {
    return data_type() == nvfuser::serde::RecordData_Vector
        ? static_cast<const nvfuser::serde::Vector*>(data())
        : nullptr;
  }
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_ARGS) &&
...
template <>
inline const nvfuser::serde::Scalar* RecordFunctor::data_as<
    nvfuser::serde::Scalar>() const {
  return data_as_Scalar();
}
...
template <>
inline const nvfuser::serde::Vector* RecordFunctor::data_as<
    nvfuser::serde::Vector>() const {
