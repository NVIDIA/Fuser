...
enum RecordType : int32_t {
  ...
  RecordType_ConstantLong = 10,
  RecordType_ConstantDouble = 11,
  RecordType_ConstantFloat = 12,
  RecordType_ConstantComplexDouble = 13,
  RecordType_ConstantComplexFloat = 14,
  RecordType_End = 15,
  RecordType_FullOp = 16,
...
inline const RecordType (&EnumValuesRecordType())[61] {
  static const RecordType values[] = {
      ...
      RecordType_ConstantLong,
      RecordType_ConstantDouble,
      RecordType_ConstantFloat,
      RecordType_ConstantComplexDouble,
      RecordType_ConstantComplexFloat,
      RecordType_End,
      RecordType_FullOp,
      RecordType_IotaOp,
...
enum InstructionType : int32_t {
  ...
  InstructionType_Merge = 1,
  InstructionType_NamedString = 2,
  InstructionType_Scalar = 3,
  InstructionType_Split = 4,
  InstructionType_Symbolic = 5,
  InstructionType_Unary = 6,
  InstructionType_None = 7,
  InstructionType_MIN = InstructionType_Binary,
  InstructionType_MAX = InstructionType_None
};

inline const InstructionType (&EnumValuesInstructionType())[8] {
  static const InstructionType values[] = {
      InstructionType_Binary,
      InstructionType_Merge,
      InstructionType_NamedString,
      InstructionType_Scalar,
      InstructionType_Split,
...
inline const char* EnumNameInstructionType(InstructionType e) {
  if (::flatbuffers::IsOutRange(
          e, InstructionType_Binary, InstructionType_None))
    return "";
  const size_t index = static_cast<size_t>(e);
...
enum RecordData : uint8_t {
  ...
  RecordData_Long = 13,
  RecordData_Norm = 14,
  RecordData_Output = 15,
  RecordData_Pad = 16,
  RecordData_Permute = 17,
  RecordData_Slice = 18,
  RecordData_Squeeze = 19,
  RecordData_Reduction = 20,
  RecordData_Reshape = 21,
...
template <>
struct RecordDataTraits<nvfuser::serde::ComplexFloat> {
  static const RecordData enum_value = RecordData_ComplexFloat;
};
...
template <>
struct RecordDataTraits<nvfuser::serde::Float> {
  static const RecordData enum_value = RecordData_Float;
};
...
template <>
struct RecordDataTraits<nvfuser::serde::Long> {
...
enum ScalarCpuData : uint8_t {
  ...
  ScalarCpuData_ComplexFloat = 3,
  ScalarCpuData_Double = 4,
  ScalarCpuData_Float = 5,
  ScalarCpuData_Half = 6,
  ScalarCpuData_BFloat16 = 7,
  ScalarCpuData_Int = 8,
  ScalarCpuData_Long = 9,
  ScalarCpuData_MIN = ScalarCpuData_NONE,
  ScalarCpuData_MAX = ScalarCpuData_Long
};

inline const ScalarCpuData (&EnumValuesScalarCpuData())[10] {
  static const ScalarCpuData values[] = {
      ScalarCpuData_NONE,
      ScalarCpuData_Bool,
      ScalarCpuData_ComplexDouble,
      ScalarCpuData_ComplexFloat,
      ScalarCpuData_Double,
      ScalarCpuData_Float,
      ScalarCpuData_Half,
      ScalarCpuData_BFloat16,
      ScalarCpuData_Int,
      ScalarCpuData_Long};
  return values;
}
...
template <>
struct ScalarCpuDataTraits<nvfuser::serde::ComplexFloat> {
  static const ScalarCpuData enum_value = ScalarCpuData_ComplexFloat;
};
...
template <>
struct ScalarCpuDataTraits<nvfuser::serde::Float> {
  static const ScalarCpuData enum_value = ScalarCpuData_Float;
};
...
template <>
struct ScalarCpuDataTraits<nvfuser::serde::BFloat16> {
  static const ScalarCpuData enum_value = ScalarCpuData_BFloat16;
};
...
template <>
struct ScalarCpuDataTraits<nvfuser::serde::Long> {
  static const ScalarCpuData enum_value = ScalarCpuData_Long;
};
...
struct ComplexFloat FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  float real() const {
    return GetField<float>(VT_REAL, 0.0f);
  }
  float imag() const {
...
struct InstructionBuilder {
  ...
  void add_src0(int64_t src0) {
    fbb_.AddElement<int64_t>(Instruction::VT_SRC0, src0, 0);
  }
  void add_src1(int64_t src1) {
    fbb_.AddElement<int64_t>(Instruction::VT_SRC1, src1, 0);
  }
  void add_dest(int64_t dest) {
    fbb_.AddElement<int64_t>(Instruction::VT_DEST, dest, 0);
  }
...
struct IterationDomain FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
        VerifyField<int64_t>(verifier, VT_EXTENT, 8) && verifier.EndTable();
  }
};
...
struct Domain FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<
      ::flatbuffers::Offset<nvfuser::serde::IterationDomain>>*
  dims() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<nvfuser::serde::IterationDomain>>*>(VT_DIMS);
  }
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_DIMS) &&
        verifier.VerifyVector(dims()) &&
        verifier.VerifyVectorOfTables(dims()) && verifier.EndTable();
  }
};
...
struct DomainBuilder {
  ...
  void add_dims(
      ::flatbuffers::Offset<::flatbuffers::Vector<
          ::flatbuffers::Offset<nvfuser::serde::IterationDomain>>> dims) {
    fbb_.AddOffset(Domain::VT_DIMS, dims);
  }
  explicit DomainBuilder(::flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline ::flatbuffers::Offset<Domain> CreateDomain(
    ::flatbuffers::FlatBufferBuilder& _fbb,
    ::flatbuffers::Offset<::flatbuffers::Vector<
        ::flatbuffers::Offset<nvfuser::serde::IterationDomain>>> dims = 0) {
...
inline ::flatbuffers::Offset<Domain> CreateDomainDirect(
    ::flatbuffers::FlatBufferBuilder& _fbb,
    const std::vector<::flatbuffers::Offset<nvfuser::serde::IterationDomain>>*
        dims = nullptr) {
  auto dims__ = dims
      ? _fbb.CreateVector<
            ::flatbuffers::Offset<nvfuser::serde::IterationDomain>>(*dims)
      : 0;
  return nvfuser::serde::CreateDomain(_fbb, dims__);
}
...
struct AllocateBufferBuilder {
  ...
  void add_zero_init(bool zero_init) {
    fbb_.AddElement<uint8_t>(
        AllocateBuffer::VT_ZERO_INIT, static_cast<uint8_t>(zero_init), 0);
  }
...
struct ScalarCpu FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_INSTANCE) &&
...
struct ScalarCpuBuilder {
  ...
  ::flatbuffers::uoffset_t start_;
  void add_instance(
      ::flatbuffers::Offset<::flatbuffers::Vector<int8_t>> instance) {
...
inline ::flatbuffers::Offset<ScalarCpu> CreateScalarCpuDirect(
  ...
  return nvfuser::serde::CreateScalarCpu(_fbb, instance__, size);
}
...
struct TensorArg FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
        ...
        VerifyOffset(verifier, VT_SIZES) && verifier.VerifyVector(sizes()) &&
...
template <>
inline const nvfuser::serde::Bool* ArgAbstract::data_as<nvfuser::serde::Bool>()
    const {
  return data_as_Bool();
}

template <>
inline const nvfuser::serde::ComplexDouble* ArgAbstract::data_as<
    nvfuser::serde::ComplexDouble>() const {
  return data_as_ComplexDouble();
}

template <>
inline const nvfuser::serde::Double* ArgAbstract::data_as<
    nvfuser::serde::Double>() const {
  return data_as_Double();
}

template <>
inline const nvfuser::serde::Long* ArgAbstract::data_as<nvfuser::serde::Long>()
    const {
  return data_as_Long();
}

template <>
inline const nvfuser::serde::PhiloxCudaState* ArgAbstract::data_as<
    nvfuser::serde::PhiloxCudaState>() const {
...
struct KernelArgumentHolderBuilder {
  ...
  void add_device_index(int8_t device_index) {
    fbb_.AddElement<int8_t>(
        KernelArgumentHolder::VT_DEVICE_INDEX, device_index, 0);
  }
...
struct GlobalBufferInfoBuilder {
  ...
  void add_zero_init(bool zero_init) {
    fbb_.AddElement<uint8_t>(
        GlobalBufferInfo::VT_ZERO_INIT, static_cast<uint8_t>(zero_init), 0);
  }
  void add_is_profile_buffer(bool is_profile_buffer) {
    fbb_.AddElement<uint8_t>(
        GlobalBufferInfo::VT_IS_PROFILE_BUFFER,
...
inline ::flatbuffers::Offset<GlobalBufferInfo> CreateGlobalBufferInfoDirect(
  ...
  return nvfuser::serde::CreateGlobalBufferInfo(
      _fbb, tv, sizes__, strides__, dtype, zero_init, is_profile_buffer);
}
...
inline ::flatbuffers::Offset<ExecutorEntry> CreateExecutorEntryDirect(
  ...
  auto output_aliases__ =
      output_aliases ? _fbb.CreateVector<int32_t>(*output_aliases) : 0;
  auto input_aliases__ =
...
struct KernelSummaryBuilder {
  ...
  void add_has_cooperative_grid_reduction(bool has_cooperative_grid_reduction) {
    fbb_.AddElement<uint8_t>(
        KernelSummary::VT_HAS_COOPERATIVE_GRID_REDUCTION,
...
struct FusionExecutor FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<
      ::flatbuffers::Offset<nvfuser::serde::AllocateBuffer>>*
  global_allocations() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<nvfuser::serde::AllocateBuffer>>*>(
        VT_GLOBAL_ALLOCATIONS);
  }
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
        ...
        verifier.VerifyTable(kernel_summary()) &&
...
struct FusionExecutorBuilder {
  ...
  void add_generator(
      ::flatbuffers::Offset<nvfuser::serde::NaiveValueGenerator> generator) {
    fbb_.AddOffset(FusionExecutor::VT_GENERATOR, generator);
  }
  void add_global_allocations(
      ::flatbuffers::Offset<::flatbuffers::Vector<
          ::flatbuffers::Offset<nvfuser::serde::AllocateBuffer>>>
          global_allocations) {
    fbb_.AddOffset(FusionExecutor::VT_GLOBAL_ALLOCATIONS, global_allocations);
  }
...
inline ::flatbuffers::Offset<FusionExecutor> CreateFusionExecutor(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<
        nvfuser::serde::AllocateBuffer>>> global_allocations = 0) {
...
inline ::flatbuffers::Offset<FusionExecutor> CreateFusionExecutorDirect(
    ...
    ::flatbuffers::Offset<nvfuser::serde::KernelSummary> kernel_summary = 0,
    ::flatbuffers::Offset<nvfuser::serde::NaiveValueGenerator> generator = 0,
    const std::vector<::flatbuffers::Offset<nvfuser::serde::AllocateBuffer>>*
        global_allocations = nullptr) {
  ...
  auto executor_entry_lookup_values__ = executor_entry_lookup_values
      ? _fbb.CreateVector<::flatbuffers::Offset<nvfuser::serde::ExecutorEntry>>(
            *executor_entry_lookup_values)
      : 0;
  auto global_allocations__ = global_allocations
      ? _fbb.CreateVector<
            ::flatbuffers::Offset<nvfuser::serde::AllocateBuffer>>(
            *global_allocations)
      : 0;
...
struct InputsIdLookup FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
        ...
        verifier.VerifyVector(encoding_lookup_values()) && verifier.EndTable();
  }
};
...
inline ::flatbuffers::Offset<InputsIdLookup> CreateInputsIdLookupDirect(
  ...
  auto encoding_lookup_values__ = encoding_lookup_values
      ? _fbb.CreateVectorOfStructs<nvfuser::serde::EncodingEntry>(
            *encoding_lookup_values)
      : 0;
...
struct FusionExecutorCache FLATBUFFERS_FINAL_CLASS
  ...
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
        ...
        verifier.VerifyVector(kernel_cache_values()) && verifier.EndTable();
  }
};
...
CreateFusionExecutorCacheDirect(
  ...
  auto kernel_cache_values__ = kernel_cache_values
      ? _fbb.CreateVector<uint64_t>(*kernel_cache_values)
      : 0;
...
struct RecordFunctor FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const nvfuser::serde::ComplexFloat* data_as_ComplexFloat() const {
    return data_type() == nvfuser::serde::RecordData_ComplexFloat
        ? static_cast<const nvfuser::serde::ComplexFloat*>(data())
        : nullptr;
  }
  const nvfuser::serde::Double* data_as_Double() const {
  ...
  const nvfuser::serde::Float* data_as_Float() const {
    return data_type() == nvfuser::serde::RecordData_Float
        ? static_cast<const nvfuser::serde::Float*>(data())
        : nullptr;
  }
  ...
  const nvfuser::serde::Long* data_as_Long() const {
    return data_type() == nvfuser::serde::RecordData_Long
        ? static_cast<const nvfuser::serde::Long*>(data())
        : nullptr;
  }
...
template <>
inline const nvfuser::serde::ComplexFloat* RecordFunctor::data_as<
    nvfuser::serde::ComplexFloat>() const {
  return data_as_ComplexFloat();
}
...
template <>
inline const nvfuser::serde::Float* RecordFunctor::data_as<
    nvfuser::serde::Float>() const {
...
template <>
inline const nvfuser::serde::Long* RecordFunctor::data_as<
    nvfuser::serde::Long>() const {
  return data_as_Long();
}
...
inline bool VerifyRecordData(
  ...
  switch (type) {
    ...
    case RecordData_ComplexFloat: {
      auto ptr = reinterpret_cast<const nvfuser::serde::ComplexFloat*>(obj);
      return verifier.VerifyTable(ptr);
    }
    ...
    case RecordData_Float: {
      auto ptr = reinterpret_cast<const nvfuser::serde::Float*>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordData_Int: {
...
inline bool VerifyScalarCpuData(
  ...
  switch (type) {
    ...
    case ScalarCpuData_ComplexFloat: {
      auto ptr = reinterpret_cast<const nvfuser::serde::ComplexFloat*>(obj);
      return verifier.VerifyTable(ptr);
    }
    ...
    case ScalarCpuData_BFloat16: {
      auto ptr = reinterpret_cast<const nvfuser::serde::BFloat16*>(obj);
      return verifier.VerifyTable(ptr);
    }
