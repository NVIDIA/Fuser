...
struct VectorFromState;
struct VectorFromStateBuilder;
...
inline const RecordType (&EnumValuesRecordType())[64] {
  static const RecordType values[] = {
      ...
      RecordType_ScalarConstantBool,
      RecordType_ScalarConstantComplexDouble,
...
inline const char* EnumNameRecordType(RecordType e) {
  if (::flatbuffers::IsOutRange(e, RecordType_Base, RecordType_VectorInput))
    return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char* EnumNameRecordData(RecordData e) {
  if (::flatbuffers::IsOutRange(e, RecordData_NONE, RecordData_VectorInput))
    return "";
  const size_t index = static_cast<size_t>(e);
...
template <>
struct RecordDataTraits<nvfuser::serde::At> {
...
template <>
struct RecordDataTraits<nvfuser::serde::ScalarInput> {
  static const RecordData enum_value = RecordData_ScalarInput;
};

template <>
struct RecordDataTraits<nvfuser::serde::Size> {
...
template <>
struct RecordDataTraits<nvfuser::serde::VectorInt> {
  static const RecordData enum_value = RecordData_VectorInt;
};

template <>
struct RecordDataTraits<nvfuser::serde::VectorFromState> {
  static const RecordData enum_value = RecordData_VectorFromState;
};

template <>
struct RecordDataTraits<nvfuser::serde::VectorInput> {
...
struct At FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
        VerifyField<int64_t>(verifier, VT_INDEX, 8) && verifier.EndTable();
  }
};
...
struct AtBuilder {
  ...
  explicit AtBuilder(::flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) {
...
struct BoolBuilder {
  ...
  void add_dtype(nvfuser::serde::DataType dtype) {
    fbb_.AddElement<int32_t>(Bool::VT_DTYPE, static_cast<int32_t>(dtype), 0);
  }
...
struct ScalarInputBuilder {
  ...
  void add_dtype(nvfuser::serde::DataType dtype) {
    fbb_.AddElement<int32_t>(
        ScalarInput::VT_DTYPE, static_cast<int32_t>(dtype), 0);
  }
...
struct SizeBuilder {
  ...
  explicit SizeBuilder(::flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct VectorFromState FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef VectorFromStateBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_DTYPE = 4
  };
  nvfuser::serde::DataType dtype() const {
...
struct VectorFromStateBuilder {
  typedef VectorFromState Table;
  ::flatbuffers::FlatBufferBuilder& fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_dtype(nvfuser::serde::DataType dtype) {
    fbb_.AddElement<int32_t>(
        VectorFromState::VT_DTYPE, static_cast<int32_t>(dtype), 0);
  }
  explicit VectorFromStateBuilder(::flatbuffers::FlatBufferBuilder& _fbb)
      : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<VectorFromState> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<VectorFromState>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<VectorFromState> CreateVectorFromState(
    ::flatbuffers::FlatBufferBuilder& _fbb,
    nvfuser::serde::DataType dtype = nvfuser::serde::DataType_Double) {
  VectorFromStateBuilder builder_(_fbb);
  builder_.add_dtype(dtype);
  return builder_.Finish();
}
...
struct VectorInputBuilder {
  ...
  void add_dtype(nvfuser::serde::DataType dtype) {
    fbb_.AddElement<int32_t>(
        VectorInput::VT_DTYPE, static_cast<int32_t>(dtype), 0);
  }
...
struct VectorInt FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<int64_t>* int_vals() const {
    return GetPointer<const ::flatbuffers::Vector<int64_t>*>(VT_INT_VALS);
  }
  int64_t size() const {
    return GetField<int64_t>(VT_SIZE, 0);
  }
  ...
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_INT_VALS) &&
        verifier.VerifyVector(int_vals()) &&
        VerifyField<int64_t>(verifier, VT_SIZE, 8) &&
        VerifyField<int32_t>(verifier, VT_DTYPE, 4) && verifier.EndTable();
  }
};
...
struct VectorIntBuilder {
  typedef VectorInt Table;
  ::flatbuffers::FlatBufferBuilder& fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_int_vals(
      ::flatbuffers::Offset<::flatbuffers::Vector<int64_t>> int_vals) {
    fbb_.AddOffset(VectorInt::VT_INT_VALS, int_vals);
  }
  void add_size(int64_t size) {
    fbb_.AddElement<int64_t>(VectorInt::VT_SIZE, size, 0);
  }
  void add_dtype(nvfuser::serde::DataType dtype) {
    fbb_.AddElement<int32_t>(
        VectorInt::VT_DTYPE, static_cast<int32_t>(dtype), 0);
  }
  explicit VectorIntBuilder(::flatbuffers::FlatBufferBuilder& _fbb)
      : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<VectorInt> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<VectorInt>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<VectorInt> CreateVectorInt(
    ::flatbuffers::FlatBufferBuilder& _fbb,
    ::flatbuffers::Offset<::flatbuffers::Vector<int64_t>> int_vals = 0,
    int64_t size = 0,
    nvfuser::serde::DataType dtype = nvfuser::serde::DataType_Double) {
  VectorIntBuilder builder_(_fbb);
  builder_.add_size(size);
  builder_.add_dtype(dtype);
  builder_.add_int_vals(int_vals);
  return builder_.Finish();
}

inline ::flatbuffers::Offset<VectorInt> CreateVectorIntDirect(
    ::flatbuffers::FlatBufferBuilder& _fbb,
    const std::vector<int64_t>* int_vals = nullptr,
    int64_t size = 0,
    nvfuser::serde::DataType dtype = nvfuser::serde::DataType_Double) {
  auto int_vals__ = int_vals ? _fbb.CreateVector<int64_t>(*int_vals) : 0;
  return nvfuser::serde::CreateVectorInt(_fbb, int_vals__, size, dtype);
}
...
struct RecordFunctor FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const nvfuser::serde::At* data_as_At() const {
    return data_type() == nvfuser::serde::RecordData_At
        ? static_cast<const nvfuser::serde::At*>(data())
        : nullptr;
  }
  ...
  const nvfuser::serde::ScalarInput* data_as_ScalarInput() const {
    return data_type() == nvfuser::serde::RecordData_ScalarInput
        ? static_cast<const nvfuser::serde::ScalarInput*>(data())
        : nullptr;
  }
  const nvfuser::serde::Size* data_as_Size() const {
    return data_type() == nvfuser::serde::RecordData_Size
        ? static_cast<const nvfuser::serde::Size*>(data())
        : nullptr;
  }
  ...
  const nvfuser::serde::VectorInt* data_as_VectorInt() const {
    return data_type() == nvfuser::serde::RecordData_VectorInt
        ? static_cast<const nvfuser::serde::VectorInt*>(data())
        : nullptr;
  }
  const nvfuser::serde::VectorFromState* data_as_VectorFromState() const {
    return data_type() == nvfuser::serde::RecordData_VectorFromState
        ? static_cast<const nvfuser::serde::VectorFromState*>(data())
        : nullptr;
  }
  const nvfuser::serde::VectorInput* data_as_VectorInput() const {
    return data_type() == nvfuser::serde::RecordData_VectorInput
        ? static_cast<const nvfuser::serde::VectorInput*>(data())
        : nullptr;
  }
  bool Verify(::flatbuffers::Verifier& verifier) const {
...
template <>
inline const nvfuser::serde::At* RecordFunctor::data_as<nvfuser::serde::At>()
    const {
  return data_as_At();
}
...
template <>
inline const nvfuser::serde::ScalarInput* RecordFunctor::data_as<
    nvfuser::serde::ScalarInput>() const {
  return data_as_ScalarInput();
}

template <>
inline const nvfuser::serde::Size* RecordFunctor::data_as<
    nvfuser::serde::Size>() const {
  return data_as_Size();
}
...
template <>
inline const nvfuser::serde::VectorInt* RecordFunctor::data_as<
    nvfuser::serde::VectorInt>() const {
  return data_as_VectorInt();
}

template <>
inline const nvfuser::serde::VectorFromState* RecordFunctor::data_as<
    nvfuser::serde::VectorFromState>() const {
  return data_as_VectorFromState();
}

template <>
inline const nvfuser::serde::VectorInput* RecordFunctor::data_as<
    nvfuser::serde::VectorInput>() const {
...
inline bool VerifyRecordData(
  ...
  switch (type) {
    ...
    case RecordData_VectorInt: {
      auto ptr = reinterpret_cast<const nvfuser::serde::VectorInt*>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordData_VectorFromState: {
      auto ptr = reinterpret_cast<const nvfuser::serde::VectorFromState*>(obj);
      return verifier.VerifyTable(ptr);
    }
