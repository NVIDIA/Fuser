...
struct ScalarCpu FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const nvfuser::serde::ComplexFloat* data_as_ComplexFloat() const {
    return data_type() == nvfuser::serde::ScalarCpuData_ComplexFloat
  ...
  const nvfuser::serde::Float* data_as_Float() const {
    return data_type() == nvfuser::serde::ScalarCpuData_Float
  ...
  const nvfuser::serde::BFloat16* data_as_BFloat16() const {
    return data_type() == nvfuser::serde::ScalarCpuData_BFloat16
        ? static_cast<const nvfuser::serde::BFloat16*>(data())
        : nullptr;
  }
  ...
  const nvfuser::serde::Long* data_as_Long() const {
    return data_type() == nvfuser::serde::ScalarCpuData_Long
...
template <>
inline const nvfuser::serde::ComplexFloat* ScalarCpu::data_as<
...
template <>
inline const nvfuser::serde::Float* ScalarCpu::data_as<nvfuser::serde::Float>()
    const {
...
template <>
inline const nvfuser::serde::BFloat16* ScalarCpu::data_as<
    nvfuser::serde::BFloat16>() const {
  return data_as_BFloat16();
}
...
template <>
inline const nvfuser::serde::Long* ScalarCpu::data_as<nvfuser::serde::Long>()
    const {
  return data_as_Long();
}
...
struct TensorArgBuilder {
  ...
  void add_ndims(int64_t ndims) {
    fbb_.AddElement<int64_t>(TensorArg::VT_NDIMS, ndims, 0);
  }
...
struct CompileParams FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_INDEX_TYPE = 4,
    VT_MAXRREGCOUNT = 6,
    VT_ENABLE_MAGIC_ZERO = 8
  };
  nvfuser::serde::DataType index_type() const {
    return static_cast<nvfuser::serde::DataType>(
        GetField<int32_t>(VT_INDEX_TYPE, 0));
  }
  int32_t maxrregcount() const {
    return GetField<int32_t>(VT_MAXRREGCOUNT, 0);
  }
...
struct CompileParamsBuilder {
  ...
  void add_maxrregcount(int32_t maxrregcount) {
    fbb_.AddElement<int32_t>(CompileParams::VT_MAXRREGCOUNT, maxrregcount, 0);
  }
  void add_enable_magic_zero(bool enable_magic_zero) {
    fbb_.AddElement<uint8_t>(
        CompileParams::VT_ENABLE_MAGIC_ZERO,
...
inline flatbuffers::Offset<CompileParams> CreateCompileParams(
  ...
  CompileParamsBuilder builder_(_fbb);
  builder_.add_maxrregcount(maxrregcount);
  builder_.add_index_type(index_type);
  builder_.add_enable_magic_zero(enable_magic_zero);
  return builder_.Finish();
}
...
struct NvrtcFunction FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_MODULE_) &&
        ...
        verifier.VerifyVector(function()) && verifier.EndTable();
  }
};
...
inline flatbuffers::Offset<NvrtcFunction> CreateNvrtcFunctionDirect(
  ...
  auto function__ = function ? _fbb.CreateVector<int8_t>(*function) : 0;
...
struct FusionExecutor FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
        ...
        VerifyOffset(verifier, VT_USED_TVS) &&
        verifier.VerifyVector(used_tvs()) && verifier.EndTable();
  }
};
