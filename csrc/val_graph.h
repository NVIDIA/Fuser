...
class ValGraph {
 public:
  ...
  // Convert unique vector of Val to unique vector of its groups
  ValGroups toGroups(const VectorOfUniqueEntries<Val*>& vals) const;

  template <typename Container>
  ValGroups toGroups(const Container vals) const {
  ...
  // Returns true if the expression group has an input id group that matches an
