...
TensorView* select(TensorView* tv, int64_t dim, Val* index, bool keep_reduction_axis) {
  auto dom = keep_reduction_axis? tv->getLogicalDomain() : TensorDomain::noReductions(tv->getLogicalDomain());
