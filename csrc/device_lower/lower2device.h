...
class TORCH_CUDA_CU_API GpuLower : public NonCopyable {
 ...
 private:
  ...
  // Start access offsets of tensors. Currently only relevant for
  // sliced fusion inputs
  std::unordered_map<TensorView*, std::unordered_set<Val*>> tensor_offsets_;
