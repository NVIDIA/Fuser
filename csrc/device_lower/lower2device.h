...
class GpuLower : public NonCopyable {
 ...
 public:
  ...
  std::unordered_map<const kir::ClusterReductionOp*, kir::TensorIndex*>& clusterReductionMBarrierMap() {
    return cluster_reduction_mbarrier_map_;
  }

  const std::unordered_map<const kir::ClusterReductionOp*, kir::TensorIndex*>& clusterReductionMBarrierMap() const {
    return cluster_reduction_mbarrier_map_;
  }
 ...
 private:
  ...
  std::unordered_map<const kir::ClusterReductionOp*, kir::TensorIndex*> cluster_reduction_mbarrier_map_;
  ...
  // The shared cluster reduction mbarrier tensor allocated during allocation pass
