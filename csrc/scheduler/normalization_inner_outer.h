...
//! not vectorized.
constexpr int64_t register_file_size_combined = (int64_t)4 * 54 * 1024;
constexpr int64_t register_file_size_combined_nonvectorized =
    (int64_t)4 * 48 * 1024;
...
constexpr int64_t max_threads_per_block_combined_nonvectorized = 512l;
