...
bool fillDefaultHopperHeuristic(
  ...
  mparams->grid_traversal_factor = std::min(swizzled_tiles, 16L);
  while (swizzled_tiles % mparams->grid_traversal_factor != 0) {
  ...
  mparams->grid_traversal_factor = 1L;
