...
bool AccumulateScheduler::canScheduleCompileTime(Fusion* fusion) {
  if (!scheduler_tools::hasAccumulationBasedOps(fusion)) {
...
std::unique_ptr<HeuristicParams> AccumulateScheduler::computeHeuristics(
    Fusion* fusion,
    SchedulerRuntimeInfo& runtime_info,
    HeuristicDataCache* data_cache) {
  FUSER_PERF_SCOPE("AccumulateScheduler::computeHeuristics");
...
void AccumulateScheduler::schedule(Fusion* fusion, const HeuristicParams* params) {
  FUSER_PERF_SCOPE("AccumulateScheduler::schedule");
