...
int64_t getSharedMemoryOverheadPerBlock(
  ...
  // space, RMS Bwd fp32 failed at hidden size of 9472 on A100. The estimated
  // blocks per sm is exactly 2, but we can't launch 2 blocks per sm due to this
  // small extra usage. Disable magic-0, the kernel can launch 2 blocks per sm,
  // and about 5% faster. Leave this for future optimization.
