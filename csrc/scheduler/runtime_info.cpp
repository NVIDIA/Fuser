...
size_t SchedulerRuntimeInfo::getAlignmentSize(TensorView* tv, std::unordered_map<TensorView*, vectorize_helper::TensorResizeAlignmentInfo*> resize_alignment_map) {
