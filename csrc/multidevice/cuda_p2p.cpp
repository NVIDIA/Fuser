...
void launchAlltoallvKernel(
  ...
  // NOLINTBEGIN(cppcoreguidelines-avoid-c-arrays,modernize-avoid-c-arrays,cppcoreguidelines-pro-type-const-cast)
  void* args_kernel[] = {
      ...
      &elem_size,
      &max_send_bytes};
  // NOLINTEND(cppcoreguidelines-avoid-c-arrays,modernize-avoid-c-arrays,cppcoreguidelines-pro-type-const-cast)
