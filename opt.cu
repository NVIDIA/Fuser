...
__device__ __inline__ __bfloat __bfloatOr(const __bfloat x, const __bfloat y) {
  __bfloat val;
  asm("{  or.b16 %0, %1, %2;}\n"
      : "=h"(__NVFUSER_BFLOAT_TO_US(val))
      : "h"(__NVFUSER_BFLOAT_TO_CUS(x)),
        "h"(__NVFUSER_BFLOAT_TO_CUS(y)));
  return val;
}
  ...
  switch (sizeof(scalar_t) * vec_size) {
    ...
    case 16: {
      ...
      if (is_volatile) {
        ...
        asm volatile(
            "st.global.L1::no_allocate.v4.s32 [%0], {%1,%2,%3,%4};" ::"l"(
                (typename MaybeVolatile<uint4, is_volatile>::type*)to),
            "r"(data.x),
            "r"(data.y),
            "r"(data.z),
  ...
  switch (sizeof(scalar_t) * vec_size) {
    ...
    case 16: {
      if (is_volatile) {
        ...
        uint4& data = *reinterpret_cast<uint4*>(to);
        asm volatile("ld.global.L1::evict_last.v4.s32 {%0,%1,%2,%3}, [%4];"
                     : "=r"(data.x), "=r"(data.y), "=r"(data.z), "=r"(data.w)
                     : "l"((uint4*)from));
...
__global__ void nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 5, 5> T0, Tensor<__bfloat, 2, 2> T1, Tensor<__bfloat, 2, 2> T2, Tensor<__bfloat, 4, 4> T21, Tensor<__bfloat, 4, 4> T40) {
  nvfuser_index_t i0;
  i0 = 8LL * ((nvfuser_index_t)threadIdx.x);
  nvfuser_index_t i1;
  i1 = ((nvfuser_index_t)blockIdx.x) / 4LL;
  nvfuser_index_t i2;
  i2 = 128LL * (i1 % 4096LL);
  nvfuser_index_t i3;
  i3 = i0 + i2;
  nvfuser_index_t i4;
  i4 = 384LL * ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i5;
  i5 = 3072LL * ((nvfuser_index_t)blockIdx.x);
  nvfuser_index_t i6;
  i6 = ((64LL + i0) + i4) + i5;
  nvfuser_index_t i7;
  i7 = -64LL + i0;
  ...
  i8 = -128LL + i0;
  nvfuser_index_t i9;
  i9 = (((i0 + (524288LL * ((nvfuser_index_t)threadIdx.y))) + (16777216LL * (i1 / 4096LL))) + (4194304LL * (((nvfuser_index_t)blockIdx.x) % 4LL))) + i2;
  nvfuser_index_t i10;
  i10 = 7LL + i0;
  bool b11;
  b11 = i10 < 128LL;
  bool b12;
  b12 = (((nvfuser_index_t)threadIdx.y) + (8LL * ((nvfuser_index_t)blockIdx.x))) < 262144LL;
  bool b13;
  b13 = ((i7 >= 0LL) && ((-57LL + i0) < 64LL)) && b12;
  bool b14;
  b14 = (i10 < 64LL) && b12;
  bool b15;
  b15 = b11 && b12;
  ...
  nvfuser_index_t i17;
  i17 = 0LL + 64LL;
  Array<__bfloat, 8LL, 8> T42;
  
  if (b11) loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T42[0LL],  &T2[i3]);
  Array<__bfloat, 8LL, 8> T41;
  if (b11) loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T41[0LL],  &T1[i3]);
  Array<__bfloat, 8LL, 8> T22;
  T22.set(__bfloat(0LL));
  if (b13) {
    loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T22[0LL],  &T0[i6]);
  }
  Array<__bfloat, 8LL, 8> T23;
  T23.set(__bfloat(0LL));
  if (b14) {
    loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T23[0LL],  &T0[(((192LL + i0) + i4) + i5)]);
  }
  Array<__bfloat, 8LL, 8> T29;
  T29.set(__bfloat(0LL));
  if (b15) {
    loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T29[0LL],  &T0[(((128LL + i0) + i4) + i5)]);
  }
   Array<__bfloat, 8LL, 8> T39;
  #pragma unroll
  for(nvfuser_index_t i18 = 0LL; i18 < 8LL; ++i18) {
    nvfuser_index_t i19;
    i19 = -i18;
    __bfloat T25[1LL];
    //T25[0LL]
    //= ((i7 >= i19) && (i8 < i19)) ? T22[i18] : 0.0000e+00;
    __bfloat T24[1LL];
    //T24[0LL]
    //= (i7 < i19) ? T23[i18] : 0.0000e+00;
    __bfloat T26[1LL];
    //T26[0LL] = __bfloat2float(T24[0LL]) + __bfloat2float(T25[0LL]);
    //T26[0LL] = __bfloatOr(T24[0LL], T25[0LL]);
    T26[0LL] = __bfloatOr(T22[i18], T23[i18]);
    float T33[1LL];
    T33[0LL]
       = __bfloat2float(T26[0LL]);
    __bfloat T27[1LL];
    T27[0LL]
       = T41[i18];
    float T31[1LL];
    T31[0LL]
       = __bfloat2float(T27[0LL]);
    float T30[1LL];
    T30[0LL]
       = __bfloat2float(T29[i18]);
    float T32[1LL];
    T32[0LL]
      = T30[0LL]
      * T31[0LL];
    ...
    T38[0LL]
       = T37[0LL];
    T39[i18]
       = __float2bfloat(T38[0LL]);
  }
  if (b15) {
    loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T40[i9], &T39[0LL]);
  }
  Array<__bfloat, 8LL, 8> T3;
  T3.set(__bfloat(0LL));
  if (b13) {
    loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T3[0LL],  &T0[((i7 + i4) + i5)]);
  }
  Array<__bfloat, 8LL, 8> T4;
  T4.set(__bfloat(0LL));  
  if (b14) {
    loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T4[0LL],  &T0[i6]);
  }
  Array<__bfloat, 8LL, 8> T10;
  T10.set(__bfloat(0LL));
  if (b15) {
    loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T10[0LL],  &T0[((i0 + i4) + i5)]);
  }
  
  Array<__bfloat, 8LL, 8> T20;
  #pragma unroll
  for(nvfuser_index_t i20 = 0LL; i20 < 8LL; ++i20) {
    nvfuser_index_t i21;
    i21 = -i20;
    __bfloat T6[1LL];
    //T6[0LL]
    //= ((i7 >= i21) && (i8 < i21)) ? T3[i20] : 0.0000e+00;
    __bfloat T5[1LL];
    //T5[0LL]
    //= (i7 < i21) ? T4[i20] : 0.0000e+00;
    __bfloat T7[1LL];
    //T7[0LL] = __bfloatOr(T5[0LL], T6[0LL]);
    T7[0LL] = __bfloatOr(T4[i20], T3[i20]);
    float T14[1LL];
    T14[0LL]
       = __bfloat2float(T7[0LL]);
    __bfloat T8[1LL];
    T8[0LL]
       = T41[i20];
    float T12[1LL];
    T12[0LL]
       = __bfloat2float(T8[0LL]);
    float T11[1LL];
    T11[0LL]
       = __bfloat2float(T10[i20]);
    float T13[1LL];
    T13[0LL]
      = T11[0LL]
      * T12[0LL];
    ...
    T19[0LL]
       = T18[0LL];
    T20[i20]
       = __float2bfloat(T19[0LL]);
  }
  if (b15) {
    loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T21[i9], &T20[0LL]);
  }
}
}
