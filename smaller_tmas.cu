    ...
    if (b17) {
      ...
      for(nvfuser_index_t i34 = 0; i34 < i5; ++i34) {
        ...
        if ((Hopper::electSync(4294967295U) && b15)) {
          ...
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr6, (Array<nvfuser_index_t, 2, 1>{(64 * i34), i25}), toSmem((&T8[(i34 % 3)])) }), (i7 + (32768 * i35)));
          mbarrier::arriveExpectTX(toSmem((&T8[(i34 % 3)])), 16384U);
          #pragma unroll
          for(nvfuser_index_t i38 = 0; i38 < 2; ++i38) {
            Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr8, (Array<nvfuser_index_t, 2, 1>{i36, (i28 + (64 * i38))}), toSmem((&T8[(i34 % 3)])) }), (i37 + (8192 * i38)));
          }
        }
      }
    } else {
      ...
      for(nvfuser_index_t i40 = 0; i40 < i5; ++i40) {
        ...
        unsigned i43;
        i43 = i7 + (32768 * i41);
        mbarrier::waitParity(toSmem((&T8[(i40 % 3)])), (uint32_t)(((i40 / 3) % 2)));
        #pragma unroll
        ...
        mbarrier::arrive(toSmem((&T8[((i40 % 3) + 3LL)])));
      }
    }
    #pragma unroll
    for(nvfuser_index_t i48 = 0; i48 < 3; ++i48) {
      if (((Hopper::electSync(4294967295U) && b15) && b16)) {
        mbarrier::inval(toSmem((&T8[(i48 + 3LL)])));
      }
    }
    #pragma unroll
    for(nvfuser_index_t i49 = 0; i49 < 3; ++i49) {
      if (((Hopper::electSync(4294967295U) && b15) && b16)) {
        mbarrier::inval(toSmem((&T8[i49])));
      }
    }
