...
def nvfuser_fusion_id1(fd: FusionDefinition) -> None:
    ...
    T51 = fd.ops.set(T40) #fd.ops.sum(T45, dims=[2], keepdim=False, dtype=DataType.Null)
    T52 = fd.ops.set(T50) #fd.ops.sum(T50, dims=[2], keepdim=False, dtype=DataType.Null)
