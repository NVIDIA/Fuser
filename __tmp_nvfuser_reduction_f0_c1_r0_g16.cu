...
__global__ void nvfuser_reduction_f0_c1_r0_g16(Tensor<__bfloat, 4, 5> T138, Tensor<__bfloat, 4, 5> T137, Tensor<__bfloat, 4, 5> T136, Tensor<__bfloat, 1, 2> T248, Tensor<__bfloat, 2, 3> T228, Tensor<__bfloat, 2, 3> T286, Tensor<float, 1, 1> T289, Tensor<int64_t, 1, 1> T290) {
  ...
  b22 = b20 && b21;
  nvfuser_index_t i23;
  i23 = ((nvfuser_index_t)blockDim.y) * 4;
  nvfuser_index_t i24;
  i24 = (((i23 * ((nvfuser_index_t)blockIdx.y)) * i0) + (((nvfuser_index_t)blockDim.y) * 3)) + ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i25;
  i25 = (-2048 + ((nvfuser_index_t)threadIdx.y)) + ((i23 * i0) * ((nvfuser_index_t)blockIdx.y));
  bool b26;
  ...
  for(nvfuser_index_t i30 = 0; i30 < 8; ++i30) {
    T288[i30] = 0.000000000e+00f;
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll 1
  for(nvfuser_index_t i31 = 0; i31 < i0; ++i31) {
    nvfuser_index_t i32;
    i32 = i2 * i31;
    nvfuser_index_t i33;
    i33 = i7 + i32;
    ...
    if ((b22 && ((i24 + i37) < 2048))) {
      ...
      for(nvfuser_index_t i30 = 0; i30 < 8; ++i30) {
        ...
        for(nvfuser_index_t i47 = 0; i47 < 4; ++i47) {
          ...
          T139[0]
             = b41 ? T138[(i39 + i49)] : 0.0000e+00f;
          Array<__bfloat, 1, 1> T141;
          T141[0]
             = b43 ? T136[(i42 + i49)] : 0.0000e+00f;
          Array<__bfloat, 1, 1> T140;
          T140[0]
             = b45 ? T137[(i44 + i49)] : 0.0000e+00f;
      ...
      for(nvfuser_index_t i30 = 0; i30 < 8; ++i30) {
        ...
        for(nvfuser_index_t i47 = 0; i47 < 4; ++i47) {
          nvfuser_index_t i59;
          i59 = i47 + nvfuser_zero;
          nvfuser_index_t i60;
          i60 = i8 * i59;
          nvfuser_index_t i61;
          i61 = i58 + (i17 * i59);
          bool b62;
          b62 = b22 && (i38 < (-(((nvfuser_index_t)blockDim.y) * i59)));
          Array<__bfloat, 1, 1> T139;
          if (b62) {
            T139[0]
               = b53 ? T138[(i51 + i60)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T141;
          if (b62) {
            T141[0]
               = b55 ? T136[(i54 + i60)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T140;
          if (b62) {
            T140[0]
               = b57 ? T137[(i56 + i60)] : 0.0000e+00f;
          }
          Array<__bfloat, 1, 1> T142;
          if (b62) {
            T142[0]
  ...
  if (b22) {
    ...
    for(nvfuser_index_t i64 = 0; i64 < 8; ++i64) {
      ...
      if (b26) {
        T284[0]
           = __float2bfloat(T226[i64]);
      }
      if (b26) {
        T248[(i18 + (i64 + nvfuser_zero))]
           = T284[0];
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
