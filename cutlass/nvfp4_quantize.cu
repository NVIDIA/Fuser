...
[[maybe_unused]] constexpr int CVT_FP4_ELTS_PER_THREAD = 8;
[[maybe_unused]] constexpr int CVT_FP4_SF_VEC_SIZE = 16;
...
void nvfp4_quantize(
  ...
  auto input_scale_ptr = static_cast<float const*>(input_scale.data_ptr());
