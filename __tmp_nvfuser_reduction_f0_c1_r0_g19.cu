...
__global__ void nvfuser_reduction_f0_c1_r0_g19(Tensor<__bfloat, 3, 4> T0, Tensor<__bfloat, 2, 3> T35, Tensor<__bfloat, 1, 2> T254, Tensor<__bfloat, 2, 3> T240, Tensor<__bfloat, 2, 3> T288, Tensor<__bfloat, 2, 3> T243, Tensor<float, 1, 1> T292, Tensor<int64_t, 1, 1> T293) {
  ...
  b7 = ((7 + i2) + i3) < 49152;
  bool b8;
  b8 = (((nvfuser_index_t)threadIdx.x) + (((nvfuser_index_t)blockDim.x) * ((nvfuser_index_t)blockIdx.x))) < 3072;
  bool b9;
  b9 = b7 && b8;
  nvfuser_index_t i10;
  i10 = ((nvfuser_index_t)blockDim.y) * 2;
  nvfuser_index_t i11;
  i11 = (((i10 * ((nvfuser_index_t)blockIdx.y)) * i0) + ((nvfuser_index_t)blockDim.y)) + ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i12;
  i12 = (-2048 + ((nvfuser_index_t)threadIdx.y)) + ((i10 * i0) * ((nvfuser_index_t)blockIdx.y));
  bool b13;
  b13 = (((nvfuser_index_t)blockIdx.y) == (((nvfuser_index_t)gridDim.y) + -1)) && (((nvfuser_index_t)threadIdx.y) == 0);
  bool b14;
  b14 = (b13 && b7) && b8;
  // Allocate global tensor T292
  // Allocate global tensor T293
  Array<float, 8, 8> T291;
  #pragma unroll
  for(nvfuser_index_t i15 = 0; i15 < 8; ++i15) {
    T291[i15] = 0.000000000e+00f;
  }
  ...
  for(nvfuser_index_t i16 = 0; i16 < i0; ++i16) {
    ...
    i19 = i12 + i18;
    if ((b9 && ((i11 + i18) < 2048))) {
      Array<__bfloat, 16, 8> T284;
      #pragma unroll
      for(nvfuser_index_t i20 = 0; i20 < 2; ++i20) {
        loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T284[(8 * i20)],  &T0[(i17 + (i5 * (i20 + nvfuser_zero)))]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i15 = 0; i15 < 8; ++i15) {
        ...
        for(nvfuser_index_t i22 = 0; i22 < 2; ++i22) {
          nvfuser_index_t i23;
          i23 = i21 + (i5 * (i22 + nvfuser_zero));
          Array<__bfloat, 1, 1> T285;
          T285[0]
             = T35[i23];
          ...
          T57[0]
             = T56[0];
          Array<__bfloat, 1, 1> T287;
          T287[0]
             = T57[0];
          T240[i23]
             = T287[0];
          Array<__bfloat, 1, 1> T289;
          T289[0]
             = T57[0];
          T288[i23]
             = T289[0];
      ...
      for(nvfuser_index_t i20 = 0; i20 < 2; ++i20) {
        nvfuser_index_t i24;
        i24 = i20 + nvfuser_zero;
        if ((b9 && (i19 < (-(((nvfuser_index_t)blockDim.y) * i24))))) {
          loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T284[(8 * i20)],  &T0[(i17 + (i5 * i24))]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i15 = 0; i15 < 8; ++i15) {
        ...
        for(nvfuser_index_t i22 = 0; i22 < 2; ++i22) {
          nvfuser_index_t i26;
          i26 = i22 + nvfuser_zero;
          nvfuser_index_t i27;
          i27 = i25 + (i5 * i26);
          bool b28;
          b28 = b9 && (i19 < (-(((nvfuser_index_t)blockDim.y) * i26)));
          Array<__bfloat, 1, 1> T285;
          if (b28) {
            T285[0]
               = T35[i27];
  ...
  if (b9) {
    ...
    for(nvfuser_index_t i30 = 0; i30 < 8; ++i30) {
      Array<__bfloat, 1, 1> T286;
      if (b13) {
        T286[0]
           = __float2bfloat(T238[i30]);
      }
      if (b13) {
        T254[(i6 + (i30 + nvfuser_zero))]
           = T286[0];
      }
    }
    NVFUSER_UPDATE_MAGIC_ZERO;
