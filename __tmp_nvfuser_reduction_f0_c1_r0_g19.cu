...
__global__ void nvfuser_reduction_f0_c1_r0_g19(Tensor<float, 3, 3> T20, Tensor<__bfloat, 3, 3> T9, Tensor<float, 2, 2> T19, Tensor<__bfloat, 1, 1> T21, Tensor<__bfloat, 1, 1> T18, Tensor<__bfloat, 2, 2> T145, Tensor<__bfloat, 1, 1> T246, Tensor<__bfloat, 1, 1> T247, Tensor<float, 3, 3> T290, Tensor<float, 3, 3> T292, Tensor<__bfloat, 2, 2> T227, Tensor<float, 3, 3> T155, Tensor<float, 1, 1> T298, Tensor<int64_t, 1, 1> T299, Tensor<float, 1, 1> T300, Tensor<int64_t, 1, 1> T301) {
  ...
  bool b14;
  b14 = b13 && b10;
  // Allocate global tensor T298
  // Allocate global tensor T299
  // Allocate global tensor T300
  // Allocate global tensor T301
  Array<float, 4, 4> T297;
  #pragma unroll
  for(nvfuser_index_t i15 = 0; i15 < 4; ++i15) {
    T297[i15] = 0.000000000e+00f;
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  Array<float, 4, 4> T296;
  #pragma unroll
  for(nvfuser_index_t i15 = 0; i15 < 4; ++i15) {
    T296[i15] = 0.000000000e+00f;
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  #pragma unroll 1
  for(nvfuser_index_t i16 = 0; i16 < i0; ++i16) {
    ...
    i20 = i12 + i18;
    if ((b10 && ((i11 + i18) < 2048))) {
      Array<__bfloat, 4, 4> T285;
      T285.set(__bfloat(0));
      loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T285[0],  &T21[i3]);
      Array<__bfloat, 4, 4> T286;
      T286.set(__bfloat(0));
      loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T286[0],  &T18[i3]);
      Array<__bfloat, 8, 4> T287;
      #pragma unroll
      ...
      #pragma unroll
      for(nvfuser_index_t i21 = 0; i21 < 2; ++i21) {
        loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T287[(4 * i21)],  &T145[(i17 + (i6 * (i21 + nvfuser_zero)))]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 8, 4> T283;
      #pragma unroll
      ...
      #pragma unroll
      for(nvfuser_index_t i22 = 0; i22 < 2; ++i22) {
        loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T283[(4 * i22)],  &T9[(i17 + (i6 * (i22 + nvfuser_zero)))]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<float, 8, 4> T293;
      Array<float, 8, 4> T295;
      Array<__bfloat, 8, 4> T294;
      #pragma unroll
      for(nvfuser_index_t i15 = 0; i15 < 4; ++i15) {
        ...
        for(nvfuser_index_t i23 = 0; i23 < 2; ++i23) {
          ...
          T163[0]
             = T162[0];
          Array<float, 1, 1> T277;
          T277[0]
             = __bfloat2float(T283[i25]);
      ...
      for(nvfuser_index_t i26 = 0; i26 < 2; ++i26) {
        loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/false>( &T292[(i17 + (i6 * (i26 + nvfuser_zero)))], &T293[(4 * i26)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i27 = 0; i27 < 2; ++i27) {
        loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T227[(i17 + (i6 * (i27 + nvfuser_zero)))], &T294[(4 * i27)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i28 = 0; i28 < 2; ++i28) {
        loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/false>( &T155[(i17 + (i6 * (i28 + nvfuser_zero)))], &T295[(4 * i28)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
    } else {
      Array<__bfloat, 4, 4> T285;
      ...
      for(nvfuser_index_t i21 = 0; i21 < 2; ++i21) {
        ...
        if ((b10 && (i20 < (-(((nvfuser_index_t)blockDim.y) * i29))))) {
          loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T287[(4 * i21)],  &T145[(i17 + (i6 * i29))]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 8, 4> T283;
      ...
      for(nvfuser_index_t i22 = 0; i22 < 2; ++i22) {
        ...
        if ((b10 && (i20 < (-(((nvfuser_index_t)blockDim.y) * i30))))) {
          loadGlobalToLocal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false, CacheOp::Streaming>(&T283[(4 * i22)],  &T9[(i17 + (i6 * i30))]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<float, 8, 4> T293;
      ...
      for(nvfuser_index_t i26 = 0; i26 < 2; ++i26) {
        ...
        if ((b10 && (i20 < (-(((nvfuser_index_t)blockDim.y) * i36))))) {
          loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/false>( &T292[(i17 + (i6 * i36))], &T293[(4 * i26)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i27 = 0; i27 < 2; ++i27) {
        ...
        if ((b10 && (i20 < (-(((nvfuser_index_t)blockDim.y) * i37))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T227[(i17 + (i6 * i37))], &T294[(4 * i27)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i28 = 0; i28 < 2; ++i28) {
        ...
        if ((b10 && (i20 < (-(((nvfuser_index_t)blockDim.y) * i38))))) {
          loadLocalToGlobal<float, /*vec_size=*/4, /*is_volatile=*/false>( &T155[(i17 + (i6 * i38))], &T295[(4 * i28)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
    }
  ...
  if (b10) {
    ...
    NVFUSER_UPDATE_MAGIC_ZERO;
    if (b13) {
      loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T247[i3], &T289[0]);
    }
  } else {
    Array<float, 4, 1> T224;
    #pragma unroll
  ...
  if (b10) {
    ...
    NVFUSER_UPDATE_MAGIC_ZERO;
    if (b13) {
      loadLocalToGlobal<__bfloat, /*vec_size=*/4, /*is_volatile=*/false>( &T246[i3], &T288[0]);
    }
  } else {
    // Alias Allocation - register
    auto& T222 = T297;
