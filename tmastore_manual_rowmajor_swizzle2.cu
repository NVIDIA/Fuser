...
__global__ void __cluster_dims__(2, 1, 1) nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 3, 3> T0, Tensor<__bfloat, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, Tensor<__bfloat, 2, 2> T3) {
  ...
  nvfuser_index_t i3;
  i3 = ceilDiv(ceilDiv(T1.logical_size[1LL], 256), 2);
  nvfuser_index_t i4;
  i4 = ceilDiv(((2 * (ceilDiv(T0.logical_size[0LL], 128))) * i3), 132);
  nvfuser_index_t i5;
  ...
  for(nvfuser_index_t i22 = 0; i22 < i4; ++i22) {
    ...
    */
    ...
    // Swizzle: i24 -> i27 etc., plus use these redefinitions
    nvfuser_index_t i24_new = i23 / i3;
    nvfuser_index_t i25_new = 512 * (i23 % i3);
    nvfuser_index_t i26_new = 256 * (i24_new % 2);
    nvfuser_index_t i24 = i25_new + i26_new;
    nvfuser_index_t i25 = 128 * (i24_new / 2);
    nvfuser_index_t i26 = i14 + i25;
    bool b27 = b18 && ((i20 + i25) < T0.logical_size[0LL]);
    nvfuser_index_t i28 = (i21 + i25_new) + i26_new;
    ...
    if (b17) {
      ...
      for(nvfuser_index_t i31 = 0; i31 < i5; ++i31) {
        ...
        if ((Hopper::electSync(4294967295U) && b15)) {
          ...
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr6, (Array<nvfuser_index_t, 2, 1>{(64 * i31), i24}), toSmem((&T8[slot])) }), (i7 + (32768 * slot)));
          mbarrier::arriveExpectTX(toSmem((&T8[slot])), 16384U);
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr8, (Array<nvfuser_index_t, 2, 1>{(64 * i31), i25}), toSmem((&T8[slot])) }), (i9 + (16384 * slot)));
        }
      }
    } else {
      #pragma unroll 2
