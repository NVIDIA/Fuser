...
#define NVFUSER_DIRECT_BINDING_UNARY_OP(NAME, OP_NAME, DOCSTRING)            \
  ops.def(NAME, [](FusionDefinition::Operators& self, Val* v) -> Val* {      \
    return static_cast<Val* (*)(Val*)>(OP_NAME)(v);                          \
  });                                                                        \
  ops.def(                                                                   \
      NAME,                                                                  \
      [](FusionDefinition::Operators& self, TensorView* tv) -> TensorView* { \
...
void bindUnaryOps(py::class_<FusionDefinition::Operators>& ops) {
...
void bindReductionOps(py::class_<FusionDefinition::Operators>& ops) {
