...
void bindTensorViewScheduleOps(
    py::class_<FusionDefinition::ScheduleOperators>& sched) {
  sched.def(
      "to_string",
      [](FusionDefinition::ScheduleOperators& self, TensorView* tv) {
        return tv->toString();
      },
      R"(
  ...
  sched.def(
      "parallelize",
      [](FusionDefinition::ScheduleOperators& self,
         TensorView* tv,
         int axis,
  ...
  sched.def(
      "merge",
      [](FusionDefinition::ScheduleOperators& self, TensorView* tv, int dim) {
        tv->merge(dim);
      },
      R"(
...
void bindLdStMatrix(py::class_<FusionDefinition::ScheduleOperators>& sched) {
  sched.def(
      "ldst_matrix",
      [](FusionDefinition::ScheduleOperators& self,
         TensorView* tv,
...
void bindScheduleOperators(py::class_<FusionDefinition>& fusion_def) {
  //! The ScheduleOperators class is a nested class of FusionDefinition to
  //! allow the user to query the class for the list of schedule operators.
  //!
  //! Example:
  //!   help(FusionDefinition.ScheduleOperators)
  py::class_<FusionDefinition::ScheduleOperators> nvf_sched(
