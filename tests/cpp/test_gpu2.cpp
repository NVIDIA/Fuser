...
__global__ void kernel1(Tensor<float, 1> T0, Tensor<float, 1> T1) {
  ...
  fe.compiledKernel()->runRtc(lp, {in0, out0}, PrimDataType::Int);
...
__global__ void kernel1(
  ...
  fe.compiledKernel()->runRtc(lp, {in0, out_var, out_avg}, PrimDataType::Int);
...
__global__ void kernel1(
  ...
  auto out_var = at::empty({x}, options);
  auto out_avg = at::empty({x}, options);
  fe.compiledKernel()->runRtc(lp, {in0, out_avg, out_var}, PrimDataType::Int);
