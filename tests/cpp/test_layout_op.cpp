...
TEST_F(LayoutOpTest, ManaulKernel) {
  ...
  auto t0 = at::arange(m * k, options).view({m, k});
  ...
  auto t2 = at::tensor({0, 100, 250, 512}, options.dtype(at::kInt));
  auto t3 = at::tensor({0, 128, 384, 768}, options.dtype(at::kInt));
  ...
  // ASSERT_TRUE(validateGroupedLayout(BlockScalingFactorLayout::Block128x4, t1,
  // t0, t2, t3));
