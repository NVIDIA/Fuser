__global__ void nvfuser_none_f0_c0_r0_g0(Tensor<float, 2, 2> T0, Tensor<float, 2, 2> T2) {
  ...
  nvfuser_index_t i5;
  i5 = (((T0.alloc_stride[0LL] * i2) + (T0.alloc_stride[1LL] * i1)) + ((32LL * T0.alloc_stride[0LL]) * i4)) + ((32LL * T0.alloc_stride[1LL]) * i3);
  nvfuser_index_t i6;
  ...
  i8 = 32LL * i4;
  nvfuser_index_t i9;
  i9 = ((i1 + (T0.logical_size[0LL] * i2)) + ((32LL * T0.logical_size[0LL]) * i3)) + i8;
  nvfuser_index_t i10;
  i10 = 8LL * T0.logical_size[0LL];
  nvfuser_index_t i11;
  i11 = 32LL * i3;
  bool b12;
  b12 = (i1 + i11) < T0.logical_size[1LL];
  nvfuser_index_t i13;
  i13 = ((-T0.logical_size[0LL]) + i2) + i8;
  bool b14;
  b14 = (i1 + i8) < T0.logical_size[0LL];
  nvfuser_index_t i15;
  i15 = ((-T0.logical_size[1LL]) + i2) + i11;
  float* T1 = reinterpret_cast<float*>(array + smem_offset + 0LL);
  #pragma unroll
  for(nvfuser_index_t i16 = 0; i16 < 4LL; ++i16) {
    nvfuser_index_t i17;
    i17 = i16 + nvfuser_zero;
    if ((b12 && (i13 < (-(8LL * i17))))) {
      T1[(((nvfuser_index_t)threadIdx.x) + (256LL * i16))]
         = T0[(i5 + (i6 * i17))];
    }
  }
