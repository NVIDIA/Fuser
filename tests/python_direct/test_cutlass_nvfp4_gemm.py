...
import pytest
import torch
from nvfuser_direct import cutlass_nvfp4_quantize, cutlass_nvfp4_scaled_mm
...
def test_nvfp4_gemm(
    ...
    a_fp4, a_scale_interleaved = cutlass_nvfp4_quantize(a_dtype, a_global_scale)
    b_fp4, b_scale_interleaved = cutlass_nvfp4_quantize(b_dtype, b_global_scale)
