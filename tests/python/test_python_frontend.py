...
class TestNvFuserFrontend(NVFuserTest):
    ...
    def test_repro(self):
        print("\n" + "="*80)
        print("Starting test_repro - Running all subtests")
        print("="*80 + "\n")
        
        print("[1/44] Running test_addcmul...")
        self.test_addcmul()
        print("✓ test_addcmul completed\n")
        
        print("[2/44] Running test_alias_output_to_input...")
        self.test_alias_output_to_input()
        print("✓ test_alias_output_to_input completed\n")
        
        print("[3/44] Running test_all_dim_var_mean...")
        self.test_all_dim_var_mean()
        print("✓ test_all_dim_var_mean completed\n")
        
        print("[4/44] Running test_allocation_domain_concretization...")
        self.test_allocation_domain_concretization()
        print("✓ test_allocation_domain_concretization completed\n")
        
        print("[5/44] Running test_allocation_domain_index_select...")
        self.test_allocation_domain_index_select()
        print("✓ test_allocation_domain_index_select completed\n")
        
        print("[6/44] Running test_arithmetic_ops...")
        self.test_arithmetic_ops()
        print("✓ test_arithmetic_ops completed\n")
        
        print("[7/44] Running test_basic...")
        self.test_basic()
        print("✓ test_basic completed\n")
        
        print("[8/44] Running test_basic_fp16...")
        self.test_basic_fp16()
        print("✓ test_basic_fp16 completed\n")
        
        print("[9/44] Running test_bcast_squeeze_replace_aliased_output...")
        self.test_bcast_squeeze_replace_aliased_output()
        print("✓ test_bcast_squeeze_replace_aliased_output completed\n")
        
        print("[10/44] Running test_broadcast_and_stride_order...")
        self.test_broadcast_and_stride_order()
        print("✓ test_broadcast_and_stride_order completed\n")
        
        print("[11/44] Running test_broadcast_in_dim_with_dynamic_shapes...")
        self.test_broadcast_in_dim_with_dynamic_shapes()
        print("✓ test_broadcast_in_dim_with_dynamic_shapes completed\n")
        
        print("[12/44] Running test_broadcast_mixing...")
        self.test_broadcast_mixing()
        print("✓ test_broadcast_mixing completed\n")
        
        print("[13/44] Running test_cast_double_to_half...")
        self.test_cast_double_to_half()
        print("✓ test_cast_double_to_half completed\n")
        
        print("[14/44] Running test_cat...")
        self.test_cat()
        print("✓ test_cat completed\n")
        
        print("[15/44] Running test_cat_symbolic...")
        self.test_cat_symbolic()
        print("✓ test_cat_symbolic completed\n")
        
        print("[16/44] Running test_complex_constants...")
        self.test_complex_constants()
        print("✓ test_complex_constants completed\n")
        
        print("[17/44] Running test_complex_rsqrt...")
        self.test_complex_rsqrt()
        print("✓ test_complex_rsqrt completed\n")
        
        print("[18/44] Running test_compute_contiguity...")
        self.test_compute_contiguity()
        print("✓ test_compute_contiguity completed\n")
        
        print("[19/44] Running test_compute_tensor_descriptor...")
        self.test_compute_tensor_descriptor()
        print("✓ test_compute_tensor_descriptor completed\n")
        
        print("[20/44] Running test_constant_nans...")
        self.test_constant_nans()
        print("✓ test_constant_nans completed\n")
        
        print("[21/44] Running test_cuda_code_and_scheduled_fusion_ir_strings...")
        self.test_cuda_code_and_scheduled_fusion_ir_strings()
        print("✓ test_cuda_code_and_scheduled_fusion_ir_strings completed\n")
        
        print("[22/44] Running test_cumsum...")
        self.test_cumsum()
        print("✓ test_cumsum completed\n")
        
        print("[23/44] Running test_cumsum_int...")
        self.test_cumsum_int()
        print("✓ test_cumsum_int completed\n")
        
        print("[24/44] Running test_debug_output...")
        self.test_debug_output()
        print("✓ test_debug_output completed\n")
        
        print("[25/44] Running test_def_op_in_schedule...")
        self.test_def_op_in_schedule()
        print("✓ test_def_op_in_schedule completed\n")
        
        print("[26/44] Running test_deterministic_random...")
        self.test_deterministic_random()
        print("✓ test_deterministic_random completed\n")
        
        print("[27/44] Running test_dynamic_reshape...")
        self.test_dynamic_reshape()
        print("✓ test_dynamic_reshape completed\n")
        
        print("[28/44] Running test_empty_reshape...")
        self.test_empty_reshape()
        print("✓ test_empty_reshape completed\n")
        
        print("[29/44] Running test_enable_disable_options...")
        self.test_enable_disable_options()
        print("✓ test_enable_disable_options completed\n")
        
        print("[30/44] Running test_execute_with_tuple_and_list...")
        self.test_execute_with_tuple_and_list()
        print("✓ test_execute_with_tuple_and_list completed\n")
        
        print("[31/44] Running test_expand...")
        self.test_expand()
        print("✓ test_expand completed\n")
        
        print("[32/44] Running test_expand_to_zero...")
        self.test_expand_to_zero()
        print("✓ test_expand_to_zero completed\n")
        
        print("[33/44] Running test_expanded_bcast_tensor...")
        self.test_expanded_bcast_tensor()
        print("✓ test_expanded_bcast_tensor completed\n")
        
        print("[34/44] Running test_expanded_reduction...")
        self.test_expanded_reduction()
        print("✓ test_expanded_reduction completed\n")
        
        print("[35/44] Running test_explicit_broadcast_input...")
        self.test_explicit_broadcast_input()
        print("✓ test_explicit_broadcast_input completed\n")
        
        print("[36/44] Running test_fix_2549...")
        self.test_fix_2549()
        print("✓ test_fix_2549 completed\n")
        
        print("[37/44] Running test_from_pytorch_fails_on_cpu_tensor...")
        self.test_from_pytorch_fails_on_cpu_tensor()
        print("✓ test_from_pytorch_fails_on_cpu_tensor completed\n")
        
        print("[38/44] Running test_func_definition...")
        self.test_func_definition()
        print("✓ test_func_definition completed\n")
        
        print("[39/44] Running test_fusion_definition_error_cache...")
        self.test_fusion_definition_error_cache()
        print("✓ test_fusion_definition_error_cache completed\n")
        
        print("[40/44] Running test_fusion_information...")
        self.test_fusion_information()
        print("✓ test_fusion_information completed\n")
        
        print("[41/44] Running test_fusion_profiler...")
        self.test_fusion_profiler()
        print("✓ test_fusion_profiler completed\n")
        
        print("[42/44] Running test_fusion_profiler_user_schedule...")
        self.test_fusion_profiler_user_schedule()
        print("✓ test_fusion_profiler_user_schedule completed\n")
        
        print("[43/44] Running test_fusion_profiler_with_noncodegen_kernels...")
        self.test_fusion_profiler_with_noncodegen_kernels()
        print("✓ test_fusion_profiler_with_noncodegen_kernels completed\n")
        
        print("[44/44] Running test_gather...")
        self.test_gather()
        print("✓ test_gather completed\n")
        
        print("\n" + "="*80)
        print("test_repro completed successfully - All 44 subtests passed!")
        print("="*80 + "\n")
