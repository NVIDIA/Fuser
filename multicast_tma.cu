...
__device__ inline void cpAsyncBulkTensorTileG2SMulticast(
  ...
  asm volatile(
      ...
      " [%0], [%1, {%3}], [%2], [%4], [%5];"
      :
      : "r"(smem_addr), "l"(gmem_int_desc), "r"(src.mbarrier), "r"(src.crds[0]), "h"(cta_mask), "l"(cache_hint)
      : "memory");
}
...
__global__ void __launch_bounds__(/*MAX_THREADS_PER_BLOCK=*/384) __cluster_dims__(2, 1, 1) nvfuser_none_f0_c0_r0_g0(Tensor<__half, 3, 3> T0, Tensor<__half, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, Tensor<__half, 2, 2> T3) {
      ...
      if ((Hopper::electSync(4294967295U) && b16)) {
        ...
        for(nvfuser_index_t i29 = 0; i29 < 2; ++i29) {
          ...
          for(nvfuser_index_t i32 = 0; i32 < 2; ++i32) {
            Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr4, (Array<nvfuser_index_t, 2, 1>{(i30 + (64 * i32)), i25}), toSmem((&T8[(i24 % 4)])) }), (i31 + (2048 * i32)));
          }
        }
        mbarrier::arriveExpectTX(toSmem((&T8[(i24 % 4)])), 4096U);
	int32_t i33 = (int32_t)blockRankInCluster();
        //uint16_t cta_mask = 0x11b;
        uint16_t cta_mask = 3;
        Hopper::cpAsyncBulkTensorTileG2SMulticast((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr7, (Array<nvfuser_index_t, 2, 1>{(i8 + (64 * i33)), i25}), toSmem((&T8[(i24 % 4)])) }), (i28 + (2048 * i33)), cta_mask, CacheHintSm90::EVICT_NORMAL);
      }
    }
    return;
  } else {
  ...
  for(nvfuser_index_t i39 = 0; i39 < 4; ++i39) {
    if (((Hopper::electSync(4294967295U) && b16) && b17)) {
      mbarrier::inval(toSmem((&T8[(i39 + 4LL)])));
    }
  }
  #pragma unroll
  for(nvfuser_index_t i40 = 0; i40 < 4; ++i40) {
    if (((Hopper::electSync(4294967295U) && b16) && b17)) {
      mbarrier::inval(toSmem((&T8[i40])));
    }
  }
  #pragma unroll
  ...
  for(nvfuser_index_t i47 = 0; i47 < 16; ++i47) {
    if ((b20 && (i21 < (-(16 * i47))))) {
      asm volatile(
        ...
        :
        :"r"((uint32_t)((toSmem(T7) + ((((nvfuser_index_t)threadIdx.y) * 32768) + (((i47 / 4) * 8192) + ((i11 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i47 % 4) * 2)) ^ (i11 % 8)) * 16))))))),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T6[(8 * i47)]))[0]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T6[(8 * i47)]))[1]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T6[(8 * i47)]))[2]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T6[(8 * i47)]))[3])
      );
    }
  }
  __syncthreads();
  ...
  for(nvfuser_index_t i48 = 0; i48 < 4; ++i48) {
    asm volatile("fence.proxy.async;\n");
    if (b19) {
      Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr13, (Array<nvfuser_index_t, 2, 1>{(i5 + (64 * i48)), i15}) }), (i12 + (8192 * i48)));
    }
  }
