...
__global__ void nvfuser_reduction_f0_c1_r0_g0(
    Tensor<float, 4, 4> T0,
    Tensor<float, 3, 3> T3,
    Tensor<float, 1, 1> T5,
    Tensor<int64_t, 1, 1> T6) {
  alignas(16) extern __shared__ char array[];
  void* shared_mem = array;
  nvfuser_index_t i0;
  i0 = ceilDiv(
      (ceilDiv(5, ((nvfuser_index_t)blockDim.x))),
      ((nvfuser_index_t)gridDim.x));
  nvfuser_index_t i1;
  i1 = ((nvfuser_index_t)blockIdx.y) % 9;
  nvfuser_index_t i2;
  i2 = ((nvfuser_index_t)blockDim.x) * i0;
  nvfuser_index_t i3;
  i3 = ((((T0.alloc_stride[3LL] * ((nvfuser_index_t)threadIdx.x)) +
          ((i2 * T0.alloc_stride[3LL]) * ((nvfuser_index_t)blockIdx.x))) +
         (T0.alloc_stride[0LL] * (((nvfuser_index_t)blockIdx.y) / 9))) +
        (T0.alloc_stride[1LL] * (i1 / 3))) +
      (T0.alloc_stride[2LL] * (i1 % 3));
  nvfuser_index_t i4;
  i4 = ((nvfuser_index_t)blockDim.x) * T0.alloc_stride[3LL];
  nvfuser_index_t i5;
  i5 = ((nvfuser_index_t)threadIdx.x) + (i2 * ((nvfuser_index_t)blockIdx.x));
...
#pragma unroll 1
  for (nvfuser_index_t i6 = 0; i6 < i0; ++i6) {
    if (((i5 + (((nvfuser_index_t)blockDim.x) * i6)) < 5)) {
      T4[0] = T4[0] + T0[(i3 + (i4 * i6))];
    }
  }
  float T1[1];
  T1[0] = 0.000000000e+00f;
  reduction::gridReduce<true, false, false, true, false, false, false, true>(
      T1[0],
      T4[0],
  ...
  float T2[1];
  T2[0] = T1[0];
  if (((((nvfuser_index_t)blockIdx.x) == (((nvfuser_index_t)gridDim.x) + -1)) &&
       (((nvfuser_index_t)threadIdx.x) == 0))) {
    T3[((nvfuser_index_t)blockIdx.y)] = T2[0] + T2[0];
  }
}
} // namespace
