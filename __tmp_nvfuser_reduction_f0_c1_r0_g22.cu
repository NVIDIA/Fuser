...
__global__ void nvfuser_reduction_f0_c1_r0_g22(Tensor<bool, 3, 3> T2, Tensor<__bfloat, 3, 3> T1, Tensor<__bfloat, 1, 1> T256, Tensor<__bfloat, 2, 2> T244, Tensor<__bfloat, 2, 2> T288, Tensor<float, 1, 1> T291, Tensor<int64_t, 1, 1> T292) {
  ...
  Array<float, 8, 8> T290;
  #pragma unroll
  for(nvfuser_index_t i12 = 0; i12 < 8; ++i12) {
    T290[i12] = 0.000000000e+00f;
  }
  ...
  for(nvfuser_index_t i13 = 0; i13 < i0; ++i13) {
    ...
    if ((b7 && ((i9 + i15) < 2048))) {
      ...
      #pragma unroll
      for(nvfuser_index_t i17 = 0; i17 < 4; ++i17) {
        loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T285[(8 * i17)],  &T1[(i14 + (i5 * (i17 + nvfuser_zero)))]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<bool, 32, 8> T284;
      #pragma unroll
      ...
      #pragma unroll
      for(nvfuser_index_t i18 = 0; i18 < 4; ++i18) {
        loadGlobalToLocal<bool, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T284[(8 * i18)],  &T2[(i14 + (i5 * (i18 + nvfuser_zero)))]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 32, 8> T287;
      Array<__bfloat, 32, 8> T289;
      #pragma unroll
      for(nvfuser_index_t i12 = 0; i12 < 8; ++i12) {
        #pragma unroll
      ...
      for(nvfuser_index_t i21 = 0; i21 < 4; ++i21) {
        loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T244[(i14 + (i5 * (i21 + nvfuser_zero)))], &T287[(8 * i21)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i22 = 0; i22 < 4; ++i22) {
        loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T288[(i14 + (i5 * (i22 + nvfuser_zero)))], &T289[(8 * i22)]);
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
    } else {
      Array<__bfloat, 32, 8> T285;
      ...
      for(nvfuser_index_t i17 = 0; i17 < 4; ++i17) {
        ...
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i23))))) {
          loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T285[(8 * i17)],  &T1[(i14 + (i5 * i23))]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<bool, 32, 8> T284;
      ...
      for(nvfuser_index_t i18 = 0; i18 < 4; ++i18) {
        ...
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i24))))) {
          loadGlobalToLocal<bool, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T284[(8 * i18)],  &T2[(i14 + (i5 * i24))]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      Array<__bfloat, 32, 8> T287;
      ...
      for(nvfuser_index_t i21 = 0; i21 < 4; ++i21) {
        ...
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i26))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T244[(i14 + (i5 * i26))], &T287[(8 * i21)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
      #pragma unroll
      for(nvfuser_index_t i22 = 0; i22 < 4; ++i22) {
        ...
        if ((b7 && (i16 < (-(((nvfuser_index_t)blockDim.y) * i27))))) {
          loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T288[(i14 + (i5 * i27))], &T289[(8 * i22)]);
        }
      }
      NVFUSER_UPDATE_MAGIC_ZERO;
    }
  ...
  if (b7) {
    ...
    NVFUSER_UPDATE_MAGIC_ZERO;
    if (b11) {
      loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T256[i6], &T286[0]);
    }
  } else {
    Array<float, 8, 1> T242;
    #pragma unroll
