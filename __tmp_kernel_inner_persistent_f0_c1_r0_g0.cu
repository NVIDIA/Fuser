...
__global__ void nvfuser_inner_persistent_f0_c1_r0_g0(Tensor<__bfloat, 2, 2> T0, Tensor<__bfloat, 1, 1> T1, Tensor<__bfloat, 1, 1> T2, int64_t* ptr0, int64_t i1, int64_t* ptr2, int64_t i3, Tensor<__bfloat, 2, 2> T34, Tensor<float, 1, 1> T58, Tensor<float, 2, 2> T60, Tensor<bool, 2, 2> T62) {
  uint4 rng_result;
  ...
  nvfuser_index_t i4;
  i4 = 8LL * ((nvfuser_index_t)threadIdx.x);
  Tensor<__bfloat, 2, 2> s5;
  s5.data = T0.data;
  s5.logical_size = T0.logical_size;
  s5.alloc_stride = T0.alloc_stride;
  Array<nvfuser_index_t, 2, 1> a6;
  a6 = s5.logical_size;
  nvfuser_index_t i7;
  i7 = a6[0LL];
  double d8;
  ...
  double d10;
  d10 = (double)(0LL);
  Array<nvfuser_index_t, 2, 1> a11;
  a11 = s5.logical_size;
  nvfuser_index_t i12;
  i12 = a11[1LL];
  nvfuser_index_t i13;
  i13 = i4 + (i12 * ((nvfuser_index_t)blockIdx.x));
  nvfuser_index_t i14;
  i14 = ceilDiv((ceilDiv(i12, 8)), 8);
  nvfuser_index_t i15;
  i15 = 8LL * i14;
  bool b16;
  b16 = ((nvfuser_index_t)threadIdx.x) < i14;
  nvfuser_index_t i17;
  i17 = (7 - i12) + i4;
  bool b18;
  ...
  d19 = (double)(i12);
  double d20;
  d20 = 1.00000000000000000e+00 * d19;
  double d21;
  d21 = (double)(i12);
  double d22;
  d22 = 1.00000000000000000e+00 * d21;
  double d23;
  d23 = d22 - d10;
  bool b24;
  b24 = d23 >= d9;
  ...
  for(nvfuser_index_t i27 = 0; i27 < 8; ++i27) {
    nvfuser_index_t i28;
    i28 = i15 * (i27 + nvfuser_zero);
    if ((b16 && (i17 < (-i28)))) {
      loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::Streaming>(&T54[(8LL * i27)],  &T0[(i13 + i28)]);
    }
  }
  NVFUSER_UPDATE_MAGIC_ZERO;
  float T35[1];
  T35[0] = 0.000000000e+00f;
  float T64[1];
  ...
  for(nvfuser_index_t i29 = 0; i29 < 8; ++i29) {
    ...
    if (b34) {
      ...
      for(nvfuser_index_t i35 = 0; i35 < 8; ++i35) {
        float T8[1];
        T8[0]
           = __bfloat2float(T54[(i30 + i35)]);
        float T3[1];
        T3[0] = 0;
        nvfuser_index_t linear_index1488 = (i31 + (i35 + nvfuser_zero));
        nvfuser_index_t rng_subseq1488 = linear_index1488 / 4;
        nvfuser_index_t rng_component1488 = linear_index1488 % 4;
        nvfuser_index_t rng_offset1488 = ((((ptr2 == nullptr) ? i3 : ((*ptr2) + i3)) / 4LL) + 1LL);
        if (rng_subseq != rng_subseq1488 || rng_offset != rng_offset1488) {
          rng_result = philox(((ptr0 == nullptr) ? i1 : (*ptr0)), rng_subseq1488, rng_offset1488);
          rng_subseq = rng_subseq1488;
          rng_offset = rng_offset1488;
        }
        T3[0] = rng_uniform_rangef(rng_result, rng_component1488, 0.00000000000000000e+00, 1.00000000000000000e+00);
        bool T4[1];
        T4[0]
          = T3[0]
      ...
      loadLocalToGlobal<bool, /*vec_size=*/8, /*is_volatile=*/false>( &T62[i33], &T63[0]);
    } else {
      Array<bool, 8, 8> T63;
      #pragma unroll
      for(nvfuser_index_t i35 = 0; i35 < 8; ++i35) {
        ...
        T3[0] = 0;
        if (b34) {
          nvfuser_index_t linear_index1772 = (i31 + (i35 + nvfuser_zero));
          nvfuser_index_t rng_subseq1772 = linear_index1772 / 4;
          nvfuser_index_t rng_component1772 = linear_index1772 % 4;
          nvfuser_index_t rng_offset1772 = ((((ptr2 == nullptr) ? i3 : ((*ptr2) + i3)) / 4LL) + 1LL);
          if (rng_subseq != rng_subseq1772 || rng_offset != rng_offset1772) {
            rng_result = philox(((ptr0 == nullptr) ? i1 : (*ptr0)), rng_subseq1772, rng_offset1772);
            rng_subseq = rng_subseq1772;
            rng_offset = rng_offset1772;
          }
          T3[0] = rng_uniform_rangef(rng_result, rng_component1772, 0.00000000000000000e+00, 1.00000000000000000e+00);
        }
        bool T4[1];
        T4[0]
          = T3[0]
  ...
  NVFUSER_UPDATE_MAGIC_ZERO;
  warp::warpReduceTIDX<false, true>(T35[0], T64[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, static_cast<float>(0.000000000e+00f));
  float T12[1];
  T12[0]
    = T35[0]
    / (float) d20;
  ...
  T59[0]
     = T12[0];
  if (b18) {
    T58[((nvfuser_index_t)blockIdx.x)]
       = T59[0];
  }
  float T18[1];
  broadcast::blockBroadcast<true, false, false, true>(T18[0], T12[0], static_cast<float*>(shared_mem), true);
  float T19[1];
  T19[0]
     = T18[0];
  float T13[1];
  T13[0] = 0.00000000000000000e+00;
  float T65[1];
  T65[0] = 0.00000000000000000e+00;
  #pragma unroll
  for(nvfuser_index_t i36 = 0; i36 < 8; ++i36) {
    ...
    i38 = i13 + (i15 * i36);
    bool b39;
    b39 = b16 && (i17 < (-(i15 * (i36 + nvfuser_zero))));
    if (b39) {
      #pragma unroll
      for(nvfuser_index_t i40 = 0; i40 < 8; ++i40) {
        float T46[1];
        T46[0]
           = __bfloat2float(T54[(i37 + i40)]);
        float T47[1];
        T47[0] = 0;
        nvfuser_index_t linear_index2163 = (i38 + (i40 + nvfuser_zero));
        nvfuser_index_t rng_subseq2163 = linear_index2163 / 4;
        nvfuser_index_t rng_component2163 = linear_index2163 % 4;
        nvfuser_index_t rng_offset2163 = ((((ptr2 == nullptr) ? i3 : ((*ptr2) + i3)) / 4LL) + 2LL);
        if (rng_subseq != rng_subseq2163 || rng_offset != rng_offset2163) {
          rng_result = philox(((ptr0 == nullptr) ? i1 : (*ptr0)), rng_subseq2163, rng_offset2163);
          rng_subseq = rng_subseq2163;
          rng_offset = rng_offset2163;
        }
        T47[0] = rng_uniform_rangef(rng_result, rng_component2163, 0.00000000000000000e+00, 1.00000000000000000e+00);
        bool T48[1];
        T48[0]
          = T47[0]
          < (float) 1.00000000000000000e+00;
      ...
      for(nvfuser_index_t i40 = 0; i40 < 8; ++i40) {
        ...
        T47[0] = 0;
        if (b39) {
          nvfuser_index_t linear_index2425 = (i38 + (i40 + nvfuser_zero));
          nvfuser_index_t rng_subseq2425 = linear_index2425 / 4;
          nvfuser_index_t rng_component2425 = linear_index2425 % 4;
          nvfuser_index_t rng_offset2425 = ((((ptr2 == nullptr) ? i3 : ((*ptr2) + i3)) / 4LL) + 2LL);
          if (rng_subseq != rng_subseq2425 || rng_offset != rng_offset2425) {
            rng_result = philox(((ptr0 == nullptr) ? i1 : (*ptr0)), rng_subseq2425, rng_offset2425);
            rng_subseq = rng_subseq2425;
            rng_offset = rng_offset2425;
          }
          T47[0] = rng_uniform_rangef(rng_result, rng_component2425, 0.00000000000000000e+00, 1.00000000000000000e+00);
        }
        bool T48[1];
        T48[0]
          = T47[0]
  ...
  NVFUSER_UPDATE_MAGIC_ZERO;
  warp::warpReduceTIDX<false, true>(T13[0], T65[0], [](float &a, float b) { a = a + b; }, static_cast<float*>(shared_mem), true, static_cast<float>(0.00000000000000000e+00));
  float T15[1];
  T15[0]
    = T13[0]
    * (float) d26;
  float T16[1];
  broadcast::blockBroadcast<true, false, false, true>(T16[0], T15[0], static_cast<float*>(shared_mem), true);
  float T17[1];
  T17[0]
     = T16[0];
  float T22[1];
  ...
  T61[0]
     = T21[0];
  if (b18) {
    T60[((nvfuser_index_t)blockIdx.x)]
       = T61[0];
  }
  float T25[1];
  T25[0]
  ...
  T26[0]
     = T25[0];
  #pragma unroll
  for(nvfuser_index_t i41 = 0; i41 < 8; ++i41) {
    nvfuser_index_t i42;
    i42 = i15 * (i41 + nvfuser_zero);
    nvfuser_index_t i43;
    i43 = i4 + i42;
    nvfuser_index_t i44;
    i44 = 8LL * i41;
    ...
    b47 = b16 && (i17 < (-i42));
    if (b47) {
      Array<__bfloat, 8, 8> T56;
      T56.set(__bfloat(0));
      loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::AllLevels>(&T56[0],  &T2[i43]);
      Array<__bfloat, 8, 8> T55;
      T55.set(__bfloat(0));
      loadGlobalToLocal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false, CacheOp::AllLevels>(&T55[0],  &T1[i43]);
      // Alias Allocation - register
      auto& T57 = T55;
      #pragma unroll
      for(nvfuser_index_t i48 = 0; i48 < 8; ++i48) {
        float T38[1];
        T38[0]
           = __bfloat2float(T54[(i44 + i48)]);
        float T39[1];
        T39[0] = 0;
        nvfuser_index_t linear_index3069 = (i45 + (i48 + nvfuser_zero));
        nvfuser_index_t rng_subseq3069 = linear_index3069 / 4;
        nvfuser_index_t rng_component3069 = linear_index3069 % 4;
        nvfuser_index_t rng_offset3069 = (((ptr2 == nullptr) ? i3 : ((*ptr2) + i3)) / 4LL);
        if (rng_subseq != rng_subseq3069 || rng_offset != rng_offset3069) {
          rng_result = philox(((ptr0 == nullptr) ? i1 : (*ptr0)), rng_subseq3069, rng_offset3069);
          rng_subseq = rng_subseq3069;
          rng_offset = rng_offset3069;
        }
        T39[0] = rng_uniform_rangef(rng_result, rng_component3069, 0.00000000000000000e+00, 1.00000000000000000e+00);
        bool T40[1];
        T40[0]
          = T39[0]
          < (float) 1.00000000000000000e+00;
        ...
        T33[0]
          ...
          + T32[0];
        T57[i48]
           = __float2bfloat(T33[0]);
      }
      loadLocalToGlobal<__bfloat, /*vec_size=*/8, /*is_volatile=*/false>( &T34[i46], &T57[0]);
    } else {
      Array<__bfloat, 8, 8> T56;
      T56.set(__bfloat(0));
      if (b47) {
      ...
      for(nvfuser_index_t i48 = 0; i48 < 8; ++i48) {
        ...
        T39[0] = 0;
        if (b47) {
          nvfuser_index_t linear_index3617 = (i45 + (i48 + nvfuser_zero));
          nvfuser_index_t rng_subseq3617 = linear_index3617 / 4;
          nvfuser_index_t rng_component3617 = linear_index3617 % 4;
          nvfuser_index_t rng_offset3617 = (((ptr2 == nullptr) ? i3 : ((*ptr2) + i3)) / 4LL);
          if (rng_subseq != rng_subseq3617 || rng_offset != rng_offset3617) {
            rng_result = philox(((ptr0 == nullptr) ? i1 : (*ptr0)), rng_subseq3617, rng_offset3617);
            rng_subseq = rng_subseq3617;
            rng_offset = rng_offset3617;
          }
          T39[0] = rng_uniform_rangef(rng_result, rng_component3617, 0.00000000000000000e+00, 1.00000000000000000e+00);
        }
        bool T40[1];
        T40[0]
          = T39[0]
