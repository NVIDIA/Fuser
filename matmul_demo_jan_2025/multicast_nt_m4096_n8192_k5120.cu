...
__global__ void __launch_bounds__(/*MAX_THREADS_PER_BLOCK=*/384) __cluster_dims__(2, 1, 1) nvfuser_none_f0_c0_r0_g0(Tensor<__half, 3, 3> T0, Tensor<__half, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, Tensor<__half, 2, 2> T3) {
  ...
  i9 = toSmem(T4);
  unsigned i10;
  i10 = i9 + (4096 * ((nvfuser_index_t)threadIdx.y));
  nvfuser_index_t i11;
  ...
  for(nvfuser_index_t i23 = 0; i23 < 4; ++i23) {
    if (((Hopper::electSync(4294967295U) && b16) && b17)) {
      mbarrier::init(toSmem((&T8[(i23 + 4LL)])), 512U);
    }
  }
  __syncthreads();
  clusterSync();
  if ((((nvfuser_index_t)threadIdx.y) == 2)) {
    ...
    for(nvfuser_index_t i24 = 0; i24 < i3; ++i24) {
      ...
      if ((Hopper::electSync(4294967295U) && b16)) {
        ...
        for(nvfuser_index_t i30 = 0; i30 < 2; ++i30) {
          ...
          unsigned i32;
          i32 = i28 + (8192 * i30);
          int32_t i33 = (int32_t)blockRankInCluster();
          uint16_t cta_mask = 3;
          Hopper::cpAsyncBulkTensorTileG2SMulticast((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr7, (Array<nvfuser_index_t, 2, 1>{(i8 + (64 * i33)), i31}), toSmem((&T8[(i24 % 4)])) }), (i32 + (4096 * i33)), cta_mask);
        }
      }
    }
    return;
    ...
    for(nvfuser_index_t i34 = 0; i34 < 4; ++i34) {
      mbarrier::arrive(toSmem((&T8[(i34 + 4LL)])), 0);
      mbarrier::arrive(toSmem((&T8[(i34 + 4LL)])), 1);
    }
    #pragma unroll 3
    for(nvfuser_index_t i35 = 0; i35 < i3; ++i35) {
      ...
      for(nvfuser_index_t i39 = 0; i39 < 4; ++i39) {
        ...
        asm volatile(
          ...
          :"l"((4611686293305294848ULL | ((262143ULL & (uint64_t)(i40)) >> 4ULL))),
           "l"((4611686293338849280ULL | ((262143ULL & (uint64_t)(i41)) >> 4ULL))),
           "n"((uint32_t)(true)),
           "n"(1),
           "n"(1),
           "n"(1),
      ...
      mbarrier::arrive(toSmem((&T8[((i35 % 4) + 4LL)])), 0);
      mbarrier::arrive(toSmem((&T8[((i35 % 4) + 4LL)])), 1);
    }
  }
  #pragma unroll
