...
nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 2, 2> T0, Tensor<__bfloat, 2, 2> T1, Tensor<__bfloat, 2, 2> T2, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, const __grid_constant__ TensorMap var3, Tensor<__bfloat, 2, 2> T16, Tensor<__bfloat, 2, 2> T12) {
  alignas(16) extern __shared__ char array[];
  const unsigned smem_offset = 0;
  nvfuser_index_t i4;
  i4 = ceilDiv(T0.logical_size[1LL], 64);
  const TensorMap* ptr5;
  ptr5 = &var0;
  nvfuser_index_t i6;
  i6 = 256 * ((nvfuser_index_t)blockIdx.x);
  __bfloat* T14 = reinterpret_cast<__bfloat*>(array + smem_offset + 65664);
  unsigned i7;
  i7 = toSmem(T14);
  ...
  __bfloat* T13 = reinterpret_cast<__bfloat*>(array + smem_offset + 128);
  unsigned i10;
  i10 = toSmem(T13);
  unsigned i11;
  i11 = i10 + (8192 * ((nvfuser_index_t)threadIdx.y));
  nvfuser_index_t i12;
  i12 = ((nvfuser_index_t)threadIdx.x) / 4;
  nvfuser_index_t i13;
  i13 = i12 / 8;
  nvfuser_index_t i14;
  i14 = i12 % 8;
  nvfuser_index_t i15;
  i15 = 2 * (((nvfuser_index_t)threadIdx.x) % 4);
  nvfuser_index_t i16;
  i16 = ((((i15 + ((16 * T1.logical_size[0LL]) * i13)) + (T1.logical_size[0LL] * i14)) + ((64 * T1.logical_size[0LL]) * ((nvfuser_index_t)threadIdx.y))) + i6) + ((128 * T1.logical_size[0LL]) * ((nvfuser_index_t)blockIdx.y));
  nvfuser_index_t i17;
  i17 = 8 * T1.logical_size[0LL];
  nvfuser_index_t i18;
  i18 = ((((nvfuser_index_t)threadIdx.x) / 32) * 16) + ((((nvfuser_index_t)threadIdx.x) % 32) % 16);
  nvfuser_index_t i19;
  i19 = 32768 * ((nvfuser_index_t)threadIdx.y);
  Array<__bfloat, 128, 8> T17;
  ...
  ptr21 = &var2;
  nvfuser_index_t i22;
  i22 = 64 * ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i23;
  i23 = i22 + i9;
  ...
  i29 = 16 * i13;
  nvfuser_index_t i30;
  i30 = ((((-T0.logical_size[0LL]) + i29) + i14) + i22) + i9;
  nvfuser_index_t i31;
  i31 = ((-T1.logical_size[0LL]) + i15) + i6;
  bool b32;
  b32 = b28 && (((((8 + i29) + i14) + i22) + i9) < T0.logical_size[0LL]);
  nvfuser_index_t i33;
  i33 = ((9 - T1.logical_size[0LL]) + i15) + i6;
  float T19[128];
  ((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))).set(0);
  asm volatile("wgmma.fence.sync.aligned;\n");
  asm volatile("fence.proxy.async;\n");
  uint64_t* T24 = reinterpret_cast<uint64_t*>(array + smem_offset + 0);
  #pragma unroll
  for(nvfuser_index_t i34 = 0; i34 < 4; ++i34) {
    if (((Hopper::electSync(4294967295U) && b26) && b27)) {
      mbarrier::init(toSmem((&T24[i34])), 2U);
    }
  }
  #pragma unroll
  for(nvfuser_index_t i35 = 0; i35 < 4; ++i35) {
    if (((Hopper::electSync(4294967295U) && b26) && b27)) {
      mbarrier::init(toSmem((&T24[(i35 + 4LL)])), 256U);
    }
  }
  __syncthreads();
  if ((((nvfuser_index_t)threadIdx.y) == 2)) {
    ...
    for(nvfuser_index_t i36 = 0; i36 < i4; ++i36) {
      ...
      if ((Hopper::electSync(4294967295U) && b26)) {
        mbarrier::waitParity(toSmem((&T24[((i36 % 4) + 4LL)])), (uint32_t)(((i36 / 4) % 2)));
        mbarrier::arriveExpectTX(toSmem((&T24[(i36 % 4)])), 32768U);
        Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr5, (Array<nvfuser_index_t, 2, 1>{(64 * i36), i6}), toSmem((&T24[(i36 % 4)])) }), (i7 + (32768 * i37)));
        mbarrier::arriveExpectTX(toSmem((&T24[(i36 % 4)])), 16384U);
        Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr8, (Array<nvfuser_index_t, 2, 1>{(64 * i36), i9}), toSmem((&T24[(i36 % 4)])) }), (i10 + (16384 * i37)));
      }
    }
    return;
  } else {
    ...
    for(nvfuser_index_t i38 = 0; i38 < 4; ++i38) {
      mbarrier::arrive(toSmem((&T24[(i38 + 4LL)])));
    }
    #pragma unroll 3
    for(nvfuser_index_t i39 = 0; i39 < i4; ++i39) {
      nvfuser_index_t i40;
      i40 = i39 % 4;
      unsigned i41;
      i41 = i11 + (16384 * i40);
      unsigned i42;
      i42 = i7 + (32768 * i40);
      mbarrier::waitParity(toSmem((&T24[(i39 % 4)])), (uint32_t)(((i39 / 4) % 2)));
      #pragma unroll
      for(nvfuser_index_t i43 = 0; i43 < 4; ++i43) {
        ...
        asm volatile(
          ...
          "}\n"
          :"+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[0]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[1]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[2]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[3]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[4]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[5]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[6]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[7]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[8]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[9]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[10]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[11]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[12]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[13]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[14]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[15]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[16]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[17]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[18]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[19]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[20]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[21]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[22]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[23]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[24]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[25]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[26]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[27]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[28]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[29]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[30]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[31]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[32]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[33]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[34]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[35]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[36]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[37]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[38]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[39]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[40]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[41]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[42]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[43]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[44]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[45]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[46]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[47]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[48]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[49]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[50]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[51]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[52]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[53]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[54]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[55]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[56]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[57]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[58]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[59]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[60]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[61]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[62]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[63]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[64]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[65]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[66]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[67]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[68]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[69]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[70]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[71]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[72]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[73]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[74]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[75]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[76]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[77]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[78]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[79]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[80]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[81]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[82]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[83]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[84]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[85]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[86]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[87]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[88]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[89]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[90]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[91]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[92]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[93]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[94]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[95]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[96]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[97]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[98]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[99]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[100]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[101]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[102]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[103]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[104]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[105]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[106]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[107]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[108]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[109]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[110]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[111]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[112]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[113]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[114]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[115]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[116]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[117]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[118]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[119]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[120]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[121]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[122]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[123]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[124]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[125]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[126]),
           "+f"((*reinterpret_cast<Array<float, 128, 1>*>(&T19[0]))[127])
      ...
      mbarrier::arrive(toSmem((&T24[((i39 % 4) + 4LL)])));
    }
  }
  #pragma unroll
  for(nvfuser_index_t i47 = 0; i47 < 4; ++i47) {
    if (((Hopper::electSync(4294967295U) && b26) && b27)) {
      mbarrier::inval(toSmem((&T24[(i47 + 4LL)])));
    }
  }
  #pragma unroll
  for(nvfuser_index_t i48 = 0; i48 < 4; ++i48) {
    if (((Hopper::electSync(4294967295U) && b26) && b27)) {
      mbarrier::inval(toSmem((&T24[i48])));
    }
  }
  #pragma unroll
  ...
  #pragma unroll
  for(nvfuser_index_t i55 = 0; i55 < 32; ++i55) {
    nvfuser_index_t i56;
    i56 = 8 * i55;
    nvfuser_index_t i57;
    i57 = i16 + i56;
  ...
  for(nvfuser_index_t i66 = 0; i66 < 16; ++i66) {
    if ((b32 && (i33 < (-(16 * i66))))) {
      asm volatile(
        ...
        :
        :"r"((uint32_t)((toSmem(T22) + ((((nvfuser_index_t)threadIdx.y) * 32768) + (((i66 / 4) * 8192) + ((i18 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i66 % 4) * 2)) ^ (i18 % 8)) * 16))))))),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i66)]))[0]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i66)]))[1]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i66)]))[2]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T17[(8 * i66)]))[3])
      );
    }
  }
  __syncthreads();
  ...
  for(nvfuser_index_t i67 = 0; i67 < 4; ++i67) {
    asm volatile("fence.proxy.async;\n");
    if (b28) {
      Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr21, (Array<nvfuser_index_t, 2, 1>{(i6 + (64 * i67)), i23}) }), (i20 + (8192 * i67)));
    }
  }
  #pragma unroll
  for(nvfuser_index_t i68 = 0; i68 < 16; ++i68) {
    if ((b32 && (i33 < (-(16 * i68))))) {
      asm volatile(
        "stmatrix.sync.aligned.x4.m8n8.shared.b16 [%0], {%1, %2, %3, %4};\n"
        :
        :"r"((uint32_t)((toSmem(T23) + ((((nvfuser_index_t)threadIdx.y) * 32768) + (((i68 / 4) * 8192) + ((i18 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i68 % 4) * 2)) ^ (i18 % 8)) * 16))))))),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T18[(8 * i68)]))[0]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T18[(8 * i68)]))[1]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T18[(8 * i68)]))[2]),
         "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T18[(8 * i68)]))[3])
      );
    }
  }
  __syncthreads();
  ...
  for(nvfuser_index_t i69 = 0; i69 < 4; ++i69) {
    asm volatile("fence.proxy.async;\n");
    if (b28) {
      Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr25, (Array<nvfuser_index_t, 2, 1>{(i6 + (64 * i69)), i23}) }), (i24 + (8192 * i69)));
    }
  }
