...
__global__ void __launch_bounds__(/*MAX_THREADS_PER_BLOCK=*/384) __cluster_dims__(1, 2, 1) nvfuser_none_f0_c0_r0_g0(Tensor<__half, 3, 3> T0, Tensor<__half, 3, 3> T1, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, Tensor<__half, 2, 2> T3) {
  alignas(16) extern __shared__ char array[];
  const unsigned smem_offset = 0;
  nvfuser_index_t i3;
  i3 = ceilDiv(T0.logical_size[0LL], 64);
  const TensorMap* ptr4;
  ptr4 = &var0;
  nvfuser_index_t i5;
  i5 = 256 * ((nvfuser_index_t)blockIdx.y);
  __half* T5 = reinterpret_cast<__half*>(array + smem_offset + 65664);
  unsigned i6;
  i6 = toSmem(T5);
  ...
  if ((((nvfuser_index_t)threadIdx.y) == 2)) {
      ...
      if ((Hopper::electSync(4294967295U) && b16)) {
        ...
        for(nvfuser_index_t i29 = 0; i29 < 4; ++i29) {
          ...
          for(nvfuser_index_t i32 = 0; i32 < 2; ++i32) {
            Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr4, (Array<nvfuser_index_t, 2, 1>{i30, (i25 + (32 * i32))}), toSmem((&T8[(i24 % 4)])) }), (i31 + (16384 * i32)));
          }
        }
        mbarrier::arriveExpectTX(toSmem((&T8[(i24 % 4)])), 16384U);
        #pragma unroll
        for(nvfuser_index_t i33 = 0; i33 < 2; ++i33) {
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr7, (Array<nvfuser_index_t, 2, 1>{(i8 + (64 * i33)), i25}), toSmem((&T8[(i24 % 4)])) }), (i28 + (8192 * i33)));
        }
      }
    }
    return;
    ...
    for(nvfuser_index_t i34 = 0; i34 < 4; ++i34) {
      mbarrier::arrive(toSmem((&T8[(i34 + 4LL)])));
    }
    #pragma unroll 3
    for(nvfuser_index_t i35 = 0; i35 < i3; ++i35) {
      nvfuser_index_t i36;
      i36 = i35 % 4;
      unsigned i37;
      i37 = i10 + (16384 * i36);
      unsigned i38;
      i38 = i6 + (32768 * i36);
      mbarrier::waitParity(toSmem((&T8[(i35 % 4)])), (uint32_t)(((i35 / 4) % 2)));
      #pragma unroll
      for(nvfuser_index_t i39 = 0; i39 < 4; ++i39) {
        unsigned i40;
        i40 = i37 + (2048 * i39);
        unsigned i41;
        i41 = (i38 + (16384 * (i39 / 2))) + (2048 * (i39 % 2));
        asm volatile("wgmma.fence.sync.aligned;\n");
        asm volatile(
          "{\n"
          "  .reg .pred p0; \n"
          ...
          :"l"((4611686293305294848ULL | ((262143ULL & (uint64_t)(i40)) >> 4ULL))),
           "l"((4611686293322072064ULL | ((262143ULL & (uint64_t)(i41)) >> 4ULL))),
           "n"((uint32_t)(true)),
           "n"(1),
           "n"(1),
           "n"(1),
      ...
      mbarrier::arrive(toSmem((&T8[((i35 % 4) + 4LL)])));
    }
  }
  #pragma unroll
  for(nvfuser_index_t i42 = 0; i42 < 4; ++i42) {
    if (((Hopper::electSync(4294967295U) && b16) && b17)) {
      mbarrier::inval(toSmem((&T8[(i42 + 4LL)])));
    }
  }
  #pragma unroll
  ...
  for(nvfuser_index_t i50 = 0; i50 < 16; ++i50) {
    if ((b20 && (i21 < (-(16 * i50))))) {
      asm volatile(
        ...
        :
        :"r"((uint32_t)((toSmem(T7) + ((((nvfuser_index_t)threadIdx.y) * 32768) + (((i50 / 4) * 8192) + ((i11 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i50 % 4) * 2)) ^ (i11 % 8)) * 16))))))),
  ...
  for(nvfuser_index_t i51 = 0; i51 < 4; ++i51) {
    asm volatile("fence.proxy.async;\n");
    if (b19) {
      Hopper::cpAsyncBulkTensorTileS2G((Hopper::CpAsyncBulkTensorTileS2GIndex<2>{ ptr13, (Array<nvfuser_index_t, 2, 1>{(i5 + (64 * i51)), i15}) }), (i12 + (8192 * i51)));
    }
  }
