    ...
    for(nvfuser_index_t i24 = 0; i24 < i3; ++i24) {
      ...
      if ((Hopper::electSync(4294967295U) && b16)) {
        ...
        for(nvfuser_index_t i29 = 0; i29 < 4; ++i29) {
          ...
          unsigned i31;
          i31 = i27 + (4096 * i29);
          int32_t i32 = (int32_t)blockRankInCluster();
          uint16_t cta_mask = 3;
          Hopper::cpAsyncBulkTensorTileG2SMulticast((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr4, (Array<nvfuser_index_t, 2, 1>{i30, (i25 + (32 * i32))}), toSmem((&T8[(i24 % 4)])) }), (i31 + (16384 * i32)), cta_mask);
        }
