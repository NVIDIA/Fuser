...
__global__ void nvfuser_none_f0_c0_r0_g0(Tensor<__bfloat, 3, 3> T0, Tensor<__bfloat, 3, 3> T1, Tensor<__bfloat, 3, 3> T2, const __grid_constant__ TensorMap var0, const __grid_constant__ TensorMap var1, const __grid_constant__ TensorMap var2, const __grid_constant__ TensorMap var3, const __grid_constant__ TensorMap var4, const __grid_constant__ TensorMap var5, Tensor<__bfloat, 2, 2> T4, Tensor<__bfloat, 2, 2> T19, Tensor<__bfloat, 2, 2> T14) {
  ...
  for(nvfuser_index_t i32 = 0; i32 < i7; ++i32) {
    ...
    for(nvfuser_index_t i43 = 0; i43 < 2; ++i43) {
      if (((Hopper::electSync(4294967295U) && b25) && b26)) {
        mbarrier::init(toSmem((&T25[(i43 + 2LL)])), 256U);
      }
    }
    __syncthreads();
    if (b27) {
      ...
      for(nvfuser_index_t i44 = 0; i44 < i8; ++i44) {
        ...
        if ((Hopper::electSync(4294967295U) && b25)) {
          mbarrier::waitParity(toSmem((&T25[((i44 % 2) + 2LL)])), (uint32_t)(((i44 / 2) % 2)));
          mbarrier::arriveExpectTX(toSmem((&T25[(i44 % 2)])), 16384U);
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr9, (Array<nvfuser_index_t, 2, 1>{(64 * i44), i35}), toSmem((&T25[(i44 % 2)])) }), (i10 + i45));
          mbarrier::arriveExpectTX(toSmem((&T25[(i44 % 2)])), 16384U);
          #pragma unroll
          for(nvfuser_index_t i48 = 0; i48 < 2; ++i48) {
            Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr11, (Array<nvfuser_index_t, 2, 1>{i46, (i38 + (64 * i48))}), toSmem((&T25[(i44 % 2)])) }), (i47 + (8192 * i48)));
          }
          mbarrier::arriveExpectTX(toSmem((&T25[(i44 % 2)])), 16384U);
          Hopper::cpAsyncBulkTensorTileG2S((Hopper::CpAsyncBulkTensorTileG2SIndex<2>{ ptr13, (Array<nvfuser_index_t, 2, 1>{i46, i35}), toSmem((&T25[(i44 % 2)])) }), (i14 + i45));
        }
      }
    } else {
      #pragma unroll
      ...
      for(nvfuser_index_t i50 = 0; i50 < i8; ++i50) {
        ...
        for(nvfuser_index_t i55 = 0; i55 < 4; ++i55) {
          ...
          asm volatile(
            ...
            :"l"((4611686293305294848ULL | ((262143ULL & (uint64_t)(i57)) >> 4ULL))),
        ...
        for(nvfuser_index_t i59 = 0; i59 < 4; ++i59) {
          ...
          asm volatile(
            ...
            :"l"((4611686293305294848ULL | ((262143ULL & (uint64_t)(i61)) >> 4ULL))),
             "l"((4611686293305294848ULL | ((262143ULL & (uint64_t)(i62)) >> 4ULL))),
             "n"((uint32_t)(true)),
             "n"(1),
             "n"(1),
             "n"(0),
    ...
    for(nvfuser_index_t i63 = 0; i63 < 2; ++i63) {
      if (((Hopper::electSync(4294967295U) && b25) && b26)) {
        mbarrier::inval(toSmem((&T25[(i63 + 2LL)])));
      }
    }
    #pragma unroll
    ...
    #pragma unroll
    for(nvfuser_index_t i73 = 0; i73 < 16; ++i73) {
      nvfuser_index_t i74;
      i74 = 4 * i73;
      #pragma unroll
      ...
      if ((b40 && (i41 < (-(16 * i79))))) {
        asm volatile(
          ...
          :"r"((uint32_t)((toSmem(T24) + ((((nvfuser_index_t)threadIdx.y) * 16384) + (((i79 / 4) * 8192) + ((i16 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i79 % 4) * 2)) ^ (i16 % 8)) * 16))))))),
           ...
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T21[(8 * i79)]))[3])
        );
      }
    }
    __syncthreads();
    ...
    #pragma unroll
    for(nvfuser_index_t i81 = 0; i81 < 8; ++i81) {
      if ((b40 && (i41 < (-(16 * i81))))) {
        asm volatile(
          "stmatrix.sync.aligned.x4.m8n8.shared.b16 [%0], {%1, %2, %3, %4};\n"
          :
          :"r"((uint32_t)((toSmem(T23) + ((((nvfuser_index_t)threadIdx.y) * 16384) + (((i81 / 4) * 8192) + ((i16 * 128) + (((((((nvfuser_index_t)threadIdx.x) % 32) / 16) + ((i81 % 4) * 2)) ^ (i16 % 8)) * 16))))))),
           ...
           "r"((*reinterpret_cast<Array<uint32_t, 4, 1>*>(&T20[(8 * i81)]))[3])
        );
      }
    }
    __syncthreads();
