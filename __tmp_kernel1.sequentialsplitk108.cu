...
__global__ void kernel1(Tensor<__half, 2, 2> T0, Tensor<__half, 2, 2> T1, Tensor<float, 2, 2> T4, Tensor<float, 1, 1> T11, Tensor<int64_t, 1, 1> T12) {
  ...
  i14 = 16 * (((i1 / 2) % 4) ^ (i2 % 4));
  nvfuser_index_t i15;
  i15 = 512 * ((nvfuser_index_t)threadIdx.y);
  nvfuser_index_t i16;
  i16 = 1024 * ((nvfuser_index_t)threadIdx.z);
  nvfuser_index_t i17;
  i17 = i8 * ((nvfuser_index_t)blockIdx.x);
  __half* ptr18;
  ptr18 = (((((T0.data + i3) + i4) + i5) + i6) + i7) + i17;
  nvfuser_index_t i19;
  i19 = ((nvfuser_index_t)threadIdx.x) / 8;
  nvfuser_index_t i20;
  i20 = i19 % 2;
  nvfuser_index_t i21;
  i21 = 512 * i20;
  nvfuser_index_t i22;
  i22 = ((nvfuser_index_t)threadIdx.x) % 8;
  nvfuser_index_t i23;
  i23 = 64 * i22;
  nvfuser_index_t i24;
  i24 = i19 / 2;
  ...
  volatile T* work_buf = &T11[0LL];
  int64_t* sync_flags = &T12[0LL];
  ...
  // Number of grid reductions in the grid
  const nvfuser_index_t num_segments = PERSISTENT_REDUCTION
      ? 1
      : index_utils::maskedSize<!X_BLOCK, !Y_BLOCK, !Z_BLOCK>(gridDim);

  // Index of this segment out of num_segments
