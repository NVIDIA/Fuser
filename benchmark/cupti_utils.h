...
namespace Metric {
namespace Parser {
inline bool ParseMetricNameString(
...
inline bool GetRawMetricRequests(
    std::string chipName,
...
inline bool GetConfigImage(
  ...
  GetRawMetricRequests(
      chipName, metricNames, rawMetricRequests, pCounterAvailabilityImage);
  ...
  SCOPE_EXIT([&]() -> void {
    auto x = NVPW_RawMetricsConfig_Destroy(
        (NVPW_RawMetricsConfig_Destroy_Params*)&rawMetricsConfigDestroyParams);
    (void)x;
  });
  ...
  RETURN_IF_NVPW_ERROR(
      false, NVPW_RawMetricsConfig_AddMetrics(&addMetricsParams));
...
bool GetCounterDataPrefixImage(
  ...
  SCOPE_EXIT([&]() {
    auto x = NVPW_CounterDataBuilder_Destroy((
        NVPW_CounterDataBuilder_Destroy_Params*)&counterDataBuilderDestroyParams);
    (void)x;
  });
  ...
  addMetricsParams.numMetricRequests = rawMetricRequests.size();
  RETURN_IF_NVPW_ERROR(
      false, NVPW_CounterDataBuilder_AddMetrics(&addMetricsParams));
...
inline bool GetMetricGpuValue(
  ...
  RETURN_IF_NVPW_ERROR(
      false, NVPW_CounterData_GetNumRanges(&getNumRangesParams));
